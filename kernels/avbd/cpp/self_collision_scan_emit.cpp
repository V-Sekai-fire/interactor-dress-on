...
struct GlobalParams_0
{
    ...
    StructuredBuffer<float> radii_0;
    RWStructuredBuffer<uint32_t> neighbors_0;
    SelfCollisionScanParams_0* params_0;
};
...
#line 16
    ...
    if(i_0 >= ((slang_bit_cast<GlobalParams_0*>(globalParams_1))->params_0->nVerts_0))
    {
...
#line 21
        if(k_0 < ((slang_bit_cast<GlobalParams_0*>(globalParams_1))->params_0->K_0))
        {
        }
        else
        {
...
#line 22
        *(&((&kernelContext_0)->globalParams_0->neighbors_0)[i_0 * (slang_bit_cast<GlobalParams_0*>(globalParams_1))->params_0->K_0 + k_0]) = 4294967295U;
...
#line 21
    ...
    Vector<float, 3>  _S3 = (&kernelContext_0)->globalParams_0->positions_0.Load(i_0);
    float _S4 = (&kernelContext_0)->globalParams_0->radii_0.Load(i_0);
...
#line 27
        if(j_0 < ((slang_bit_cast<GlobalParams_0*>(globalParams_1))->params_0->nVerts_0))
        {
        }
        else
        {
...
#line 28
        Vector<float, 3>  dj_0 = (&kernelContext_0)->globalParams_0->positions_0.Load(j_0);
        float dx_0 = _S3.x - dj_0.x;
        float dy_0 = _S3.y - dj_0.y;
        float dz_0 = _S3.z - dj_0.z;
        float d2_0 = dx_0 * dx_0 + dy_0 * dy_0 + dz_0 * dz_0;

        float tr_0 = _S4 + (&kernelContext_0)->globalParams_0->radii_0.Load(j_0);
        float t2_0 = tr_0 * tr_0;
...
#line 36
            _S5 = count_0 < ((slang_bit_cast<GlobalParams_0*>(globalParams_1))->params_0->K_0);
...
#line 37
            *(&((&kernelContext_0)->globalParams_0->neighbors_0)[i_0 * (slang_bit_cast<GlobalParams_0*>(globalParams_1))->params_0->K_0 + count_0]) = j_0;
