...
#line 1 "slang/anny_csr_gemv3.slang"
struct AnnyCsrParams_0
{
    uint32_t rows_0;
    uint32_t accumulate_0;
};
...
{
    AnnyCsrParams_0* params_0;
    StructuredBuffer<uint32_t> rowptr_0;
...
#line 23
    ...
    bool acc_0 = ((slang_bit_cast<GlobalParams_0*>(globalParams_1))->params_0->accumulate_0) != 0U;
...
#line 26
        a_0 = *(&((&kernelContext_0)->globalParams_0->y_0)[i_0 * 3U]);
...
#line 27
        b_0 = *(&((&kernelContext_0)->globalParams_0->y_0)[i_0 * 3U + 1U]);
...
#line 28
        c_0 = *(&((&kernelContext_0)->globalParams_0->y_0)[i_0 * 3U + 2U]);
...
#line 28
    uint32_t k_0 = (&kernelContext_0)->globalParams_0->rowptr_0.Load(i_0);
    for(;;)
    {

#line 29
        if(k_0 < ((&kernelContext_0)->globalParams_0->rowptr_0).Load(i_0 + 1U))
        {
        }
        else
        {
...
#line 30
        float w_0 = (&kernelContext_0)->globalParams_0->val_0.Load(k_0);
        uint32_t o_0 = (&kernelContext_0)->globalParams_0->col_0.Load(k_0) * 3U;
        float _S3 = a_0 + w_0 * (&kernelContext_0)->globalParams_0->x_0.Load(o_0);
        float _S4 = b_0 + w_0 * (&kernelContext_0)->globalParams_0->x_0.Load(o_0 + 1U);
        float _S5 = c_0 + w_0 * (&kernelContext_0)->globalParams_0->x_0.Load(o_0 + 2U);
...
#line 36
    *(&((&kernelContext_0)->globalParams_0->y_0)[_S6]) = a_0;
    *(&((&kernelContext_0)->globalParams_0->y_0)[_S6 + 1U]) = b_0;
    *(&((&kernelContext_0)->globalParams_0->y_0)[_S6 + 2U]) = c_0;
    return;
}
