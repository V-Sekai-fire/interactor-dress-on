...
#line 27
    ...
    uint32_t base_0 = c_0 * 4U;
    float n_c_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_1))->nTarget_0.Load(c_0);
    float w0_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_1))->weight_0.Load(base_0);
    uint32_t _S3 = base_0 + 1U;

#line 32
    float w1_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_1))->weight_0.Load(_S3);
    uint32_t _S4 = base_0 + 2U;

#line 33
    float w2_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_1))->weight_0.Load(_S4);
    uint32_t _S5 = base_0 + 3U;

#line 34
    float w3_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_1))->weight_0.Load(_S5);
    Vector<float, 3>  vg0_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_1))->v_grad_0.Load(base_0);
    Vector<float, 3>  vg1_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_1))->v_grad_0.Load(_S3);
    Vector<float, 3>  vg2_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_1))->v_grad_0.Load(_S4);
    Vector<float, 3>  vg3_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_1))->v_grad_0.Load(_S5);

#line 43
    float Ax_0 = w0_0 * vg0_0.x + w1_0 * vg1_0.x + (w2_0 * vg2_0.x + w3_0 * vg3_0.x);
    float Ay_0 = w0_0 * vg0_0.y + w1_0 * vg1_0.y + (w2_0 * vg2_0.y + w3_0 * vg3_0.y);
    float Az_0 = w0_0 * vg0_0.z + w1_0 * vg1_0.z + (w2_0 * vg2_0.z + w3_0 * vg3_0.z);
    float HW_0 = w0_0 * w0_0 * (slang_bit_cast<GlobalParams_0*>(globalParams_1))->v_hessScalar_0.Load(base_0) + w1_0 * w1_0 * (slang_bit_cast<GlobalParams_0*>(globalParams_1))->v_hessScalar_0.Load(_S3) + (w2_0 * w2_0 * (slang_bit_cast<GlobalParams_0*>(globalParams_1))->v_hessScalar_0.Load(_S4) + w3_0 * w3_0 * (slang_bit_cast<GlobalParams_0*>(globalParams_1))->v_hessScalar_0.Load(_S5));
...
#line 64
    if(n_c_0 > 9.99999997475242708e-07f)
    {



        Vector<float, 3>  p0_0 = (&kernelContext_0)->globalParams_0->positions_0.Load((&kernelContext_0)->globalParams_0->idx_0.Load(base_0));
        Vector<float, 3>  p1_0 = (&kernelContext_0)->globalParams_0->positions_0.Load((&kernelContext_0)->globalParams_0->idx_0.Load(_S3));
        Vector<float, 3>  p2_0 = (&kernelContext_0)->globalParams_0->positions_0.Load((&kernelContext_0)->globalParams_0->idx_0.Load(_S4));
        Vector<float, 3>  p3_0 = (&kernelContext_0)->globalParams_0->positions_0.Load((&kernelContext_0)->globalParams_0->idx_0.Load(_S5));
...
#line 110
    *(&((&kernelContext_0)->globalParams_0->v_p_0)[base_0]) = Vector<float, 3> (vpx0_0, vpy0_0, vpz0_0);
    *(&((&kernelContext_0)->globalParams_0->v_p_0)[_S3]) = Vector<float, 3> (vpx1_0, vpy1_0, vpz1_0);
    *(&((&kernelContext_0)->globalParams_0->v_p_0)[_S4]) = Vector<float, 3> (vpx2_0, vpy2_0, vpz2_0);
    *(&((&kernelContext_0)->globalParams_0->v_p_0)[_S5]) = Vector<float, 3> (vpx3_0, vpy3_0, vpz3_0);
    *(&((&kernelContext_0)->globalParams_0->v_lambda_0)[c_0]) = Vector<float, 3> (vlx_0, vly_0, vlz_0);
    *(&((&kernelContext_0)->globalParams_0->v_stiffness_0)[c_0]) = vk_0;
    *(&((&kernelContext_0)->globalParams_0->v_nTarget_0)[c_0]) = vn_0;
    return;
}
