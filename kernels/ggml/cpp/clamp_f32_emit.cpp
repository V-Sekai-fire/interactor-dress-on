...
static float pf_0(uint32_t k_1, KernelContext_0 * kernelContext_3)
{

#line 41
    uint32_t _S16 = pw_0(k_1, kernelContext_3);
    return (U32_asfloat((_S16)));
}

static float clamp_ggml_0(float x_0, float lo_0, float hi_0)
{
...
#line 59
    uint32_t _S25 = off4_0(10U, i0_2, i1_2, i2_2, i3_2, &kernelContext_4);



    float * _S26 = (&((&kernelContext_4)->globalParams_0->s0_0)[_S25]);
    float * _S27 = (&((&kernelContext_4)->globalParams_0->dst_0)[_S24]);

#line 64
    float _S28 = pf_0(37U, &kernelContext_4);

#line 64
    float _S29 = pf_0(38U, &kernelContext_4);

#line 64
    *_S27 = clamp_ggml_0(*_S26, _S28, _S29);
    return;
}
