...
#line 1 "C:/interactor-dress-on/kernels/avbd/slang/vbd_init_backward.slang"
struct VbdInitBackwardParams_0
{
    float invHSquared_0;
};
...
struct GlobalParams_0
{
    ...
    StructuredBuffer<Vector<float, 3> > predicted_0;
    StructuredBuffer<float> mass_0;
    StructuredBuffer<Vector<float, 3> > v_g_0;
    StructuredBuffer<float> v_H_0;
    RWStructuredBuffer<Vector<float, 3> > v_x_0;
    RWStructuredBuffer<Vector<float, 3> > v_y_0;
    RWStructuredBuffer<float> v_mass_0;
    VbdInitBackwardParams_0* params_0;
};
...
#line 25
    ...
    Vector<float, 3>  x_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->positions_0.Load(v_0);
    Vector<float, 3>  y_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->predicted_0.Load(v_0);

    Vector<float, 3>  vg_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_g_0.Load(v_0);
    float w_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->mass_0.Load(v_0) * (slang_bit_cast<GlobalParams_0*>(globalParams_0))->params_0->invHSquared_0;
    float _S3 = vg_0.x;
...
#line 33
    *(&((slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_x_0)[v_0]) = Vector<float, 3> (w_0 * _S3, w_0 * _S4, w_0 * _S5);
    float _S6 = 0.0f - w_0;

#line 34
    *(&((slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_y_0)[v_0]) = Vector<float, 3> (_S6 * _S3, _S6 * _S4, _S6 * _S5);

#line 40
    *(&((slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_mass_0)[v_0]) = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->params_0->invHSquared_0 * ((x_0.x - y_0.x) * _S3 + (x_0.y - y_0.y) * _S4 + (x_0.z - y_0.z) * _S5 + ((slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_H_0.Load(hb_0) + (slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_H_0.Load(hb_0 + 3U) + (slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_H_0.Load(hb_0 + 5U)));
    return;
}
