...
#line 22 "C:/interactor-dress-on/kernels/avbd/slang/vbd_gather_bending_backward.slang"
struct GlobalParams_0
{
    StructuredBuffer<uint32_t> bendIdx_0;
    StructuredBuffer<Vector<float, 3> > v_g_0;
    StructuredBuffer<float> v_H_0;
    RWStructuredBuffer<Vector<float, 3> > v_bendGrad_0;
    RWStructuredBuffer<float> v_bendHessScalar_0;
};
...
#line 13
    ...
    uint32_t slot_0 = (_S2->groupID * Vector<uint32_t, 3> (64U, 1U, 1U) + _S2->groupThreadID).x;
    uint32_t v_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->bendIdx_0.Load(slot_0);
    uint32_t hb_0 = 6U * v_0;
    Vector<float, 3>  vg_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_g_0.Load(v_0);
    float vHxx_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_H_0.Load(hb_0);
    float vHyy_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_H_0.Load(hb_0 + 3U);
    float vHzz_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_H_0.Load(hb_0 + 5U);
    *(&((slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_bendGrad_0)[slot_0]) = Vector<float, 3> (vg_0.x, vg_0.y, vg_0.z);
    *(&((slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_bendHessScalar_0)[slot_0]) = vHxx_0 + vHyy_0 + vHzz_0;
    return;
}
