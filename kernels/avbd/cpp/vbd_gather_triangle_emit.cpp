...
#line 1 "C:/interactor-dress-on/kernels/avbd/slang/vbd_gather_triangle.slang"
struct VbdGatherTriangleParams_0
{
...
{
    StructuredBuffer<Vector<float, 3> > triGrad_0;
    StructuredBuffer<float> triHessScalar_0;
    StructuredBuffer<uint32_t> vertTriOffset_0;
    StructuredBuffer<uint32_t> vertTriIdx_0;
    StructuredBuffer<uint32_t> vertTriRole_0;
    RWStructuredBuffer<Vector<float, 3> > gScratch_0;
    RWStructuredBuffer<float> hScratch_0;
    StructuredBuffer<uint32_t> vertPerm_0;
    VbdGatherTriangleParams_0* params_0;
};
...
#line 29
    ...
    uint32_t sStart_0 = (&kernelContext_0)->globalParams_0->vertTriOffset_0.Load(v_0);
    uint32_t _S3 = (&kernelContext_0)->globalParams_0->vertTriOffset_0.Load(v_0 + 1U);
...
#line 42
        ...
        uint32_t gi_0 = 3U * (&kernelContext_0)->globalParams_0->vertTriIdx_0.Load(k_0) + (&kernelContext_0)->globalParams_0->vertTriRole_0.Load(k_0);
        Vector<float, 3>  ga_0 = (&kernelContext_0)->globalParams_0->triGrad_0.Load(gi_0);
        float hs_0 = (&kernelContext_0)->globalParams_0->triHessScalar_0.Load(gi_0);
