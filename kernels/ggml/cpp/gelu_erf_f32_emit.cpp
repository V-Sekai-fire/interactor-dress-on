...
#line 1 "slang/gelu_erf_f32.slang"
struct Slot_0
{
    uint32_t base_0;
    uint32_t pad0_0;
...
#line 21 "slang/gelu_erf_f32.slang"
...
#line 62
    uint32_t _S25 = off4_0(10U, i0_2, i1_2, i2_2, i3_2, &kernelContext_3);

#line 67
    *(&((&kernelContext_3)->globalParams_0->dst_0)[_S24]) = gelu_erf_0(*(&((&kernelContext_3)->globalParams_0->s0_0)[_S25]));
    return;
}
