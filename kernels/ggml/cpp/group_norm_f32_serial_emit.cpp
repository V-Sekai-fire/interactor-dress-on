...
#line 1 "slang/group_norm_f32_serial.slang"
struct Slot_0
{
    uint32_t base_0;
    uint32_t pad0_0;
...
#line 21 "slang/group_norm_f32_serial.slang"
...
static uint32_t gidx_0(uint32_t w_1, uint32_t e_0, uint32_t n0_0, uint32_t n1_0, uint32_t c0_0, uint32_t i3_1, KernelContext_0 * kernelContext_3)
{

#line 34
    uint32_t r_0 = e_0 / n0_0;
    uint32_t _S10 = e_0 % n0_0;

#line 35
    uint32_t _S11 = r_0 % n1_0;

#line 35
    uint32_t _S12 = r_0 / n1_0;

#line 35
    uint32_t _S13 = off4_0(w_1, _S10, _S11, c0_0 + _S12, i3_1, kernelContext_3);
...
void _main_0(void* _S14, void* entryPointParams_0, void* globalParams_1)
{
...
#line 39
    ComputeThreadVaryingInput * _S15 = (slang_bit_cast<ComputeThreadVaryingInput *>(_S14));
...
#line 39
    Vector<uint32_t, 3>  _S16 = _S15->groupID;
    uint32_t _S17 = _S15->groupID.y;

#line 40
    uint32_t _S18 = pw_0(54U, &kernelContext_4);

#line 40
    uint32_t row_0 = _S17 * _S18 + _S16.x;

#line 40
    uint32_t _S19 = pw_0(55U, &kernelContext_4);
    if(row_0 >= _S19)
    {
...
#line 42
    ...
    FixedArray<float, 256>  sh_0;

#line 44
    uint32_t _S20 = pw_0(37U, &kernelContext_4);

    uint32_t g_0 = row_0 % _S20;
    uint32_t _S21 = row_0 / _S20;

#line 47
    uint32_t _S22 = pw_0(10U, &kernelContext_4);

#line 47
    uint32_t _S23 = pw_0(11U, &kernelContext_4);

#line 47
    uint32_t _S24 = pw_0(12U, &kernelContext_4);



    uint32_t cpg_0 = (_S24 + _S20 - 1U) / _S20;
    uint32_t start_0 = g_0 * cpg_0;
    uint32_t _S25 = start_0 + cpg_0;
...
#line 54
    float _S26 = pf_0(38U, &kernelContext_4);
...
#line 59
            uint32_t _S27 = gidx_0(10U, i_sumx_0, _S22, _S23, start_0, _S21, &kernelContext_4);

            float _S28 = acc_sumx_0 + *(&((&kernelContext_4)->globalParams_0->s0_0)[_S27]);

#line 61
            i_sumx_0 = i_sumx_0 + 256U;
...
#line 67
        sh_0[t_0] = sh_0[t_0] + sh_0[t_0 + 128U];
...
#line 70
        sh_0[t_0] = sh_0[t_0] + sh_0[t_0 + 64U];
...
#line 73
        sh_0[t_0] = sh_0[t_0] + sh_0[t_0 + 32U];
...
#line 76
        sh_0[t_0] = sh_0[t_0] + sh_0[t_0 + 16U];
...
#line 88
        uint32_t _S29 = t_0 + 1U;

#line 88
        sh_0[t_0] = sh_0[t_0] + sh_0[_S29];
...
#line 87
    ...
    float _S30 = float(n_0);

#line 91
    float _S31 = sh_0[0U] / _S30;
...
#line 95
            uint32_t _S32 = gidx_0(10U, i_sumx_0, _S22, _S23, start_0, _S21, &kernelContext_4);

            float _S33 = *(&((&kernelContext_4)->globalParams_0->s0_0)[_S32]) - _S31;

#line 97
            float _S34 = acc_sumx_0 + _S33 * _S33;
...
#line 124
        uint32_t _S35 = t_0 + 1U;

#line 124
        sh_0[t_0] = sh_0[t_0] + sh_0[_S35];
...
#line 128
    float _S36 = 1.0f / (F32_sqrt((sh_0[0U] / _S30 + _S26)));
...
#line 129
        uint32_t _S37 = gidx_0(10U, i_sumx_0, _S22, _S23, start_0, _S21, &kernelContext_4);
        float * _S38 = (&((&kernelContext_4)->globalParams_0->s0_0)[_S37]);

#line 130
        uint32_t _S39 = gidx_0(1U, i_sumx_0, _S22, _S23, start_0, _S21, &kernelContext_4);
        *(&((&kernelContext_4)->globalParams_0->dst_0)[_S39]) = (*_S38 - _S31) * _S36;

#line 129
        i_sumx_0 = i_sumx_0 + 1U;
