...
#line 1 "C:/interactor-dress-on/kernels/avbd/slang/triangle_bending_dual_update.slang"
struct TriangleBendingDualUpdateParams_0
{
    float beta_0;
    float penaltyMax_0;
    uint32_t count_0;
...
struct GlobalParams_0
{
    ...
    TriangleBendingDualUpdateParams_0* params_0;
};
...
#line 26
    ...
    float n_c_0 = (&kernelContext_0)->globalParams_0->nTarget_0.Load(c_0);
    uint32_t base_0 = c_0 * 4U;
    float w0_0 = (&kernelContext_0)->globalParams_0->weight_0.Load(base_0);
    uint32_t _S3 = base_0 + 1U;

#line 31
    float w1_0 = (&kernelContext_0)->globalParams_0->weight_0.Load(_S3);
    uint32_t _S4 = base_0 + 2U;

#line 32
    float w2_0 = (&kernelContext_0)->globalParams_0->weight_0.Load(_S4);
    uint32_t _S5 = base_0 + 3U;

#line 33
    float w3_0 = (&kernelContext_0)->globalParams_0->weight_0.Load(_S5);
...
#line 55
        g_eff_0 = *(&((&kernelContext_0)->globalParams_0->gamma_0)[c_0]);
...
#line 58
    Vector<float, 3>  * _S9 = (&((&kernelContext_0)->globalParams_0->lambda_0)[c_0]);
    *(&((&kernelContext_0)->globalParams_0->lambda_0)[c_0]) = Vector<float, 3> ((*_S9).x + g_eff_0 * ex_0, (*_S9).y + g_eff_0 * ey_0, (*_S9).z + g_eff_0 * ez_0);

    *(&((&kernelContext_0)->globalParams_0->gamma_0)[c_0]) = (F32_min((*(&((&kernelContext_0)->globalParams_0->gamma_0)[c_0]) + (slang_bit_cast<GlobalParams_0*>(globalParams_1))->params_0->beta_0 * (F32_sqrt((ex_0 * ex_0 + ey_0 * ey_0 + ez_0 * ez_0)))), ((slang_bit_cast<GlobalParams_0*>(globalParams_1))->params_0->penaltyMax_0)));
    return;
}
