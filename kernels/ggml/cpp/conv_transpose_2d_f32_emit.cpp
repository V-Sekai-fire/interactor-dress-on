...
#line 1 "slang/conv_transpose_2d_f32.slang"
struct Slot_0
{
    uint32_t base_0;
    uint32_t pad0_0;
...
#line 50
    unravel4_0(e_1, 1U, &ox_0, &oy_0, &oc_0, &i3_2, &kernelContext_3);

#line 50
    uint32_t _S23 = pw_0(37U, &kernelContext_3);

#line 50
    uint32_t _S24 = pw_0(10U, &kernelContext_3);

#line 50
    uint32_t _S25 = pw_0(11U, &kernelContext_3);

#line 50
    uint32_t _S26 = pw_0(13U, &kernelContext_3);

#line 50
    uint32_t _S27 = pw_0(19U, &kernelContext_3);

#line 50
    uint32_t _S28 = pw_0(20U, &kernelContext_3);

#line 50
    uint32_t _S29 = pw_0(14U, &kernelContext_3);

#line 50
    uint32_t _S30 = pw_0(15U, &kernelContext_3);

#line 50
    uint32_t _S31 = pw_0(16U, &kernelContext_3);

#line 50
    uint32_t _S32 = pw_0(17U, &kernelContext_3);

#line 50
    uint32_t _S33 = pw_0(23U, &kernelContext_3);

#line 50
    uint32_t _S34 = pw_0(24U, &kernelContext_3);

#line 50
    uint32_t _S35 = pw_0(25U, &kernelContext_3);

#line 50
    uint32_t _S36 = pw_0(18U, &kernelContext_3);

#line 65
    uint32_t _S37 = _S36 + oc_0 * _S31;
...
#line 74
                    uint32_t _S41 = pw_0(27U, &kernelContext_3);
                    uint32_t _S42 = _S41 + (i10_0 * _S33 + i11_0 * _S34);
                    uint32_t _S43 = _S37 + (kx_0 * _S29 + _S39 * _S30);
...
#line 79
                        float _S44 = vdot_0 + *(&((&kernelContext_3)->globalParams_0->s1_0)[_S42 + ic_0 * _S35]) * *(&((&kernelContext_3)->globalParams_0->s0_0)[_S43 + ic_0 * _S32]);
...
#line 67
    uint32_t _S45 = off4_0(1U, ox_0, oy_0, oc_0, i3_2, &kernelContext_3);

#line 86
    *(&((&kernelContext_3)->globalParams_0->dst_0)[_S45]) = acc_0;
    return;
}
