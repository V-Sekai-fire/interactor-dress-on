...
#line 62 "C:/interactor-dress-on/kernels/avbd/slang/triangle_bending_force_al.slang"
...
#line 34
    if(n_c_0 > 9.99999997475242708e-07f)
    {
        ...
        Vector<float, 3>  lam_0 = (&kernelContext_0)->globalParams_0->lambda_0.Load(c_0);
        float _S9 = lam_0.x;
        float _S10 = lam_0.y;
        float _S11 = lam_0.z;

#line 56
        k_eff_0 = (&kernelContext_0)->globalParams_0->stiffness_0.Load(c_0);
...
#line 58
    float _S12 = k_eff_0 * w0_0;

#line 58
    *(&((&kernelContext_0)->globalParams_0->grad_0)[base_0]) = Vector<float, 3> (_S12 * ex_0 + w0_0 * lx_0, _S12 * ey_0 + w0_0 * ly_0, _S12 * ez_0 + w0_0 * lz_0);
    float _S13 = k_eff_0 * w1_0;

#line 59
    *(&((&kernelContext_0)->globalParams_0->grad_0)[_S3]) = Vector<float, 3> (_S13 * ex_0 + w1_0 * lx_0, _S13 * ey_0 + w1_0 * ly_0, _S13 * ez_0 + w1_0 * lz_0);
    float _S14 = k_eff_0 * w2_0;

#line 60
    *(&((&kernelContext_0)->globalParams_0->grad_0)[_S4]) = Vector<float, 3> (_S14 * ex_0 + w2_0 * lx_0, _S14 * ey_0 + w2_0 * ly_0, _S14 * ez_0 + w2_0 * lz_0);
    float _S15 = k_eff_0 * w3_0;

#line 61
    *(&((&kernelContext_0)->globalParams_0->grad_0)[_S5]) = Vector<float, 3> (_S15 * ex_0 + w3_0 * lx_0, _S15 * ey_0 + w3_0 * ly_0, _S15 * ez_0 + w3_0 * lz_0);
    *(&((&kernelContext_0)->globalParams_0->hessScalar_0)[base_0]) = k_eff_0 * (w0_0 * w0_0);
    *(&((&kernelContext_0)->globalParams_0->hessScalar_0)[_S3]) = k_eff_0 * (w1_0 * w1_0);
    *(&((&kernelContext_0)->globalParams_0->hessScalar_0)[_S4]) = k_eff_0 * (w2_0 * w2_0);
    *(&((&kernelContext_0)->globalParams_0->hessScalar_0)[_S5]) = k_eff_0 * (w3_0 * w3_0);
    return;
}
