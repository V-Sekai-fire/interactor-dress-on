...
#line 1 "slang/mean_f32_serial.slang"
struct Slot_0
{
    uint32_t base_0;
    uint32_t pad0_0;
...
void _main_0(void* _S9, void* entryPointParams_0, void* globalParams_1)
{

#line 30
    ComputeThreadVaryingInput * _S10 = (slang_bit_cast<ComputeThreadVaryingInput *>(_S9));
...
#line 30
    Vector<uint32_t, 3>  _S11 = _S10->groupID;
    uint32_t _S12 = _S10->groupID.y;

#line 31
    uint32_t _S13 = pw_0(54U, &kernelContext_2);

#line 31
    uint32_t row_0 = _S12 * _S13 + _S11.x;

#line 31
    uint32_t _S14 = pw_0(55U, &kernelContext_2);
    if(row_0 >= _S14)
    {
...
#line 35
    uint32_t _S15 = pw_0(10U, &kernelContext_2);

#line 35
    uint32_t _S16 = pw_0(11U, &kernelContext_2);

    uint32_t r1_0 = row_0 % _S16;

#line 37
    uint32_t _S17 = pw_0(11U, &kernelContext_2);
    uint32_t rr_0 = row_0 / _S17;

#line 38
    uint32_t _S18 = pw_0(12U, &kernelContext_2);
    uint32_t r2_0 = rr_0 % _S18;

#line 39
    uint32_t _S19 = pw_0(12U, &kernelContext_2);
    uint32_t r3_0 = rr_0 / _S19;

#line 40
    uint32_t _S20 = off4_0(10U, 0U, r1_0, r2_0, r3_0, &kernelContext_2);

#line 40
    uint32_t _S21 = pw_0(14U, &kernelContext_2);

#line 40
    uint32_t _S22 = off4_0(1U, 0U, r1_0, r2_0, r3_0, &kernelContext_2);
...
#line 45
        uint32_t i_sumx_0 = t_0;

#line 45
        float acc_sumx_0 = 0.0f;
...
#line 48
            ...
            float _S23 = acc_sumx_0 + *(&((&kernelContext_2)->globalParams_0->s0_0)[_S20 + i_sumx_0 * _S21]);
...
#line 77
        uint32_t _S24 = t_0 + 1U;

#line 77
        sh_0[t_0] = sh_0[t_0] + sh_0[_S24];
...
#line 76
    ...
    *(&((&kernelContext_2)->globalParams_0->dst_0)[_S22]) = sh_0[0U] / float(_S15);
    return;
}
