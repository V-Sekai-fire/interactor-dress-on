...
static uint32_t ld16_s1_0(uint32_t e_2, KernelContext_0 * kernelContext_4)
{

#line 46
    return ((*(&(kernelContext_4->globalParams_0->s1_0)[e_2 >> 1U])) >> ((e_2 & 1U) * 16U)) & 65535U;
}

static uint32_t val_0(uint32_t i0_2, uint32_t i1_2, uint32_t i2_2, uint32_t i3_2, KernelContext_0 * kernelContext_5)
{

#line 49
    uint32_t _S16 = pw_0(10U, kernelContext_5);

#line 49
    uint32_t _S17 = pw_0(11U, kernelContext_5);

#line 49
    uint32_t _S18 = pw_0(12U, kernelContext_5);

#line 49
    uint32_t _S19 = pw_0(13U, kernelContext_5);
...
#line 54
        uint32_t _S21 = off4_0(10U, i0_2, i1_2, i2_2, i3_2, kernelContext_5);

#line 54
        uint32_t _S22 = ld16_s0_0(_S21, kernelContext_5);
        return _S22;
    }
...
#line 57
    uint32_t _S27 = off4_0(19U, _S23, _S24, _S25, _S26, kernelContext_5);

#line 57
    uint32_t _S28 = ld16_s1_0(_S27, kernelContext_5);
...
void _main_0(void* _S29, void* entryPointParams_0, void* globalParams_1)
{

#line 61
    ComputeThreadVaryingInput * _S30 = (slang_bit_cast<ComputeThreadVaryingInput *>(_S29));

#line 61
    KernelContext_0 kernelContext_6;

#line 61
    (&kernelContext_6)->globalParams_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_1));

#line 61
    Vector<uint32_t, 3>  _S31 = _S30->groupID;

#line 61
    Vector<uint32_t, 3>  _S32 = _S30->groupThreadID;
    uint32_t _S33 = _S30->groupID.y;

#line 62
    uint32_t _S34 = pw_0(54U, &kernelContext_6);

#line 62
    uint32_t e_3 = (_S33 * _S34 + _S31.x) * 256U + _S32.x;

#line 62
    uint32_t _S35 = pw_0(53U, &kernelContext_6);
    if(e_3 >= _S35)
    {
...
#line 69
    unravel4_0(e_3, 1U, &i0_3, &i1_3, &i2_3, &i3_3, &kernelContext_6);

#line 69
    uint32_t _S36 = off4_0(1U, i0_3, i1_3, i2_3, i3_3, &kernelContext_6);

#line 69
    uint32_t _S37 = pw_0(55U, &kernelContext_6);
...
#line 75
        ...
        uint32_t _S38 = _S36 >> 1U;

#line 77
        uint32_t * _S39 = (&((&kernelContext_6)->globalParams_0->dst_0)[_S38]);

#line 77
        uint32_t _S40 = (*(&((&kernelContext_6)->globalParams_0->dst_0)[_S38])) & 65535U;

#line 77
        uint32_t _S41 = val_0(i0_3, i1_3, i2_3, i3_3, &kernelContext_6);
...
#line 78
    uint32_t _S42 = val_0(i0_3, i1_3, i2_3, i3_3, &kernelContext_6);
...
#line 86
        uint32_t _S47 = i0_3 + 1U;

#line 86
        uint32_t _S48 = pw_0(1U, &kernelContext_6);
...
#line 89
            uint32_t _S50 = i1_3 + 1U;

#line 89
            uint32_t _S51 = pw_0(2U, &kernelContext_6);
...
#line 93
                uint32_t _S53 = i2_3 + 1U;

#line 93
                uint32_t _S54 = pw_0(3U, &kernelContext_6);
...
#line 98
                    uint32_t _S56 = i3_3 + 1U;

#line 98
                    uint32_t _S57 = pw_0(4U, &kernelContext_6);
...
#line 110
        uint32_t * _S59 = (&((&kernelContext_6)->globalParams_0->dst_0)[_S36 >> 1U]);

#line 110
        uint32_t _S60 = val_0(k0_0, k1_0, k2_0, k3_0, &kernelContext_6);
...
#line 109
    ...
    {
        uint32_t _S61 = _S36 >> 1U;

#line 112
        *(&((&kernelContext_6)->globalParams_0->dst_0)[_S61]) = ((*(&((&kernelContext_6)->globalParams_0->dst_0)[_S61])) & 4294901760U) | _S42;
