...
#line 1 "slang/flash_attn_ext_f32_d128_serial.slang"
struct Slot_0
{
    uint32_t base_0;
    uint32_t pad0_0;
...
#line 21 "slang/flash_attn_ext_f32_d128_serial.slang"
...
#line 35
    uint32_t e_0 = (_S14 * _S15 + _S12.x) * 64U + _S13.x;
...
#line 37
    uint32_t _S17 = pw_0(11U, &kernelContext_3);


    uint32_t iq_0 = e_0 % _S17;
    uint32_t rr_0 = e_0 / _S17;

#line 41
    uint32_t _S18 = pw_0(12U, &kernelContext_3);
    uint32_t h_0 = rr_0 % _S18;

#line 42
    uint32_t _S19 = pw_0(12U, &kernelContext_3);
...
#line 43
    uint32_t _S21 = pw_0(55U, &kernelContext_3);

    uint32_t hk_0 = h_0 / _S21;
...
#line 46
    uint32_t _S23 = pw_0(57U, &kernelContext_3);
    uint32_t hv_0 = h_0 / _S23;

#line 47
    uint32_t _S24 = pw_0(58U, &kernelContext_3);
    uint32_t bv_0 = b_0 / _S24;

#line 48
    float _S25 = pf_0(59U, &kernelContext_3);

#line 48
    float _S26 = pf_0(60U, &kernelContext_3);

#line 48
    uint32_t _S27 = off4_0(10U, 0U, iq_0, h_0, b_0, &kernelContext_3);

#line 48
    uint32_t _S28 = off4_0(19U, 0U, 0U, hk_0, bk_0, &kernelContext_3);

#line 48
    uint32_t _S29 = pw_0(24U, &kernelContext_3);

#line 48
    uint32_t _S30 = off4_0(28U, 0U, 0U, hv_0, bv_0, &kernelContext_3);

#line 48
    uint32_t _S31 = pw_0(33U, &kernelContext_3);
...
#line 60
        qv_0[c_0] = *(&((&kernelContext_3)->globalParams_0->s0_0)[_S27 + c_0]);
        acc_0[c_0] = 0.0f;
...
#line 74
                    float _S35 = s_0 + qv_0[c_0] * *(&((&kernelContext_3)->globalParams_0->s1_0)[_S28 + key_0 * _S29 + c_0]);
...
#line 85
            float _S36 = (F32_max((s_0), (sc_0[j_1])));
...
#line 98
                    acc_0[c_2] = acc_0[c_2] + p_0 * *(&((&kernelContext_3)->globalParams_0->s2_0)[_S30 + key_1 * _S31 + c_2]);
...
#line 106
        uint32_t _S39 = off4_0(1U, c_0, h_0, iq_0, b_0, &kernelContext_3);
        *(&((&kernelContext_3)->globalParams_0->dst_0)[_S39]) = acc_0[c_0] * m_0;
