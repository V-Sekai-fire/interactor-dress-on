...
struct GlobalParams_0
{
    ...
    RWStructuredBuffer<float> world_0;
    RWStructuredBuffer<float> bone_0;
};
...
#line 23
    ...
    if(((_S2->groupID + _S2->groupThreadID).x) != 0U)
    {
...
#line 27
        if(j_0 < ((&kernelContext_0)->globalParams_0->params_0->J_0))
        {
        }
        else
        {
...
#line 42
            Pp0_0 = *(&((&kernelContext_0)->globalParams_0->world_0)[pi_0 * 12U]);
...
#line 43
            Pp1_0 = *(&((&kernelContext_0)->globalParams_0->world_0)[pi_0 * 12U + 1U]);
...
#line 44
            Pp2_0 = *(&((&kernelContext_0)->globalParams_0->world_0)[pi_0 * 12U + 2U]);
...
#line 45
            Pp3_0 = *(&((&kernelContext_0)->globalParams_0->world_0)[pi_0 * 12U + 4U]);
...
#line 46
            Pp4_0 = *(&((&kernelContext_0)->globalParams_0->world_0)[pi_0 * 12U + 5U]);
...
#line 47
            Pp5_0 = *(&((&kernelContext_0)->globalParams_0->world_0)[pi_0 * 12U + 6U]);
...
#line 48
            Pp6_0 = *(&((&kernelContext_0)->globalParams_0->world_0)[pi_0 * 12U + 8U]);
...
#line 49
            Pp7_0 = *(&((&kernelContext_0)->globalParams_0->world_0)[pi_0 * 12U + 9U]);
...
#line 50
            Pp8_0 = *(&((&kernelContext_0)->globalParams_0->world_0)[pi_0 * 12U + 10U]);
...
#line 51
            qp0_0 = *(&((&kernelContext_0)->globalParams_0->world_0)[pi_0 * 12U + 3U]);
...
#line 52
            qp1_0 = *(&((&kernelContext_0)->globalParams_0->world_0)[pi_0 * 12U + 7U]);
...
#line 53
            qp2_0 = *(&((&kernelContext_0)->globalParams_0->world_0)[pi_0 * 12U + 11U]);
...
#line 54
        float Rbj0_0 = (&kernelContext_0)->globalParams_0->rb_0.Load(_S3);
        float Rbj1_0 = (&kernelContext_0)->globalParams_0->rb_0.Load(_S3 + 1U);
        float Rbj2_0 = (&kernelContext_0)->globalParams_0->rb_0.Load(_S3 + 2U);
        float Rbj3_0 = (&kernelContext_0)->globalParams_0->rb_0.Load(_S3 + 3U);
        float Rbj4_0 = (&kernelContext_0)->globalParams_0->rb_0.Load(_S3 + 4U);
        float Rbj5_0 = (&kernelContext_0)->globalParams_0->rb_0.Load(_S3 + 5U);
        float Rbj6_0 = (&kernelContext_0)->globalParams_0->rb_0.Load(_S3 + 6U);
        float Rbj7_0 = (&kernelContext_0)->globalParams_0->rb_0.Load(_S3 + 7U);
        float Rbj8_0 = (&kernelContext_0)->globalParams_0->rb_0.Load(_S3 + 8U);
        uint32_t _S4 = j_0 * 3U;

#line 63
        float jj0_0 = (&kernelContext_0)->globalParams_0->jpos_0.Load(_S4);
        float jj1_0 = (&kernelContext_0)->globalParams_0->jpos_0.Load(_S4 + 1U);
        float jj2_0 = (&kernelContext_0)->globalParams_0->jpos_0.Load(_S4 + 2U);
        uint32_t _S5 = j_0 * 6U;

#line 66
        float R_a10_0 = (&kernelContext_0)->globalParams_0->rot6_0.Load(_S5);
        float R_a11_0 = (&kernelContext_0)->globalParams_0->rot6_0.Load(_S5 + 1U);
        float R_a12_0 = (&kernelContext_0)->globalParams_0->rot6_0.Load(_S5 + 2U);
        float R_a20_0 = (&kernelContext_0)->globalParams_0->rot6_0.Load(_S5 + 3U);
        float R_a21_0 = (&kernelContext_0)->globalParams_0->rot6_0.Load(_S5 + 4U);
        float R_a22_0 = (&kernelContext_0)->globalParams_0->rot6_0.Load(_S5 + 5U);
        float _S6 = (F32_max(((F32_sqrt((R_a10_0 * R_a10_0 + R_a11_0 * R_a11_0 + R_a12_0 * R_a12_0)))), (9.99999968265522539e-21f)));
        float R_r10_0 = R_a10_0 / _S6;
        float R_r11_0 = R_a11_0 / _S6;
        float R_r12_0 = R_a12_0 / _S6;
        ...
        float _S7 = (F32_max(((F32_sqrt((R_u0_0 * R_u0_0 + R_u1_0 * R_u1_0 + R_u2_0 * R_u2_0)))), (9.99999968265522539e-21f)));
        float R_r20_0 = R_u0_0 / _S7;
        float R_r21_0 = R_u1_0 / _S7;
        float R_r22_0 = R_u2_0 / _S7;
...
#line 96
        ...
        float P0_0 = Pp0_0 * A0_0 + Pp1_0 * A3_0 + Pp2_0 * A6_0;
        float P1_0 = Pp0_0 * A1_0 + Pp1_0 * A4_0 + Pp2_0 * A7_0;
        float P2_0 = Pp0_0 * A2_0 + Pp1_0 * A5_0 + Pp2_0 * A8_0;
        float P3_0 = Pp3_0 * A0_0 + Pp4_0 * A3_0 + Pp5_0 * A6_0;
        float P4_0 = Pp3_0 * A1_0 + Pp4_0 * A4_0 + Pp5_0 * A7_0;
        float P5_0 = Pp3_0 * A2_0 + Pp4_0 * A5_0 + Pp5_0 * A8_0;
        float P6_0 = Pp6_0 * A0_0 + Pp7_0 * A3_0 + Pp8_0 * A6_0;
        float P7_0 = Pp6_0 * A1_0 + Pp7_0 * A4_0 + Pp8_0 * A7_0;
        float P8_0 = Pp6_0 * A2_0 + Pp7_0 * A5_0 + Pp8_0 * A8_0;



        float q0_0 = Pp0_0 * c0_0 + Pp1_0 * c1_0 + Pp2_0 * c2_0 + qp0_0;
        float q1_0 = Pp3_0 * c0_0 + Pp4_0 * c1_0 + Pp5_0 * c2_0 + qp1_0;
        float q2_0 = Pp6_0 * c0_0 + Pp7_0 * c1_0 + Pp8_0 * c2_0 + qp2_0;
        uint32_t _S8 = j_0 * 12U;

#line 135
        *(&((&kernelContext_0)->globalParams_0->world_0)[_S8]) = P0_0;
        uint32_t _S9 = _S8 + 1U;

#line 136
        *(&((&kernelContext_0)->globalParams_0->world_0)[_S9]) = P1_0;
        uint32_t _S10 = _S8 + 2U;

#line 137
        *(&((&kernelContext_0)->globalParams_0->world_0)[_S10]) = P2_0;
        uint32_t _S11 = _S8 + 4U;

#line 138
        *(&((&kernelContext_0)->globalParams_0->world_0)[_S11]) = P3_0;
        uint32_t _S12 = _S8 + 5U;

#line 139
        *(&((&kernelContext_0)->globalParams_0->world_0)[_S12]) = P4_0;
        uint32_t _S13 = _S8 + 6U;

#line 140
        *(&((&kernelContext_0)->globalParams_0->world_0)[_S13]) = P5_0;
        uint32_t _S14 = _S8 + 8U;

#line 141
        *(&((&kernelContext_0)->globalParams_0->world_0)[_S14]) = P6_0;
        uint32_t _S15 = _S8 + 9U;

#line 142
        *(&((&kernelContext_0)->globalParams_0->world_0)[_S15]) = P7_0;
        uint32_t _S16 = _S8 + 10U;

#line 143
        *(&((&kernelContext_0)->globalParams_0->world_0)[_S16]) = P8_0;
        uint32_t _S17 = _S8 + 3U;

#line 144
        *(&((&kernelContext_0)->globalParams_0->world_0)[_S17]) = q0_0;
        uint32_t _S18 = _S8 + 7U;

#line 145
        *(&((&kernelContext_0)->globalParams_0->world_0)[_S18]) = q1_0;
        uint32_t _S19 = _S8 + 11U;

#line 146
        *(&((&kernelContext_0)->globalParams_0->world_0)[_S19]) = q2_0;
        float B0_0 = P0_0 * Rbj0_0 + P1_0 * Rbj1_0 + P2_0 * Rbj2_0;
        float B1_0 = P0_0 * Rbj3_0 + P1_0 * Rbj4_0 + P2_0 * Rbj5_0;
        float B2_0 = P0_0 * Rbj6_0 + P1_0 * Rbj7_0 + P2_0 * Rbj8_0;
        float B3_0 = P3_0 * Rbj0_0 + P4_0 * Rbj1_0 + P5_0 * Rbj2_0;
        float B4_0 = P3_0 * Rbj3_0 + P4_0 * Rbj4_0 + P5_0 * Rbj5_0;
        float B5_0 = P3_0 * Rbj6_0 + P4_0 * Rbj7_0 + P5_0 * Rbj8_0;
        float B6_0 = P6_0 * Rbj0_0 + P7_0 * Rbj1_0 + P8_0 * Rbj2_0;
        float B7_0 = P6_0 * Rbj3_0 + P7_0 * Rbj4_0 + P8_0 * Rbj5_0;
        float B8_0 = P6_0 * Rbj6_0 + P7_0 * Rbj7_0 + P8_0 * Rbj8_0;



        float b0_0 = q0_0 - (B0_0 * jj0_0 + B1_0 * jj1_0 + B2_0 * jj2_0);
        float b1_0 = q1_0 - (B3_0 * jj0_0 + B4_0 * jj1_0 + B5_0 * jj2_0);
        float b2_0 = q2_0 - (B6_0 * jj0_0 + B7_0 * jj1_0 + B8_0 * jj2_0);
        *(&((&kernelContext_0)->globalParams_0->bone_0)[_S8]) = B0_0;
        *(&((&kernelContext_0)->globalParams_0->bone_0)[_S9]) = B1_0;
        *(&((&kernelContext_0)->globalParams_0->bone_0)[_S10]) = B2_0;
        *(&((&kernelContext_0)->globalParams_0->bone_0)[_S11]) = B3_0;
        *(&((&kernelContext_0)->globalParams_0->bone_0)[_S12]) = B4_0;
        *(&((&kernelContext_0)->globalParams_0->bone_0)[_S13]) = B5_0;
        *(&((&kernelContext_0)->globalParams_0->bone_0)[_S14]) = B6_0;
        *(&((&kernelContext_0)->globalParams_0->bone_0)[_S15]) = B7_0;
        *(&((&kernelContext_0)->globalParams_0->bone_0)[_S16]) = B8_0;
        *(&((&kernelContext_0)->globalParams_0->bone_0)[_S17]) = b0_0;
        *(&((&kernelContext_0)->globalParams_0->bone_0)[_S18]) = b1_0;
        *(&((&kernelContext_0)->globalParams_0->bone_0)[_S19]) = b2_0;
