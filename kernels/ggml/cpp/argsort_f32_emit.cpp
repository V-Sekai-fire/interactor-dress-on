...
#line 1 "slang/argsort_f32.slang"
struct Slot_0
{
    uint32_t base_0;
    uint32_t pad0_0;
...
#line 50
    uint32_t _S23 = off4_0(10U, 0U, i1_2, i2_2, i3_2, &kernelContext_3);

#line 50
    uint32_t _S24 = pw_0(14U, &kernelContext_3);

#line 50
    uint32_t _S25 = pw_0(10U, &kernelContext_3);

#line 50
    uint32_t _S26 = pw_0(37U, &kernelContext_3);

#line 55
    bool _S27 = _S26 != 0U;
    float _S28 = *(&((&kernelContext_3)->globalParams_0->s0_0)[_S23 + i0_2 * _S24]);
...
#line 59
        float xk_0 = *(&((&kernelContext_3)->globalParams_0->s0_0)[_S23 + k_1 * _S24]);
...
#line 58
    uint32_t _S30 = off4_0(1U, rank_0, i1_2, i2_2, i3_2, &kernelContext_3);

#line 65
    *(&((&kernelContext_3)->globalParams_0->dst_0)[_S30]) = i0_2;
    return;
}
