...
#line 1 "slang/sum_f32_serial.slang"
struct Slot_0
{
    uint32_t base_0;
    uint32_t pad0_0;
...
#line 43
    uint32_t e_1 = _S20 * _S21 + _S18.x + _S19.x;
...
#line 45
    uint32_t _S23 = pw_0(10U, &kernelContext_3);

#line 45
    uint32_t _S24 = pw_0(11U, &kernelContext_3);

    uint32_t _S25 = _S23 * _S24;

#line 47
    uint32_t _S26 = pw_0(12U, &kernelContext_3);

#line 47
    uint32_t _S27 = _S25 * _S26;

#line 47
    uint32_t _S28 = pw_0(13U, &kernelContext_3);

#line 47
    uint32_t _S29 = _S27 * _S28;
...
#line 56
            unravel4_0(i_0, 10U, &j0_0, &j1_0, &j2_0, &j3_0, &kernelContext_3);

#line 56
            uint32_t _S30 = off4_0(10U, j0_0, j1_0, j2_0, j3_0, &kernelContext_3);


            float _S31 = acc_0 + *(&((&kernelContext_3)->globalParams_0->s0_0)[_S30]);
...
#line 85
    uint32_t _S33 = pw_0(9U, &kernelContext_3);



    *(&((&kernelContext_3)->globalParams_0->dst_0)[_S33]) = sh_0[0U];
    return;
}
