...
#line 1 "slang/sdf_spline_hessian.slang"
struct SdfSplineParams_0
{
    uint32_t count_0;
};
...
{
    StructuredBuffer<double> stencil_0;
    StructuredBuffer<double> uvw_0;
    RWStructuredBuffer<double> result_0;
    SdfSplineParams_0* params_0;
};
...
#line 14
static double bspline_0(double x_0)
{

#line 15
    double absx_0 = (F64_abs((x_0)));
    if(absx_0 >= 2.0)
    {
...
#line 20
        double tmp_0 = 2.0 - absx_0;
        return tmp_0 * tmp_0 * tmp_0 / 6.0;
    }
    return 0.66666666666666663 + (0.5 * absx_0 - 1.0) * x_0 * x_0;
}

static double bspline_d1_0(double x_1)
{

#line 27
    double absx_1 = (F64_abs((x_1)));
    if(absx_1 >= 2.0)
    {
...
#line 32
        double tmp_1 = 2.0 - absx_1;
        double _S1 = -0.5 * tmp_1 * tmp_1;
...
#line 33
    ...
    return x_1 * (1.5 * absx_1 - 2.0);
}

static double bspline_d2_0(double x_2)
{

#line 39
    double absx_2 = (F64_abs((x_2)));
    if(absx_2 >= 2.0)
    {
...
#line 44
    ...
    return 3.0 * absx_2 - 2.0;
}


void _main_0(void* _S3, void* entryPointParams_0, void* globalParams_1)
{

#line 50
    ComputeThreadVaryingInput * _S4 = (slang_bit_cast<ComputeThreadVaryingInput *>(_S3));
...
#line 50
    ...
    uint32_t lane_0 = (_S4->groupID * Vector<uint32_t, 3> (64U, 1U, 1U) + _S4->groupThreadID).x;
    if(lane_0 >= ((slang_bit_cast<GlobalParams_0*>(globalParams_1))->params_0->count_0))
    {

#line 53
        return;
    }
    uint32_t _S5 = 64U * lane_0;
    uint32_t _S6 = 3U * lane_0;
    uint32_t rb_0 = 10U * lane_0;
    FixedArray<double, 12>  basis_0;
    FixedArray<double, 12>  deriv1_0;
    FixedArray<double, 12>  deriv2_0;
...
#line 62
        double w_0 = (&kernelContext_0)->globalParams_0->uvw_0.Load(_S6 + d_0);
        uint32_t t_0 = 4U * d_0;
        double _S7 = w_0 + 1.0;

#line 64
        basis_0[t_0] = bspline_0(_S7);
        deriv1_0[t_0] = bspline_d1_0(_S7);
        deriv2_0[t_0] = bspline_d2_0(_S7);
        uint32_t _S8 = t_0 + 1U;

#line 67
        basis_0[_S8] = bspline_0(w_0);
        deriv1_0[_S8] = bspline_d1_0(w_0);
        deriv2_0[_S8] = bspline_d2_0(w_0);
        uint32_t _S9 = t_0 + 2U;
...
#line 70
        basis_0[_S9] = bspline_0(_S10);
        deriv1_0[_S9] = - bspline_d1_0(_S10);
        deriv2_0[_S9] = bspline_d2_0(_S10);
        uint32_t _S11 = t_0 + 3U;

#line 73
        double _S12 = 2.0 - w_0;

#line 73
        basis_0[_S11] = bspline_0(_S12);
        deriv1_0[_S11] = - bspline_d1_0(_S12);
        deriv2_0[_S11] = bspline_d2_0(_S12);
...
#line 90
                double s_0 = (&kernelContext_0)->globalParams_0->stencil_0.Load(_S5 + i_0 * 16U + j_0 * 4U + k_0);
                uint32_t _S13 = 4U + j_0;

#line 91
                uint32_t _S14 = 8U + k_0;

#line 91
                double _S15 = x_4 + s_0 * basis_0[i_0] * basis_0[_S13] * basis_0[_S14];
                double _S16 = g0_1 + s_0 * deriv1_0[i_0] * basis_0[_S13] * basis_0[_S14];
                double _S17 = g1_1 + s_0 * basis_0[i_0] * deriv1_0[_S13] * basis_0[_S14];
                double _S18 = g2_1 + s_0 * basis_0[i_0] * basis_0[_S13] * deriv1_0[_S14];
                double _S19 = h00_1 + s_0 * deriv2_0[i_0] * basis_0[_S13] * basis_0[_S14];
                double _S20 = h01_1 + s_0 * deriv1_0[i_0] * deriv1_0[_S13] * basis_0[_S14];
                double _S21 = h02_1 + s_0 * deriv1_0[i_0] * basis_0[_S13] * deriv1_0[_S14];
                double _S22 = h11_1 + s_0 * basis_0[i_0] * deriv2_0[_S13] * basis_0[_S14];
                double _S23 = h12_1 + s_0 * basis_0[i_0] * deriv1_0[_S13] * deriv1_0[_S14];
                double _S24 = h22_1 + s_0 * basis_0[i_0] * basis_0[_S13] * deriv2_0[_S14];
...
#line 104
    *(&((&kernelContext_0)->globalParams_0->result_0)[rb_0]) = x_3;
    *(&((&kernelContext_0)->globalParams_0->result_0)[rb_0 + 1U]) = g0_0;
    *(&((&kernelContext_0)->globalParams_0->result_0)[rb_0 + 2U]) = g1_0;
    *(&((&kernelContext_0)->globalParams_0->result_0)[rb_0 + 3U]) = g2_0;
    *(&((&kernelContext_0)->globalParams_0->result_0)[rb_0 + 4U]) = h00_0;
    *(&((&kernelContext_0)->globalParams_0->result_0)[rb_0 + 5U]) = h01_0;
    *(&((&kernelContext_0)->globalParams_0->result_0)[rb_0 + 6U]) = h02_0;
    *(&((&kernelContext_0)->globalParams_0->result_0)[rb_0 + 7U]) = h11_0;
    *(&((&kernelContext_0)->globalParams_0->result_0)[rb_0 + 8U]) = h12_0;
    *(&((&kernelContext_0)->globalParams_0->result_0)[rb_0 + 9U]) = h22_0;
    return;
}
