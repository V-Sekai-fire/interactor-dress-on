...
#line 1 "slang/anny_vert_residual.slang"
struct AnnyResidualParams_0
{
    uint32_t n_0;
};
...
{
    AnnyResidualParams_0* params_0;
    StructuredBuffer<float> verts_0;
    StructuredBuffer<float> target_0;
    RWStructuredBuffer<float> dverts_0;
};
...
#line 18
    ...
    *(&((&kernelContext_0)->globalParams_0->dverts_0)[i_0]) = (&kernelContext_0)->globalParams_0->verts_0.Load(i_0) - (&kernelContext_0)->globalParams_0->target_0.Load(i_0);
    return;
}
