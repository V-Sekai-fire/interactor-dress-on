...
#line 1 "slang/anny_blend_backward.slang"
...
struct GlobalParams_0
{
    ...
    StructuredBuffer<float> dvanny_0;
    RWStructuredBuffer<float> dcoeffs_0;
};
...
#line 67
    ...
    uint32_t n_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_1))->params_0->P_0 * 3U;
    uint32_t _S3 = c_0 * n_0;
    float hi_4 = 0.0f;
    float lo_4 = 0.0f;
...
#line 74
        df_acc_0(&hi_4, &lo_4, (&kernelContext_0)->globalParams_0->blend_0.Load(_S3 + i_0), (&kernelContext_0)->globalParams_0->dvanny_0.Load(i_0));
...
#line 73
    ...
    *(&((&kernelContext_0)->globalParams_0->dcoeffs_0)[c_0]) = hi_4 + lo_4;
    return;
}
