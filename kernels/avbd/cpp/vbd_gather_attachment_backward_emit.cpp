...
#line 22 "C:/interactor-dress-on/kernels/avbd/slang/vbd_gather_attachment_backward.slang"
struct GlobalParams_0
{
    StructuredBuffer<uint32_t> attachVertIdx_0;
    StructuredBuffer<Vector<float, 3> > v_g_0;
    StructuredBuffer<float> v_H_0;
    RWStructuredBuffer<Vector<float, 3> > v_attachGradV_0;
    RWStructuredBuffer<float> v_attachHessScalar_0;
};
...
#line 13
    ...
    uint32_t v_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->attachVertIdx_0.Load(c_0);
    ...
    *(&((slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_attachGradV_0)[c_0]) = Vector<float, 3> (vg_0.x, vg_0.y, vg_0.z);
    *(&((slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_attachHessScalar_0)[c_0]) = vHxx_0 + vHyy_0 + vHzz_0;
    return;
}
