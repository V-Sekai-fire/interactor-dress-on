...
static float tanh_clamped_0(float x_0)
{
...
#line 60
    *(&((&kernelContext_3)->globalParams_0->dst_0)[_S23]) = tanh_clamped_0(*(&((&kernelContext_3)->globalParams_0->s0_0)[_S24]));
    return;
}
