...
#line 26
    ...
    Vector<float, 3>  x_0 = (&kernelContext_0)->globalParams_0->positions_0.Load(v_0);
    Vector<float, 3>  px_0 = (&kernelContext_0)->globalParams_0->predicted_0.Load(v_0);

    float w_0 = (&kernelContext_0)->globalParams_0->mass_0.Load(v_0) * (slang_bit_cast<GlobalParams_0*>(globalParams_1))->params_0->invHSquared_0;
    *(&((&kernelContext_0)->globalParams_0->gScratch_0)[v_0]) = Vector<float, 3> (w_0 * (x_0.x - px_0.x), w_0 * (x_0.y - px_0.y), w_0 * (x_0.z - px_0.z));
    uint32_t hb_0 = 6U * v_0;
    *(&((&kernelContext_0)->globalParams_0->hScratch_0)[hb_0]) = w_0;
    *(&((&kernelContext_0)->globalParams_0->hScratch_0)[hb_0 + 1U]) = 0.0f;
    *(&((&kernelContext_0)->globalParams_0->hScratch_0)[hb_0 + 2U]) = 0.0f;
    *(&((&kernelContext_0)->globalParams_0->hScratch_0)[hb_0 + 3U]) = w_0;
    *(&((&kernelContext_0)->globalParams_0->hScratch_0)[hb_0 + 4U]) = 0.0f;
    *(&((&kernelContext_0)->globalParams_0->hScratch_0)[hb_0 + 5U]) = w_0;
    return;
}
