...
void _main_0(void* _S35, void* entryPointParams_0, void* globalParams_1)
{

#line 65
    ComputeThreadVaryingInput * _S36 = (slang_bit_cast<ComputeThreadVaryingInput *>(_S35));
...
#line 65
    Vector<uint32_t, 3>  _S37 = _S36->groupID;

#line 65
    Vector<uint32_t, 3>  _S38 = _S36->groupThreadID;
    uint32_t _S39 = _S36->groupID.y;

#line 66
    uint32_t _S40 = pw_0(54U, &kernelContext_4);

#line 66
    uint32_t e_1 = (_S39 * _S40 + _S37.x) * 256U + _S38.x;

#line 66
    uint32_t _S41 = pw_0(53U, &kernelContext_4);
    if(e_1 >= _S41)
    {
...
#line 73
    uint32_t _S42 = off4_0(1U, i0_3, i1_3, i2_3, i3_3, &kernelContext_4);

    float * _S43 = (&((&kernelContext_4)->globalParams_0->dst_0)[_S42]);

#line 75
    float _S44 = im2col_at_0(i0_3, i1_3, i2_3, i3_3, &kernelContext_4);
