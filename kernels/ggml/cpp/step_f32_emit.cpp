...
static float step_ggml_0(float x_0)
{
...
#line 59
    *(&((&kernelContext_3)->globalParams_0->dst_0)[_S24]) = step_ggml_0(*(&((&kernelContext_3)->globalParams_0->s0_0)[_S25]));
    return;
}
