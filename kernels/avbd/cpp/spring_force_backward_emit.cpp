...
#line 56 "C:/interactor-dress-on/kernels/avbd/slang/spring_force_backward.slang"
struct GlobalParams_0
{
    ...
    StructuredBuffer<Vector<float, 3> > v_gradA_0;
    StructuredBuffer<float> v_springHess_0;
    RWStructuredBuffer<Vector<float, 3> > v_p_d_0;
    RWStructuredBuffer<float> v_restLen_0;
...
#line 32
    ...
    float L_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->restLen_0.Load(i_0);
    Vector<float, 3>  vG_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_gradA_0.Load(i_0);
    uint32_t hbi_0 = 6U * i_0;
    float vH0_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_springHess_0.Load(hbi_0);
    float vH1_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_springHess_0.Load(hbi_0 + 1U);
    float vH2_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_springHess_0.Load(hbi_0 + 2U);
    float vH3_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_springHess_0.Load(hbi_0 + 3U);
    float vH4_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_springHess_0.Load(hbi_0 + 4U);
    float vH5_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_springHess_0.Load(hbi_0 + 5U);
    float _S6 = len_0 - L_0;

#line 44
    float gScale_0 = k_0 * _S6 / len_0;
    float _S7 = vG_0.x;
...
#line 45
    float dotVGd_0 = _S7 * dx_0 + _S8 * dy_0 + _S9 * dz_0;

    float kLd_0 = k_0 * (L_0 * dotVGd_0) / (len_0 * len2_0);

    float S_0 = vH0_0 * _S3 + vH1_0 * (dx_0 * dy_0) + vH2_0 * (dx_0 * dz_0) + vH3_0 * _S4 + vH4_0 * (dy_0 * dz_0) + vH5_0 * _S5;



    float hs_0 = 2.0f * (k_0 * S_0) / (len2_0 * len2_0);
    float kOverLen2_0 = k_0 / len2_0;
    *(&((slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_p_d_0)[i_0]) = Vector<float, 3> (gScale_0 * _S7 + kLd_0 * dx_0 + (kOverLen2_0 * (vH0_0 * (2.0f * dx_0) + vH1_0 * dy_0 + vH2_0 * dz_0) - hs_0 * dx_0), gScale_0 * _S8 + kLd_0 * dy_0 + (kOverLen2_0 * (vH1_0 * dx_0 + vH3_0 * (2.0f * dy_0) + vH4_0 * dz_0) - hs_0 * dy_0), gScale_0 * _S9 + kLd_0 * dz_0 + (kOverLen2_0 * (vH2_0 * dx_0 + vH4_0 * dy_0 + vH5_0 * (2.0f * dz_0)) - hs_0 * dz_0));
    *(&((slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_restLen_0)[i_0]) = 0.0f - k_0 * dotVGd_0 / len_0;
    *(&((slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_stiffness_0)[i_0]) = _S6 * dotVGd_0 / len_0 + S_0 / len2_0;
    return;
}
