...
#line 1 "slang/lb_pg_inf_serial.slang"
struct LbPgInfParams_0
{
    uint32_t n_0;
    uint32_t dstOff_0;
};
...
#line 23
        float _S3 = (F32_max((acc_0), ((F32_abs(((F32_min(((F32_max(((&kernelContext_0)->globalParams_0->x_0.Load(i_0) - (&kernelContext_0)->globalParams_0->g_0.Load(i_0)), ((&kernelContext_0)->globalParams_0->lb_0.Load(i_0))))), ((&kernelContext_0)->globalParams_0->ub_0.Load(i_0)))) - (&kernelContext_0)->globalParams_0->x_0.Load(i_0)))))));
