...
static float gelu_tanh_0(float x_1)
{
    return 0.5f * x_1 * (1.0f + (F32_tanh((clamp_0(0.79788458347320557f * x_1 * (1.0f + 0.04471499845385551f * x_1 * x_1), -10.0f, 10.0f)))));
}
...
#line 60
    *(&((&kernelContext_3)->globalParams_0->dst_0)[_S23]) = gelu_tanh_0(*(&((&kernelContext_3)->globalParams_0->s0_0)[_S24]));
    return;
}
