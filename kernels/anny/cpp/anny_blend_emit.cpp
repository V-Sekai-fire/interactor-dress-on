...
#line 1 "slang/anny_blend.slang"
struct AnnyBlendParams_0
{
    uint32_t P_0;
    uint32_t NB_0;
};
...
{
    AnnyBlendParams_0* params_0;
    StructuredBuffer<float> templ_0;
    StructuredBuffer<float> blend_0;
    StructuredBuffer<float> coeffs_0;
    RWStructuredBuffer<float> vanny_0;
};
...
#line 18
    ...
    if(i_0 >= ((slang_bit_cast<GlobalParams_0*>(globalParams_1))->params_0->P_0))
    {
...
#line 24
    float _S5 = (&kernelContext_0)->globalParams_0->templ_0.Load(_S4);
    uint32_t _S6 = _S3 + 2U;

#line 25
    float _S7 = (&kernelContext_0)->globalParams_0->templ_0.Load(_S6);

#line 25
    float x_0 = (&kernelContext_0)->globalParams_0->templ_0.Load(_S3);
...
#line 26
        if(c_0 < ((slang_bit_cast<GlobalParams_0*>(globalParams_1))->params_0->NB_0))
        {
        }
        else
        {
...
#line 27
        ...
        uint32_t o_0 = (c_0 * (slang_bit_cast<GlobalParams_0*>(globalParams_1))->params_0->P_0 + i_0) * 3U;
        float _S8 = x_0 + w_0 * (&kernelContext_0)->globalParams_0->blend_0.Load(o_0);
        float _S9 = y_0 + w_0 * (&kernelContext_0)->globalParams_0->blend_0.Load(o_0 + 1U);
        float _S10 = z_0 + w_0 * (&kernelContext_0)->globalParams_0->blend_0.Load(o_0 + 2U);
...
#line 33
    *(&((&kernelContext_0)->globalParams_0->vanny_0)[_S3]) = x_0;
    *(&((&kernelContext_0)->globalParams_0->vanny_0)[_S4]) = y_0;
    *(&((&kernelContext_0)->globalParams_0->vanny_0)[_S6]) = z_0;
    return;
}
