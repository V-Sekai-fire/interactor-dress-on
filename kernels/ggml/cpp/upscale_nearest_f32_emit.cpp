...
#line 1 "slang/upscale_nearest_f32.slang"
struct Slot_0
{
    uint32_t base_0;
    uint32_t pad0_0;
...
static uint32_t src_idx_0(uint32_t i_0, uint32_t nd_0, uint32_t ns_0)
{

#line 42
    uint32_t _S16 = i_0 * ns_0 / nd_0;
...
#line 54
    uint32_t _S25 = pw_0(1U, &kernelContext_3);

#line 54
    uint32_t _S26 = pw_0(10U, &kernelContext_3);


    uint32_t _S27 = src_idx_0(i0_2, _S25, _S26);

#line 57
    uint32_t _S28 = pw_0(2U, &kernelContext_3);

#line 57
    uint32_t _S29 = pw_0(11U, &kernelContext_3);

#line 57
    uint32_t _S30 = src_idx_0(i1_2, _S28, _S29);

#line 57
    uint32_t _S31 = pw_0(3U, &kernelContext_3);

#line 57
    uint32_t _S32 = pw_0(12U, &kernelContext_3);

#line 57
    uint32_t _S33 = src_idx_0(i2_2, _S31, _S32);

#line 57
    uint32_t _S34 = pw_0(4U, &kernelContext_3);

#line 57
    uint32_t _S35 = pw_0(13U, &kernelContext_3);

#line 57
    uint32_t _S36 = src_idx_0(i3_2, _S34, _S35);

#line 57
    uint32_t _S37 = off4_0(10U, _S27, _S30, _S33, _S36, &kernelContext_3);
    *(&((&kernelContext_3)->globalParams_0->dst_0)[_S24]) = *(&((&kernelContext_3)->globalParams_0->s0_0)[_S37]);
    return;
}
