...
#line 1 "slang/geglu_erf_f32.slang"
struct Slot_0
{
    uint32_t base_0;
    uint32_t pad0_0;
...
#line 21 "slang/geglu_erf_f32.slang"
...
static float erf_as_0(float x_0)
{

#line 42
    float z_0 = (F32_abs((x_0)));
    float t_0 = 1.0f / (1.0f + 0.32759109139442444f * z_0);

    float r_2 = 1.0f - t_0 * (0.25482958555221558f + t_0 * (-0.2844967246055603f + t_0 * (1.42141377925872803f + t_0 * (-1.45315206050872803f + t_0 * 1.06140542030334473f)))) * (F32_exp((- (z_0 * z_0))));
...
#line 50
    return 0.5f * x_1 * (1.0f + erf_as_0(x_1 * 0.70710676908493042f));
}
...
#line 62
    uint32_t _S25 = pw_0(55U, &kernelContext_3);

#line 62
    uint32_t _S26 = off4_0(10U, i0_2 + _S25, i1_2, i2_2, i3_2, &kernelContext_3);


    float x_2 = *(&((&kernelContext_3)->globalParams_0->s0_0)[_S26]);

#line 65
    uint32_t _S27 = pw_0(57U, &kernelContext_3);
...
#line 67
        uint32_t _S28 = off4_0(19U, i0_2, i1_2, i2_2, i3_2, &kernelContext_3);

#line 67
        g_0 = *(&((&kernelContext_3)->globalParams_0->s1_0)[_S28]);
...
#line 67
        uint32_t _S29 = pw_0(56U, &kernelContext_3);

#line 67
        uint32_t _S30 = off4_0(10U, i0_2 + _S29, i1_2, i2_2, i3_2, &kernelContext_3);

#line 67
        g_0 = *(&((&kernelContext_3)->globalParams_0->s0_0)[_S30]);

#line 67
    }

#line 72
    *(&((&kernelContext_3)->globalParams_0->dst_0)[_S24]) = gelu_erf_0(x_2) * g_0;
    return;
}
