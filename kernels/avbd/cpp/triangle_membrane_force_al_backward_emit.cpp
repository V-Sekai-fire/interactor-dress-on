...
#line 103 "C:/interactor-dress-on/kernels/avbd/slang/triangle_membrane_force_al_backward.slang"
struct GlobalParams_0
{
    StructuredBuffer<Vector<float, 3> > positions_0;
    StructuredBuffer<uint32_t> idx_0;
    StructuredBuffer<float> stiffness_0;
    StructuredBuffer<Vector<float, 3> > lambda0_0;
    StructuredBuffer<Vector<float, 3> > lambda1_0;
    StructuredBuffer<float> inv_deltaUV_0;
    StructuredBuffer<Vector<float, 3> > v_grad_0;
    StructuredBuffer<float> v_hessScalar_0;
    RWStructuredBuffer<Vector<float, 3> > v_p_0;
    RWStructuredBuffer<float> v_stiffness_0;
    RWStructuredBuffer<Vector<float, 3> > v_lambda0_0;
    RWStructuredBuffer<Vector<float, 3> > v_lambda1_0;
};
...
#line 27
    ...
    uint32_t base_0 = c_0 * 3U;

    uint32_t _S3 = base_0 + 1U;
    uint32_t _S4 = base_0 + 2U;
    Vector<float, 3>  p0_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->positions_0.Load((slang_bit_cast<GlobalParams_0*>(globalParams_0))->idx_0.Load(base_0));
    Vector<float, 3>  p1_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->positions_0.Load((slang_bit_cast<GlobalParams_0*>(globalParams_0))->idx_0.Load(_S3));
    Vector<float, 3>  p2_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->positions_0.Load((slang_bit_cast<GlobalParams_0*>(globalParams_0))->idx_0.Load(_S4));
    uint32_t iub_0 = c_0 * 4U;
    float m00_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->inv_deltaUV_0.Load(iub_0);
    float m01_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->inv_deltaUV_0.Load(iub_0 + 1U);
    float m10_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->inv_deltaUV_0.Load(iub_0 + 2U);
    float m11_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->inv_deltaUV_0.Load(iub_0 + 3U);
    float _S5 = p0_0.x;

#line 41
    float ex0_0 = p1_0.x - _S5;
    float _S6 = p0_0.y;

#line 42
    float ey0_0 = p1_0.y - _S6;
    float _S7 = p0_0.z;

#line 43
    float ez0_0 = p1_0.z - _S7;
    float ex1_0 = p2_0.x - _S5;
    float ey1_0 = p2_0.y - _S6;
    float ez1_0 = p2_0.z - _S7;
    float f0x_0 = ex0_0 * m00_0 + ex1_0 * m10_0;
    float f0y_0 = ey0_0 * m00_0 + ey1_0 * m10_0;
    float f0z_0 = ez0_0 * m00_0 + ez1_0 * m10_0;
    float f1x_0 = ex0_0 * m01_0 + ex1_0 * m11_0;
    float f1y_0 = ey0_0 * m01_0 + ey1_0 * m11_0;
    float f1z_0 = ez0_0 * m01_0 + ez1_0 * m11_0;
    float a_0 = (F32_sqrt((f0x_0 * f0x_0 + f0y_0 * f0y_0 + f0z_0 * f0z_0)));
    float e1x_0 = f0x_0 / a_0;
    float e1y_0 = f0y_0 / a_0;
    float e1z_0 = f0z_0 / a_0;
    float b_0 = e1x_0 * f1x_0 + e1y_0 * f1y_0 + e1z_0 * f1z_0;
    float tx_0 = f1x_0 - b_0 * e1x_0;
    float ty_0 = f1y_0 - b_0 * e1y_0;
    float tz_0 = f1z_0 - b_0 * e1z_0;
    float d_0 = (F32_sqrt((tx_0 * tx_0 + ty_0 * ty_0 + tz_0 * tz_0)));
    float e2x_0 = tx_0 / d_0;
    float e2y_0 = ty_0 / d_0;
    float e2z_0 = tz_0 / d_0;
    float xv_0 = a_0 + d_0;
    float _S8 = xv_0 * xv_0;
...
#line 66
    float rn_0 = (F32_sqrt((_S8 + _S9)));
    float r00_0 = xv_0 / rn_0;
    float r01_0 = b_0 / rn_0;
    float r10_0 = 0.0f - b_0 / rn_0;
    float r11_0 = xv_0 / rn_0;

#line 83
    float w0a_0 = m00_0 + m10_0;
    float w0b_0 = m01_0 + m11_0;
    float k_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->stiffness_0.Load(c_0);
    Vector<float, 3>  vg0_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_grad_0.Load(base_0);
    Vector<float, 3>  vg1_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_grad_0.Load(_S3);
    Vector<float, 3>  vg2_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_grad_0.Load(_S4);



    float _S10 = 0.0f - w0a_0;
...
#line 92
    float Bx_0 = _S10 * _S11 + m00_0 * _S12 + m10_0 * _S13;
    float _S14 = vg0_0.y;
...
#line 93
    float By_0 = _S10 * _S14 + m00_0 * _S15 + m10_0 * _S16;
    float _S17 = vg0_0.z;
...
#line 94
    float Bz_0 = _S10 * _S17 + m00_0 * _S18 + m10_0 * _S19;
    float _S20 = 0.0f - w0b_0;

#line 95
    float Cx_0 = _S20 * _S11 + m01_0 * _S12 + m11_0 * _S13;
    float Cy_0 = _S20 * _S14 + m01_0 * _S15 + m11_0 * _S16;
    float Cz_0 = _S20 * _S17 + m01_0 * _S18 + m11_0 * _S19;
    float H_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_hessScalar_0.Load(base_0) * (w0a_0 * w0a_0 + w0b_0 * w0b_0) + (slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_hessScalar_0.Load(_S3) * (m00_0 * m00_0 + m01_0 * m01_0) + (slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_hessScalar_0.Load(_S4) * (m10_0 * m10_0 + m11_0 * m11_0);
    float BdotE0_0 = Bx_0 * (f0x_0 - (e1x_0 * r00_0 + e2x_0 * r10_0)) + By_0 * (f0y_0 - (e1y_0 * r00_0 + e2y_0 * r10_0)) + Bz_0 * (f0z_0 - (e1z_0 * r00_0 + e2z_0 * r10_0));
    float CdotE1_0 = Cx_0 * (f1x_0 - (e1x_0 * r01_0 + e2x_0 * r11_0)) + Cy_0 * (f1y_0 - (e1y_0 * r01_0 + e2y_0 * r11_0)) + Cz_0 * (f1z_0 - (e1z_0 * r01_0 + e2z_0 * r11_0));
    *(&((slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_lambda0_0)[c_0]) = Vector<float, 3> (Bx_0, By_0, Bz_0);
    *(&((slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_lambda1_0)[c_0]) = Vector<float, 3> (Cx_0, Cy_0, Cz_0);
    *(&((slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_stiffness_0)[c_0]) = BdotE0_0 + CdotE1_0 + H_0;
    float vf0x_0 = k_0 * Bx_0;
    float vf0y_0 = k_0 * By_0;
    float vf0z_0 = k_0 * Bz_0;
    float vf1x_0 = k_0 * Cx_0;
    float vf1y_0 = k_0 * Cy_0;
    float vf1z_0 = k_0 * Cz_0;
    float vn0x_0 = 0.0f - vf0x_0;
    float vn0y_0 = 0.0f - vf0y_0;
    float vn0z_0 = 0.0f - vf0z_0;
    float vn1x_0 = 0.0f - vf1x_0;
    float vn1y_0 = 0.0f - vf1y_0;
    float vn1z_0 = 0.0f - vf1z_0;



    float ve2x_0 = vn0x_0 * r10_0 + vn1x_0 * r11_0;
    float ve2y_0 = vn0y_0 * r10_0 + vn1y_0 * r11_0;
    float ve2z_0 = vn0z_0 * r10_0 + vn1z_0 * r11_0;

    float vr01_0 = vn1x_0 * e1x_0 + vn1y_0 * e1y_0 + vn1z_0 * e1z_0;
    float vr10_0 = vn0x_0 * e2x_0 + vn0y_0 * e2y_0 + vn0z_0 * e2z_0;

    float rn3_0 = rn_0 * (rn_0 * rn_0);
    float trR_0 = vn0x_0 * e1x_0 + vn0y_0 * e1y_0 + vn0z_0 * e1z_0 + (vn1x_0 * e2x_0 + vn1y_0 * e2y_0 + vn1z_0 * e2z_0);


    float _S21 = xv_0 * b_0;

#line 130
    float vxv_0 = trR_0 * _S9 / rn3_0 + (vr10_0 - vr01_0) * _S21 / rn3_0;



    float ve2dote2_0 = ve2x_0 * e2x_0 + ve2y_0 * e2y_0 + ve2z_0 * e2z_0;
    float vtx_0 = (ve2x_0 - ve2dote2_0 * e2x_0) / d_0 + vxv_0 * e2x_0;
    float vty_0 = (ve2y_0 - ve2dote2_0 * e2y_0) / d_0 + vxv_0 * e2y_0;
    float vtz_0 = (ve2z_0 - ve2dote2_0 * e2z_0) / d_0 + vxv_0 * e2z_0;

#line 145
    float vb_0 = 0.0f - trR_0 * _S21 / rn3_0 + (vr01_0 - vr10_0) * _S8 / rn3_0 + (0.0f - (vtx_0 * e1x_0 + vty_0 * e1y_0 + vtz_0 * e1z_0));
    float ve1x_0 = vn0x_0 * r00_0 + vn1x_0 * r01_0 - b_0 * vtx_0 + vb_0 * f1x_0;
    float ve1y_0 = vn0y_0 * r00_0 + vn1y_0 * r01_0 - b_0 * vty_0 + vb_0 * f1y_0;
    float ve1z_0 = vn0z_0 * r00_0 + vn1z_0 * r01_0 - b_0 * vtz_0 + vb_0 * f1z_0;
    float vf1x_1 = vf1x_0 + vtx_0 + vb_0 * e1x_0;
    float vf1y_1 = vf1y_0 + vty_0 + vb_0 * e1y_0;
    float vf1z_1 = vf1z_0 + vtz_0 + vb_0 * e1z_0;
    float ve1dote1_0 = ve1x_0 * e1x_0 + ve1y_0 * e1y_0 + ve1z_0 * e1z_0;



    float vf0x_1 = vf0x_0 + (ve1x_0 - ve1dote1_0 * e1x_0) / a_0 + vxv_0 * e1x_0;
    float vf0y_1 = vf0y_0 + (ve1y_0 - ve1dote1_0 * e1y_0) / a_0 + vxv_0 * e1y_0;
    float vf0z_1 = vf0z_0 + (ve1z_0 - ve1dote1_0 * e1z_0) / a_0 + vxv_0 * e1z_0;
    *(&((slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_p_0)[base_0]) = Vector<float, 3> (0.0f - (w0a_0 * vf0x_1 + w0b_0 * vf1x_1), 0.0f - (w0a_0 * vf0y_1 + w0b_0 * vf1y_1), 0.0f - (w0a_0 * vf0z_1 + w0b_0 * vf1z_1));
    *(&((slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_p_0)[_S3]) = Vector<float, 3> (m00_0 * vf0x_1 + m01_0 * vf1x_1, m00_0 * vf0y_1 + m01_0 * vf1y_1, m00_0 * vf0z_1 + m01_0 * vf1z_1);
    *(&((slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_p_0)[_S4]) = Vector<float, 3> (m10_0 * vf0x_1 + m11_0 * vf1x_1, m10_0 * vf0y_1 + m11_0 * vf1y_1, m10_0 * vf0z_1 + m11_0 * vf1z_1);
    return;
}
