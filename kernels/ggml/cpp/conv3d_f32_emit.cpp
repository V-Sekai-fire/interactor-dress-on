...
void _main_0(void* _S16, void* entryPointParams_0, void* globalParams_1)
{

#line 42
    ComputeThreadVaryingInput * _S17 = (slang_bit_cast<ComputeThreadVaryingInput *>(_S16));
...
#line 42
    Vector<uint32_t, 3>  _S18 = _S17->groupID;

#line 42
    Vector<uint32_t, 3>  _S19 = _S17->groupThreadID;
    uint32_t _S20 = _S17->groupID.y;

#line 43
    uint32_t _S21 = pw_0(54U, &kernelContext_3);

#line 43
    uint32_t e_1 = (_S20 * _S21 + _S18.x) * 256U + _S19.x;

#line 43
    uint32_t _S22 = pw_0(53U, &kernelContext_3);
    if(e_1 >= _S22)
    {
...
#line 50
    unravel4_0(e_1, 1U, &ox_0, &oy_0, &oz_0, &ocn_0, &kernelContext_3);

#line 50
    uint32_t _S23 = pw_0(46U, &kernelContext_3);

#line 50
    uint32_t _S24 = pw_0(48U, &kernelContext_3);

#line 50
    uint32_t _S25 = pw_0(37U, &kernelContext_3);

#line 50
    uint32_t _S26 = pw_0(38U, &kernelContext_3);

#line 50
    uint32_t _S27 = pw_0(39U, &kernelContext_3);

#line 50
    uint32_t _S28 = pw_0(40U, &kernelContext_3);

#line 50
    uint32_t _S29 = pw_0(41U, &kernelContext_3);

#line 50
    uint32_t _S30 = pw_0(42U, &kernelContext_3);

#line 50
    uint32_t _S31 = pw_0(43U, &kernelContext_3);

#line 50
    uint32_t _S32 = pw_0(44U, &kernelContext_3);

#line 50
    uint32_t _S33 = pw_0(45U, &kernelContext_3);

#line 50
    uint32_t _S34 = pw_0(10U, &kernelContext_3);

#line 50
    uint32_t _S35 = pw_0(11U, &kernelContext_3);

#line 50
    uint32_t _S36 = pw_0(12U, &kernelContext_3);

#line 50
    uint32_t _S37 = pw_0(19U, &kernelContext_3);

#line 50
    uint32_t _S38 = pw_0(20U, &kernelContext_3);

#line 50
    uint32_t _S39 = pw_0(21U, &kernelContext_3);

#line 50
    uint32_t _S40 = pw_0(14U, &kernelContext_3);

#line 50
    uint32_t _S41 = pw_0(15U, &kernelContext_3);

#line 50
    uint32_t _S42 = pw_0(16U, &kernelContext_3);

#line 50
    uint32_t _S43 = pw_0(17U, &kernelContext_3);

#line 50
    uint32_t _S44 = pw_0(23U, &kernelContext_3);

#line 50
    uint32_t _S45 = pw_0(24U, &kernelContext_3);

#line 50
    uint32_t _S46 = pw_0(25U, &kernelContext_3);

#line 50
    uint32_t _S47 = pw_0(26U, &kernelContext_3);

#line 50
    uint32_t _S48 = pw_0(27U, &kernelContext_3);

#line 77
    uint32_t _S49 = ocn_0 / _S24;

#line 77
    uint32_t _S50 = _S48 + _S49 * _S23 * _S47;

#line 77
    uint32_t _S51 = pw_0(18U, &kernelContext_3);
    uint32_t _S52 = ocn_0 % _S24;

#line 78
    uint32_t _S53 = _S51 + _S52 * _S23 * _S43;
...
#line 81
        uint32_t _S54 = _S50 + ic_0 * _S47;
        uint32_t _S55 = _S53 + ic_0 * _S43;
...
#line 84
            uint32_t z_0 = oz_0 * _S27 + kz_0 * _S33;
...
#line 86
                uint32_t _S57 = _S54 + (z_0 - _S30) * _S46;
                uint32_t _S58 = _S55 + kz_0 * _S42;
...
#line 89
                    uint32_t y_0 = oy_0 * _S26 + ky_0 * _S32;
...
#line 91
                        uint32_t _S60 = _S57 + (y_0 - _S29) * _S45;
                        uint32_t _S61 = _S58 + ky_0 * _S41;
...
#line 94
                            uint32_t x_0 = ox_0 * _S25 + kx_0 * _S31;
...
#line 95
                                acc_2 = acc_2 + *(&((&kernelContext_3)->globalParams_0->s1_0)[_S60 + (x_0 - _S28) * _S44]) * *(&((&kernelContext_3)->globalParams_0->s0_0)[_S61 + kx_0 * _S40]);
...
#line 80
    uint32_t _S63 = off4_0(1U, ox_0, oy_0, oz_0, ocn_0, &kernelContext_3);

#line 104
    *(&((&kernelContext_3)->globalParams_0->dst_0)[_S63]) = acc_0;
    return;
}
