...
#line 1 "slang/anny_lbs_backward_bind.slang"
...
struct GlobalParams_0
{
    ...
    StructuredBuffer<float> dverts_0;
    RWStructuredBuffer<float> dbind_0;
};
...
#line 23
    float _S4 = (&kernelContext_0)->globalParams_0->dverts_0.Load(_S3);
    uint32_t _S5 = _S3 + 1U;

#line 24
    float _S6 = (&kernelContext_0)->globalParams_0->dverts_0.Load(_S5);
    uint32_t _S7 = _S3 + 2U;

#line 25
    float _S8 = (&kernelContext_0)->globalParams_0->dverts_0.Load(_S7);
...
#line 32
            ...
            float _S9 = y_0 + w_0 * ((&kernelContext_0)->globalParams_0->bone_0.Load(b_0 + 1U) * _S4 + (&kernelContext_0)->globalParams_0->bone_0.Load(b_0 + 5U) * _S6 + (&kernelContext_0)->globalParams_0->bone_0.Load(b_0 + 9U) * _S8);
            float _S10 = z_0 + w_0 * ((&kernelContext_0)->globalParams_0->bone_0.Load(b_0 + 2U) * _S4 + (&kernelContext_0)->globalParams_0->bone_0.Load(b_0 + 6U) * _S6 + (&kernelContext_0)->globalParams_0->bone_0.Load(b_0 + 10U) * _S8);

#line 35
            x_0 = x_0 + w_0 * ((&kernelContext_0)->globalParams_0->bone_0.Load(b_0) * _S4 + (&kernelContext_0)->globalParams_0->bone_0.Load(b_0 + 4U) * _S6 + (&kernelContext_0)->globalParams_0->bone_0.Load(b_0 + 8U) * _S8);
...
#line 38
    *(&((&kernelContext_0)->globalParams_0->dbind_0)[_S3]) = x_0;
    *(&((&kernelContext_0)->globalParams_0->dbind_0)[_S5]) = y_0;
    *(&((&kernelContext_0)->globalParams_0->dbind_0)[_S7]) = z_0;
    return;
}
