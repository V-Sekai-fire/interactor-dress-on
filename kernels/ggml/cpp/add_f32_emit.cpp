...
#line 50
    uint32_t _S24 = off4_0(10U, i0_2, i1_2, i2_2, i3_2, &kernelContext_3);

#line 50
    uint32_t _S25 = pw_0(19U, &kernelContext_3);



    uint32_t _S26 = i0_2 % _S25;

#line 54
    uint32_t _S27 = pw_0(20U, &kernelContext_3);

#line 54
    uint32_t _S28 = i1_2 % _S27;

#line 54
    uint32_t _S29 = pw_0(21U, &kernelContext_3);

#line 54
    uint32_t _S30 = i2_2 % _S29;

#line 54
    uint32_t _S31 = pw_0(22U, &kernelContext_3);

#line 54
    uint32_t _S32 = i3_2 % _S31;

#line 54
    uint32_t _S33 = off4_0(19U, _S26, _S28, _S30, _S32, &kernelContext_3);
    *(&((&kernelContext_3)->globalParams_0->dst_0)[_S23]) = *(&((&kernelContext_3)->globalParams_0->s0_0)[_S24]) + *(&((&kernelContext_3)->globalParams_0->s1_0)[_S33]);
    return;
}
