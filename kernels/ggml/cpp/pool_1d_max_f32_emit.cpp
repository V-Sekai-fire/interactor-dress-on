...
#line 1 "slang/pool_1d_max_f32.slang"
struct Slot_0
{
    uint32_t base_0;
    uint32_t pad0_0;
...
#line 59
    float res_0 = -3.4028234663852886e+38f;
...
#line 64
            float * _S32 = (&((&kernelContext_3)->globalParams_0->s0_0)[_S24 + (q_0 - _S29) * _S25]);
...
#line 68
    *(&((&kernelContext_3)->globalParams_0->dst_0)[_S23]) = res_0;
    return;
}
