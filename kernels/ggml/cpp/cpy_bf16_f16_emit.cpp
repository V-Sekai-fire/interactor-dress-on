...
#line 1 "slang/cpy_bf16_f16.slang"
struct Slot_0
{
    uint32_t base_0;
    uint32_t pad0_0;
...
static uint32_t f32_to_f16_0(uint32_t b_0)
{

#line 46
    uint32_t s_0 = (b_0 >> 16U) & 32768U;
    uint32_t a_0 = b_0 & 2147483647U;
    if(a_0 > 2139095040U)
    {
...
#line 55
        uint32_t m_0 = a_0 - 939524096U;
        return s_0 | ((m_0 + 4095U + ((m_0 >> 13U) & 1U)) >> 13U);
    }
    uint32_t x_0 = a_0 >> 23U;
    if(x_0 < 102U)
    {
...
#line 60
    ...
    uint32_t q_0 = (a_0 & 8388607U) | 8388608U;
    uint32_t sh_0 = 126U - x_0;
    return s_0 | ((q_0 + ((1U << (sh_0 - 1U)) - 1U) + ((q_0 >> sh_0) & 1U)) >> sh_0);
}
...
#line 67
    uint32_t _S16 = pw_0(56U, kernelContext_4);
    uint32_t _S17 = i0_2 * _S16;

#line 68
    uint32_t _S18 = pw_0(57U, kernelContext_4);

#line 68
    uint32_t _S19 = _S17 + i1_2 * _S18;

#line 68
    uint32_t _S20 = pw_0(58U, kernelContext_4);

#line 68
    uint32_t _S21 = _S19 + i2_2 * _S20;

#line 68
    uint32_t _S22 = pw_0(59U, kernelContext_4);
    uint32_t j0_0;
    uint32_t j1_0;
    uint32_t j2_0;
    uint32_t j3_0;
...
#line 72
    unravel4_0(_S21 + i3_2 * _S22, 10U, &j0_0, &j1_0, &j2_0, &j3_0, kernelContext_4);

#line 72
    uint32_t _S23 = off4_0(10U, j0_0, j1_0, j2_0, j3_0, kernelContext_4);

#line 72
    uint32_t _S24 = ld16_s0_0(_S23, kernelContext_4);

    return f32_to_f16_0(_S24 << 16U);
}
...
#line 78
    Vector<uint32_t, 3>  _S27 = _S26->groupID;

#line 78
    Vector<uint32_t, 3>  _S28 = _S26->groupThreadID;
    uint32_t _S29 = _S26->groupID.y;

#line 79
    uint32_t _S30 = pw_0(54U, &kernelContext_5);

#line 79
    uint32_t e_2 = (_S29 * _S30 + _S27.x) * 256U + _S28.x;

#line 79
    uint32_t _S31 = pw_0(53U, &kernelContext_5);
    if(e_2 >= _S31)
    {
...
#line 86
    uint32_t _S32 = off4_0(1U, i0_3, i1_3, i2_3, i3_3, &kernelContext_5);

#line 86
    uint32_t _S33 = pw_0(55U, &kernelContext_5);
...
#line 92
        ...
        uint32_t _S34 = _S32 >> 1U;

#line 94
        uint32_t * _S35 = (&((&kernelContext_5)->globalParams_0->dst_0)[_S34]);

#line 94
        uint32_t _S36 = (*(&((&kernelContext_5)->globalParams_0->dst_0)[_S34])) & 65535U;

#line 94
        uint32_t _S37 = val_0(i0_3, i1_3, i2_3, i3_3, &kernelContext_5);
...
#line 103
        uint32_t _S43 = i0_3 + 1U;

#line 103
        uint32_t _S44 = pw_0(1U, &kernelContext_5);
...
#line 110
                uint32_t _S49 = i2_3 + 1U;

#line 110
                uint32_t _S50 = pw_0(3U, &kernelContext_5);
...
#line 115
                    uint32_t _S52 = i3_3 + 1U;

#line 115
                    uint32_t _S53 = pw_0(4U, &kernelContext_5);
...
#line 127
        uint32_t * _S55 = (&((&kernelContext_5)->globalParams_0->dst_0)[_S32 >> 1U]);

#line 127
        uint32_t _S56 = val_0(k0_0, k1_0, k2_0, k3_0, &kernelContext_5);
...
#line 126
    ...
    {
        uint32_t _S57 = _S32 >> 1U;

#line 129
        *(&((&kernelContext_5)->globalParams_0->dst_0)[_S57]) = ((*(&((&kernelContext_5)->globalParams_0->dst_0)[_S57])) & 4294901760U) | _S38;
