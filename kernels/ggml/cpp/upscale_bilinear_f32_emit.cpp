...
#line 1 "slang/upscale_bilinear_f32.slang"
struct Slot_0
{
    uint32_t base_0;
    uint32_t pad0_0;
...
{
    StructuredBuffer<uint32_t> params_0;
    RWStructuredBuffer<float> s0_0;
    RWStructuredBuffer<uint32_t> s1_0;
    RWStructuredBuffer<uint32_t> s2_0;
    RWStructuredBuffer<float> dst_0;
    Slot_0* slot_0;
};


#line 11108 "hlsl.meta.slang"
...
#line 21 "slang/upscale_bilinear_f32.slang"
static uint32_t pw_0(uint32_t k_0, KernelContext_0 * kernelContext_0)
{

#line 22
    return kernelContext_0->globalParams_0->params_0.Load(kernelContext_0->globalParams_0->slot_0->base_0 + k_0);
}

static void unravel4_0(uint32_t e_0, uint32_t w_0, uint32_t * i0_0, uint32_t * i1_0, uint32_t * i2_0, uint32_t * i3_0, KernelContext_0 * kernelContext_1)
{

#line 25
    uint32_t _S1 = pw_0(w_0, kernelContext_1);

#line 25
    uint32_t _S2 = pw_0(w_0 + 1U, kernelContext_1);

#line 25
    uint32_t _S3 = pw_0(w_0 + 2U, kernelContext_1);



    uint32_t _S4 = e_0 % _S1;

#line 29
    *i0_0 = _S4;
    uint32_t r_0 = e_0 / _S1;
    uint32_t _S5 = r_0 % _S2;

#line 31
    *i1_0 = _S5;
    uint32_t r_1 = r_0 / _S2;
    uint32_t _S6 = r_1 % _S3;

#line 33
    *i2_0 = _S6;
    uint32_t _S7 = r_1 / _S3;
...
#line 37
static uint32_t off4_0(uint32_t w_1, uint32_t i0_1, uint32_t i1_1, uint32_t i2_1, uint32_t i3_1, KernelContext_0 * kernelContext_2)
{

#line 37
    uint32_t _S8 = pw_0(w_1 + 8U, kernelContext_2);

#line 37
    uint32_t _S9 = pw_0(w_1 + 4U, kernelContext_2);
    uint32_t _S10 = _S8 + i0_1 * _S9;

#line 38
    uint32_t _S11 = pw_0(w_1 + 5U, kernelContext_2);

#line 38
    uint32_t _S12 = _S10 + i1_1 * _S11;

#line 38
    uint32_t _S13 = pw_0(w_1 + 6U, kernelContext_2);

#line 38
    uint32_t _S14 = _S12 + i2_1 * _S13;

#line 38
    uint32_t _S15 = pw_0(w_1 + 7U, kernelContext_2);

#line 38
    return _S14 + i3_1 * _S15;
}


#line 45
static int32_t clamp_idx_0(int32_t i_0, int32_t hi_0)
{
...
static float clamp01_0(float t_0)
{
...
#line 41
static uint32_t src_idx_0(uint32_t i_1, uint32_t nd_0, uint32_t ns_0)
{

#line 42
    uint32_t _S16 = i_1 * ns_0 / nd_0;
...
#line 56
void _main_0(void* _S17, void* entryPointParams_0, void* globalParams_1)
{

#line 56
    ComputeThreadVaryingInput * _S18 = (slang_bit_cast<ComputeThreadVaryingInput *>(_S17));
...
#line 56
    Vector<uint32_t, 3>  _S19 = _S18->groupID;

#line 56
    Vector<uint32_t, 3>  _S20 = _S18->groupThreadID;
    uint32_t _S21 = _S18->groupID.y;

#line 57
    uint32_t _S22 = pw_0(54U, &kernelContext_3);

#line 57
    uint32_t e_1 = (_S21 * _S22 + _S19.x) * 256U + _S20.x;

#line 57
    uint32_t _S23 = pw_0(53U, &kernelContext_3);
    if(e_1 >= _S23)
    {
...
#line 64
    unravel4_0(e_1, 1U, &i0_2, &i1_2, &i2_2, &i3_2, &kernelContext_3);

#line 64
    uint32_t _S24 = off4_0(1U, i0_2, i1_2, i2_2, i3_2, &kernelContext_3);

#line 64
    uint32_t _S25 = pw_0(37U, &kernelContext_3);


    bool ac_0 = (_S25 & 256U) != 0U;
...
#line 69
        uint32_t _S27 = pw_0(1U, &kernelContext_3);
...
#line 69
            uint32_t _S28 = pw_0(10U, &kernelContext_3);
...
#line 69
        uint32_t _S29 = pw_0(1U, &kernelContext_3);

#line 69
        float _S30 = float(_S29 - 1U);

#line 69
        uint32_t _S31 = pw_0(10U, &kernelContext_3);

#line 69
        sf0_0 = _S30 / float(_S31 - 1U);
...
#line 69
        uint32_t _S32 = pw_0(1U, &kernelContext_3);

#line 69
        float _S33 = float(_S32);

#line 69
        uint32_t _S34 = pw_0(10U, &kernelContext_3);

#line 69
        sf0_0 = _S33 / float(_S34);
...
#line 70
        uint32_t _S35 = pw_0(2U, &kernelContext_3);
...
#line 70
            uint32_t _S36 = pw_0(11U, &kernelContext_3);
...
#line 70
        uint32_t _S37 = pw_0(2U, &kernelContext_3);

#line 70
        float _S38 = float(_S37 - 1U);

#line 70
        uint32_t _S39 = pw_0(11U, &kernelContext_3);

#line 70
        sf1_0 = _S38 / float(_S39 - 1U);
...
#line 70
        uint32_t _S40 = pw_0(2U, &kernelContext_3);

#line 70
        float _S41 = float(_S40);

#line 70
        uint32_t _S42 = pw_0(11U, &kernelContext_3);

#line 70
        sf1_0 = _S41 / float(_S42);

#line 70
    }
    float yc_0 = (float(i1_2) + po_0) / sf1_0 - po_0;
    int32_t _S43 = int32_t((F32_floor((yc_0))));

#line 72
    uint32_t _S44 = pw_0(11U, &kernelContext_3);

#line 72
    int32_t y0_0 = clamp_idx_0(_S43, int32_t(_S44 - 1U));
    int32_t _S45 = _S43 + int(1);

#line 73
    uint32_t _S46 = pw_0(11U, &kernelContext_3);

#line 73
    int32_t y1_0 = clamp_idx_0(_S45, int32_t(_S46 - 1U));
    float dy_0 = clamp01_0(yc_0 - float(y0_0));
    float xc_0 = (float(i0_2) + po_0) / sf0_0 - po_0;
    int32_t _S47 = int32_t((F32_floor((xc_0))));

#line 76
    uint32_t _S48 = pw_0(10U, &kernelContext_3);

#line 76
    int32_t x0_0 = clamp_idx_0(_S47, int32_t(_S48 - 1U));
    int32_t _S49 = _S47 + int(1);

#line 77
    uint32_t _S50 = pw_0(10U, &kernelContext_3);

#line 77
    int32_t x1_0 = clamp_idx_0(_S49, int32_t(_S50 - 1U));
    float dx_0 = clamp01_0(xc_0 - float(x0_0));

#line 78
    uint32_t _S51 = pw_0(3U, &kernelContext_3);

#line 78
    uint32_t _S52 = pw_0(12U, &kernelContext_3);
    uint32_t i02_0 = src_idx_0(i2_2, _S51, _S52);

#line 79
    uint32_t _S53 = pw_0(4U, &kernelContext_3);

#line 79
    uint32_t _S54 = pw_0(13U, &kernelContext_3);
    uint32_t i03_0 = src_idx_0(i3_2, _S53, _S54);
    uint32_t _S55 = uint32_t(x0_0);

#line 81
    uint32_t _S56 = uint32_t(y0_0);

#line 81
    uint32_t _S57 = off4_0(10U, _S55, _S56, i02_0, i03_0, &kernelContext_3);

#line 81
    float * _S58 = (&((&kernelContext_3)->globalParams_0->s0_0)[_S57]);
    uint32_t _S59 = uint32_t(x1_0);

#line 82
    uint32_t _S60 = off4_0(10U, _S59, _S56, i02_0, i03_0, &kernelContext_3);

#line 82
    float * _S61 = (&((&kernelContext_3)->globalParams_0->s0_0)[_S60]);
    uint32_t _S62 = uint32_t(y1_0);

#line 83
    uint32_t _S63 = off4_0(10U, _S55, _S62, i02_0, i03_0, &kernelContext_3);

#line 83
    float * _S64 = (&((&kernelContext_3)->globalParams_0->s0_0)[_S63]);

#line 83
    uint32_t _S65 = off4_0(10U, _S59, _S62, i02_0, i03_0, &kernelContext_3);

    float _S66 = 1.0f - dx_0;

#line 85
    float _S67 = 1.0f - dy_0;

#line 85
    *(&((&kernelContext_3)->globalParams_0->dst_0)[_S24]) = *_S58 * _S66 * _S67 + *_S61 * dx_0 * _S67 + *_S64 * _S66 * dy_0 + *(&((&kernelContext_3)->globalParams_0->s0_0)[_S65]) * dx_0 * dy_0;
    return;
}
