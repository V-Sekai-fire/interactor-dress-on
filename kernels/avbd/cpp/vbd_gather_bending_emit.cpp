...
#line 1 "C:/interactor-dress-on/kernels/avbd/slang/vbd_gather_bending.slang"
struct VbdGatherBendingParams_0
{
...
{
    StructuredBuffer<Vector<float, 3> > bendGrad_0;
    StructuredBuffer<float> bendHessScalar_0;
    StructuredBuffer<uint32_t> vertBendOffset_0;
    StructuredBuffer<uint32_t> vertBendIdx_0;
    StructuredBuffer<uint32_t> vertBendRole_0;
    RWStructuredBuffer<Vector<float, 3> > gScratch_0;
    RWStructuredBuffer<float> hScratch_0;
    StructuredBuffer<uint32_t> vertPerm_0;
    VbdGatherBendingParams_0* params_0;
};
...
#line 29
    ...
    uint32_t sStart_0 = (&kernelContext_0)->globalParams_0->vertBendOffset_0.Load(v_0);
    uint32_t _S3 = (&kernelContext_0)->globalParams_0->vertBendOffset_0.Load(v_0 + 1U);
...
#line 42
        ...
        uint32_t gi_0 = 4U * (&kernelContext_0)->globalParams_0->vertBendIdx_0.Load(k_0) + (&kernelContext_0)->globalParams_0->vertBendRole_0.Load(k_0);
        Vector<float, 3>  ga_0 = (&kernelContext_0)->globalParams_0->bendGrad_0.Load(gi_0);
        float hs_0 = (&kernelContext_0)->globalParams_0->bendHessScalar_0.Load(gi_0);
        float _S12 = gx_0 + ga_0.x;
        float _S13 = gy_0 + ga_0.y;
        float _S14 = gz_0 + ga_0.z;
        float _S15 = Hxx_0 + hs_0;
        float _S16 = Hyy_0 + hs_0;
        float _S17 = Hzz_0 + hs_0;
...
#line 55
    ...
    *(&((&kernelContext_0)->globalParams_0->hScratch_0)[_S8]) = Hyy_0;
    *(&((&kernelContext_0)->globalParams_0->hScratch_0)[_S10]) = Hzz_0;
    return;
}
