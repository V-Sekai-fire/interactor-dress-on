...
#line 1 "C:/interactor-dress-on/kernels/avbd/slang/attachment_dual_update.slang"
struct AttachmentDualUpdateParams_0
{
    float beta_0;
    float penaltyMax_0;
    uint32_t count_0;
...
struct GlobalParams_0
{
    ...
    AttachmentDualUpdateParams_0* params_0;
};
...
#line 24
    ...
    Vector<float, 3>  p_0 = (&kernelContext_0)->globalParams_0->positions_0.Load((&kernelContext_0)->globalParams_0->vertIdx_0.Load(c_0));
    Vector<float, 3>  fp_0 = (&kernelContext_0)->globalParams_0->fixedPos_0.Load(c_0);
    float * _S3 = (&((&kernelContext_0)->globalParams_0->gamma_0)[c_0]);

#line 29
    float g_0 = *_S3;
    Vector<float, 3>  * _S4 = (&((&kernelContext_0)->globalParams_0->lambda_0)[c_0]);
    float Cx_0 = p_0.x - fp_0.x;
    float Cy_0 = p_0.y - fp_0.y;
    float Cz_0 = p_0.z - fp_0.z;
    *(&((&kernelContext_0)->globalParams_0->lambda_0)[c_0]) = Vector<float, 3> ((*_S4).x + *_S3 * Cx_0, (*_S4).y + *_S3 * Cy_0, (*_S4).z + *_S3 * Cz_0);

    *(&((&kernelContext_0)->globalParams_0->gamma_0)[c_0]) = (F32_min((g_0 + (slang_bit_cast<GlobalParams_0*>(globalParams_1))->params_0->beta_0 * (F32_sqrt((Cx_0 * Cx_0 + Cy_0 * Cy_0 + Cz_0 * Cz_0)))), ((slang_bit_cast<GlobalParams_0*>(globalParams_1))->params_0->penaltyMax_0)));
    return;
}
