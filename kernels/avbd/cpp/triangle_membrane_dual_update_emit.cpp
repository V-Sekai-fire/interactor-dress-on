...
struct GlobalParams_0
{
    ...
    RWStructuredBuffer<float> gamma_0;
    RWStructuredBuffer<Vector<float, 3> > lambda0_0;
    RWStructuredBuffer<Vector<float, 3> > lambda1_0;
    StructuredBuffer<float> inv_deltaUV_0;
    TriangleMembraneDualUpdateParams_0* params_0;
};
...
#line 23
    ...
    if(c_0 >= ((slang_bit_cast<GlobalParams_0*>(globalParams_1))->params_0->count_0))
    {
...
#line 26
    ...
    Vector<float, 3>  p0_0 = (&kernelContext_0)->globalParams_0->positions_0.Load((&kernelContext_0)->globalParams_0->idx_0.Load(base_0));
    Vector<float, 3>  p1_0 = (&kernelContext_0)->globalParams_0->positions_0.Load((&kernelContext_0)->globalParams_0->idx_0.Load(base_0 + 1U));
    Vector<float, 3>  p2_0 = (&kernelContext_0)->globalParams_0->positions_0.Load((&kernelContext_0)->globalParams_0->idx_0.Load(base_0 + 2U));
    uint32_t iub_0 = c_0 * 4U;
    float m00_0 = (&kernelContext_0)->globalParams_0->inv_deltaUV_0.Load(iub_0);
    float m01_0 = (&kernelContext_0)->globalParams_0->inv_deltaUV_0.Load(iub_0 + 1U);
    float m10_0 = (&kernelContext_0)->globalParams_0->inv_deltaUV_0.Load(iub_0 + 2U);
    float m11_0 = (&kernelContext_0)->globalParams_0->inv_deltaUV_0.Load(iub_0 + 3U);
    float _S3 = p0_0.x;

#line 40
    float ex0_0 = p1_0.x - _S3;
    float _S4 = p0_0.y;

#line 41
    float ey0_0 = p1_0.y - _S4;
    float _S5 = p0_0.z;

#line 42
    float ez0_0 = p1_0.z - _S5;
    float ex1_0 = p2_0.x - _S3;
    float ey1_0 = p2_0.y - _S4;
    float ez1_0 = p2_0.z - _S5;
...
#line 77
    float e0x_0 = f0x_0 - (e1x_0 * r00_0 + e2x_0 * r10_0);
    float e0y_0 = f0y_0 - (e1y_0 * r00_0 + e2y_0 * r10_0);
    float e0z_0 = f0z_0 - (e1z_0 * r00_0 + e2z_0 * r10_0);
    float e1rx_0 = f1x_0 - (e1x_0 * r01_0 + e2x_0 * r11_0);
    float e1ry_0 = f1y_0 - (e1y_0 * r01_0 + e2y_0 * r11_0);
    float e1rz_0 = f1z_0 - (e1z_0 * r01_0 + e2z_0 * r11_0);
    float * _S6 = (&((&kernelContext_0)->globalParams_0->gamma_0)[c_0]);

#line 83
    float g_0 = *_S6;
    Vector<float, 3>  * _S7 = (&((&kernelContext_0)->globalParams_0->lambda0_0)[c_0]);
    Vector<float, 3>  l1_0 = *(&((&kernelContext_0)->globalParams_0->lambda1_0)[c_0]);
    *(&((&kernelContext_0)->globalParams_0->lambda0_0)[c_0]) = Vector<float, 3> ((*_S7).x + *_S6 * e0x_0, (*_S7).y + *_S6 * e0y_0, (*_S7).z + *_S6 * e0z_0);
    *(&((&kernelContext_0)->globalParams_0->lambda1_0)[c_0]) = Vector<float, 3> (l1_0.x + g_0 * e1rx_0, l1_0.y + g_0 * e1ry_0, l1_0.z + g_0 * e1rz_0);

    *(&((&kernelContext_0)->globalParams_0->gamma_0)[c_0]) = (F32_min((g_0 + (slang_bit_cast<GlobalParams_0*>(globalParams_1))->params_0->beta_0 * (F32_sqrt((e0x_0 * e0x_0 + e0y_0 * e0y_0 + e0z_0 * e0z_0 + e1rx_0 * e1rx_0 + e1ry_0 * e1ry_0 + e1rz_0 * e1rz_0)))), ((slang_bit_cast<GlobalParams_0*>(globalParams_1))->params_0->penaltyMax_0)));
    return;
}
