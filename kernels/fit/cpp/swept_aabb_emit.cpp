...
{
    StructuredBuffer<float> x0_0;
    StructuredBuffer<float> x1_0;
    StructuredBuffer<uint32_t> edges_0;
    StructuredBuffer<uint32_t> faces_0;
    RWStructuredBuffer<float> boxes_0;
    AabbParams_0* params_0;
};
...
#line 23
    ...
    if(i_0 >= ((slang_bit_cast<GlobalParams_0*>(globalParams_1))->params_0->n_v_0 + (slang_bit_cast<GlobalParams_0*>(globalParams_1))->params_0->n_e_0 + (slang_bit_cast<GlobalParams_0*>(globalParams_1))->params_0->n_f_0))
    {

#line 26
        return;
    }
    FixedArray<uint32_t, 3>  vv_0;
...
#line 32
    uint32_t nv_0;
    if(i_0 >= ((slang_bit_cast<GlobalParams_0*>(globalParams_1))->params_0->n_v_0))
    {

#line 34
        if(i_0 < ((slang_bit_cast<GlobalParams_0*>(globalParams_1))->params_0->n_v_0 + (slang_bit_cast<GlobalParams_0*>(globalParams_1))->params_0->n_e_0))
        {

            uint32_t _S3 = 2U * (i_0 - (slang_bit_cast<GlobalParams_0*>(globalParams_1))->params_0->n_v_0);

#line 37
            vv_0[0U] = (&kernelContext_0)->globalParams_0->edges_0.Load(_S3);
            vv_0[1U] = (&kernelContext_0)->globalParams_0->edges_0.Load(_S3 + 1U);
...
#line 42
            uint32_t _S4 = 3U * (i_0 - (slang_bit_cast<GlobalParams_0*>(globalParams_1))->params_0->n_v_0 - (slang_bit_cast<GlobalParams_0*>(globalParams_1))->params_0->n_e_0);

#line 42
            vv_0[0U] = (&kernelContext_0)->globalParams_0->faces_0.Load(_S4);
            vv_0[1U] = (&kernelContext_0)->globalParams_0->faces_0.Load(_S4 + 1U);
            vv_0[2U] = (&kernelContext_0)->globalParams_0->faces_0.Load(_S4 + 2U);
...
#line 47
    FixedArray<float, 3>  mn_0;
    FixedArray<float, 3>  mx_0;
...
#line 50
        mn_0[d_0] = 3.00000000549775576e+38f;
        mx_0[d_0] = -3.00000000549775576e+38f;
...
#line 56
            uint32_t _S6 = _S5 + d_0;

#line 56
            float a0_0 = (&kernelContext_0)->globalParams_0->x0_0.Load(_S6);
            float a1_0 = (&kernelContext_0)->globalParams_0->x1_0.Load(_S6);
            mn_0[d_0] = (F32_min((mn_0[d_0]), ((F32_min((a0_0), (a1_0))))));
            mx_0[d_0] = (F32_max((mx_0[d_0]), ((F32_max((a0_0), (a1_0))))));
...
#line 64
        float m_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_1))->params_0->margin_0 * (1.0f + (F32_max(((F32_abs((mn_0[d_0])))), ((F32_abs((mx_0[d_0])))))));
        *(&((&kernelContext_0)->globalParams_0->boxes_0)[_S7 + d_0]) = mn_0[d_0] - (slang_bit_cast<GlobalParams_0*>(globalParams_1))->params_0->inflation_0 - m_0;
        *(&((&kernelContext_0)->globalParams_0->boxes_0)[_S7 + 3U + d_0]) = mx_0[d_0] + (slang_bit_cast<GlobalParams_0*>(globalParams_1))->params_0->inflation_0 + m_0;
