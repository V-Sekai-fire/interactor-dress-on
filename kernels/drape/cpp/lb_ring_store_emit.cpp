...
#line 1 "slang/lb_ring_store.slang"
struct LbRingStoreParams_0
{
    uint32_t n_0;
};
...
#line 22
    ...
    if(((&kernelContext_0)->globalParams_0->st_0).Load(3U) == 0U)
    {

#line 25
        return;
    }
    uint32_t k_0 = (&kernelContext_0)->globalParams_0->st_0.Load(2U) * (slang_bit_cast<GlobalParams_0*>(globalParams_1))->params_0->n_0 + i_0;
    *(&((&kernelContext_0)->globalParams_0->S_0)[k_0]) = (&kernelContext_0)->globalParams_0->s_0.Load(i_0);
    *(&((&kernelContext_0)->globalParams_0->Y_0)[k_0]) = (&kernelContext_0)->globalParams_0->y_0.Load(i_0);
    return;
}
