...
#line 46
    ...
    return *(&(kernelContext_3->globalParams_0->s0_0)[_S23]);
}
...
#line 60
    ...
    uint32_t * _S32 = (&((&kernelContext_4)->globalParams_0->dst_0)[_S31]);

#line 62
    uint32_t _S33 = val_0(i0_3, i1_3, i2_3, i3_3, &kernelContext_4);
