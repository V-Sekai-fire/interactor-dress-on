...
#line 1 "slang/project_psd12.slang"
struct df_0
{
    float hi_0;
    float lo_0;
...
static df_0 df_f_0(float a_0)
{

#line 24
    return df_make_0(a_0, 0.0f);
}
...
#line 27
static df_0 two_sum_0(float a_1, float b_0)
{

#line 28
    precise float s_0 = a_1 + b_0;
    precise float bb_0 = s_0 - a_1;
    precise float ea_0 = a_1 - (s_0 - bb_0);
    precise float eb_0 = b_0 - bb_0;
    precise float e_0 = ea_0 + eb_0;
    return df_make_0(s_0, e_0);
}

static df_0 quick_two_sum_0(float a_2, float b_1)
{

#line 37
    precise float s_1 = a_2 + b_1;
    precise float e_1 = b_1 - (s_1 - a_2);
...
#line 61
static df_0 df_sub_0(df_0 * x_2, df_0 * y_1)
{

#line 61
    df_0 _S1 = df_neg_0(y_1);

#line 61
    df_0 _S2 = _S1;

#line 61
    df_0 _S3 = df_add_0(x_2, &_S2);
    return _S3;
}


#line 42
static df_0 two_prod_0(float a_3, float b_2)
{

#line 43
    precise float p_0 = a_3 * b_2;
    precise float e_2 = (F32_fma((a_3), (b_2), (- p_0)));
    return df_make_0(p_0, e_2);
}


#line 74
static df_0 df_mulf_0(df_0 * x_3, float c_0)
{

#line 75
    df_0 p_1 = two_prod_0(x_3->hi_0, c_0);
    precise float d_0 = x_3->lo_0 * c_0;
    precise float pl_0 = p_1.lo_0 + d_0;
    return quick_two_sum_0(p_1.hi_0, pl_0);
}

static df_0 df_div_0(df_0 * x_4, df_0 * y_2)
{

#line 81
    float _S4 = y_2->hi_0;
    float q1_0 = x_4->hi_0 / y_2->hi_0;

#line 82
    df_0 _S5 = df_mulf_0(y_2, q1_0);

#line 82
    df_0 _S6 = _S5;

#line 82
    df_0 _S7 = df_sub_0(x_4, &_S6);

    float q2_0 = _S7.hi_0 / _S4;

#line 84
    df_0 _S8 = df_mulf_0(y_2, q2_0);
...
#line 84
    df_0 _S11 = df_sub_0(&_S9, &_S10);



    df_0 _S12 = df_f_0(_S11.hi_0 / _S4);

#line 88
    df_0 _S13 = quick_two_sum_0(q1_0, q2_0);
...
#line 107
static bool df_lt_0(df_0 * x_5, df_0 * y_3)
{
...
static df_0 df_abs_0(df_0 * x_6)
{

#line 111
    df_0 _S19 = df_make_0(0.0f, 0.0f);

#line 111
    bool _S20 = df_lt_0(x_6, &_S19);
    if(_S20)
    {

#line 112
        df_0 _S21 = df_neg_0(x_6);
        return _S21;
    }
    return *x_6;
}
...
#line 65
static df_0 df_mul_0(df_0 * x_7, df_0 * y_4)
{

#line 66
    df_0 p_2 = two_prod_0(x_7->hi_0, y_4->hi_0);
    precise float c_1 = x_7->hi_0 * y_4->lo_0;
    precise float d_1 = x_7->lo_0 * y_4->hi_0;
    precise float cd_0 = c_1 + d_1;
    precise float pl_1 = p_2.lo_0 + cd_0;
    return quick_two_sum_0(p_2.hi_0, pl_1);
}


#line 91
static df_0 df_sqrt_0(df_0 * x_8)
{
...
#line 93
        return df_make_0(0.0f, 0.0f);
    }
    float r_1 = (F32_sqrt((_S22)));

#line 95
    df_0 _S23 = two_prod_0(r_1, r_1);

#line 95
    df_0 _S24 = df_sub_0(x_8, &_S23);


    precise float dd_0 = _S24.hi_0 + _S24.lo_0;

    return quick_two_sum_0(r_1, dd_0 / (2.0f * r_1));
}


#line 119
void _main_0(void* _S25, void* entryPointParams_0, void* globalParams_1)
{
...
#line 119
    ComputeThreadVaryingInput * _S26 = (slang_bit_cast<ComputeThreadVaryingInput *>(_S25));
...
#line 119
    ...
    uint32_t k_0 = (_S26->groupID * Vector<uint32_t, 3> (64U, 1U, 1U) + _S26->groupThreadID).x;
...
#line 122
    ...
    if(((slang_bit_cast<GlobalParams_0*>(globalParams_1))->params_0->enabled_0) == 0U)
    {

#line 125
        return;
    }
    uint32_t _S27 = 144U * k_0;
    FixedArray<df_0, 144>  A_0;
    FixedArray<df_0, 144>  V_0;
...
#line 131
        A_0[i_0] = *(&((&kernelContext_0)->globalParams_0->blocks_0)[_S27 + i_0]);
        V_0[i_0] = df_make_0(0.0f, 0.0f);
...
#line 143
                float _S28 = dg_0 + (&A_0[p_3 * 13U])->hi_0 * (&A_0[p_3 * 13U])->hi_0;
                uint32_t _S29 = p_3 + 1U;
...
#line 145
                    float _S30 = off_0 + (&A_0[p_3 * 12U + q_0])->hi_0 * (&A_0[p_3 * 12U + q_0])->hi_0;
...
#line 148
            if(off_0 <= (dg_0 * 1.00000000317107685e-30f))
            {
...
#line 153
                        uint32_t _S32 = p_4 * 12U;

#line 153
                        df_0 apq_0 = A_0[_S32 + q_0];
                        if((A_0[_S32 + q_0].hi_0) != 0.0f)
                        {
...
#line 154
                            df_0 _S33 = A_0[q_0 * 13U];

#line 154
                            df_0 _S34 = A_0[p_4 * 13U];

#line 154
                            df_0 _S35 = df_sub_0(&_S33, &_S34);

#line 154
                            df_0 _S36 = apq_0;

#line 154
                            df_0 _S37 = df_mulf_0(&_S36, 2.0f);
...
#line 154
                            df_0 _S40 = df_div_0(&_S38, &_S39);

#line 154
                            df_0 _S41 = _S40;

#line 154
                            df_0 _S42 = df_abs_0(&_S41);


                            df_0 _S43 = df_f_0(1.0f);
...
#line 157
                            df_0 _S49 = df_add_0(&_S47, &_S48);

#line 157
                            df_0 _S50 = _S49;

#line 157
                            df_0 _S51 = df_sqrt_0(&_S50);
...
#line 158
                            df_0 _S65 = df_add_0(&_S63, &_S64);

#line 158
                            df_0 _S66 = _S65;

#line 158
                            df_0 _S67 = df_sqrt_0(&_S66);
...
#line 164
                                uint32_t _S74 = r_2 * 12U;

#line 164
                                df_0 acp_0 = A_0[_S74 + p_4];
                                df_0 acq_0 = A_0[_S74 + q_0];

#line 165
                                df_0 _S75 = _S70;

#line 165
                                df_0 _S76 = A_0[_S74 + p_4];

#line 165
                                df_0 _S77 = df_mul_0(&_S75, &_S76);

#line 165
                                df_0 _S78 = _S73;

#line 165
                                df_0 _S79 = A_0[_S74 + q_0];

#line 165
                                df_0 _S80 = df_mul_0(&_S78, &_S79);
...
#line 170
                                df_0 arp_0 = A_0[_S32 + r_3];
                                df_0 arq_0 = A_0[q_0 * 12U + r_3];

#line 171
                                df_0 _S93 = _S70;

#line 171
                                df_0 _S94 = A_0[_S32 + r_3];

#line 171
                                df_0 _S95 = df_mul_0(&_S93, &_S94);

#line 171
                                df_0 _S96 = _S73;

#line 171
                                df_0 _S97 = A_0[q_0 * 12U + r_3];

#line 171
                                df_0 _S98 = df_mul_0(&_S96, &_S97);
...
#line 171
                                df_0 _S101 = df_sub_0(&_S99, &_S100);
                                A_0[_S32 + r_3] = _S101;
...
#line 172
                                df_0 _S104 = df_mul_0(&_S102, &_S103);
...
#line 172
                                df_0 _S107 = df_mul_0(&_S105, &_S106);
...
#line 172
                                df_0 _S110 = df_add_0(&_S108, &_S109);
                                A_0[q_0 * 12U + r_3] = _S110;
...
#line 176
                                uint32_t _S111 = r_4 * 12U;

#line 176
                                df_0 vcp_0 = V_0[_S111 + p_4];
                                df_0 vcq_0 = V_0[_S111 + q_0];

#line 177
                                df_0 _S112 = _S70;

#line 177
                                df_0 _S113 = V_0[_S111 + p_4];

#line 177
                                df_0 _S114 = df_mul_0(&_S112, &_S113);

#line 177
                                df_0 _S115 = _S73;

#line 177
                                df_0 _S116 = V_0[_S111 + q_0];

#line 177
                                df_0 _S117 = df_mul_0(&_S115, &_S116);
...
#line 177
                                df_0 _S120 = df_sub_0(&_S118, &_S119);
                                V_0[_S111 + p_4] = _S120;
...
#line 178
                                df_0 _S123 = df_mul_0(&_S121, &_S122);
...
#line 178
                                df_0 _S126 = df_mul_0(&_S124, &_S125);
...
#line 178
                                df_0 _S129 = df_add_0(&_S127, &_S128);
                                V_0[_S111 + q_0] = _S129;
...
#line 189
        df_0 _S130 = df_make_0(0.0f, 0.0f);

#line 189
        df_0 _S131 = A_0[i_0 * 13U];

#line 189
        df_0 _S132 = _S130;

#line 189
        bool _S133 = df_lt_0(&_S131, &_S132);
...
#line 198
            df_0 _S134 = df_make_0(0.0f, 0.0f);
...
#line 200
                df_0 lam_0 = A_0[p_4 * 13U];

#line 200
                df_0 _S135 = _S134;

#line 200
                df_0 _S136 = A_0[p_4 * 13U];

#line 200
                bool _S137 = df_lt_0(&_S135, &_S136);
                if(_S137)
                {

#line 201
                    df_0 _S138 = V_0[i_0 * 12U + p_4];

#line 201
                    df_0 _S139 = V_0[p_3 * 12U + p_4];

#line 201
                    df_0 _S140 = df_mul_0(&_S138, &_S139);
...
#line 201
                    df_0 _S146 = df_add_0(&_S144, &_S145);
...
#line 205
            *(&((&kernelContext_0)->globalParams_0->blocks_0)[_S27 + (i_0 * 12U + p_3)]) = t_1;
