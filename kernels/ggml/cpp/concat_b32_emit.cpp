...
#line 41
    uint32_t _S19 = pw_0(13U, kernelContext_3);
...
#line 46
        uint32_t _S21 = off4_0(10U, i0_2, i1_2, i2_2, i3_2, kernelContext_3);
        return *(&(kernelContext_3->globalParams_0->s0_0)[_S21]);
    }
...
#line 49
    uint32_t _S26 = off4_0(19U, _S22, _S23, _S24, _S25, kernelContext_3);

#line 49
    return *(&(kernelContext_3->globalParams_0->s1_0)[_S26]);
}


void _main_0(void* _S27, void* entryPointParams_0, void* globalParams_1)
{

#line 53
    ComputeThreadVaryingInput * _S28 = (slang_bit_cast<ComputeThreadVaryingInput *>(_S27));
...
#line 53
    Vector<uint32_t, 3>  _S29 = _S28->groupID;

#line 53
    Vector<uint32_t, 3>  _S30 = _S28->groupThreadID;
    uint32_t _S31 = _S28->groupID.y;

#line 54
    uint32_t _S32 = pw_0(54U, &kernelContext_4);

#line 54
    uint32_t e_1 = (_S31 * _S32 + _S29.x) * 256U + _S30.x;

#line 54
    uint32_t _S33 = pw_0(53U, &kernelContext_4);
    if(e_1 >= _S33)
    {
...
#line 61
    uint32_t _S34 = off4_0(1U, i0_3, i1_3, i2_3, i3_3, &kernelContext_4);

    uint32_t * _S35 = (&((&kernelContext_4)->globalParams_0->dst_0)[_S34]);
