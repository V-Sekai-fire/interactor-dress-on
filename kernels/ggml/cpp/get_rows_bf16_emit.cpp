...
#line 1 "slang/get_rows_bf16.slang"
struct Slot_0
{
    uint32_t base_0;
    uint32_t pad0_0;
...
#line 45
    uint32_t _S16 = off4_0(19U, i1_2, i2_2, i3_2, 0U, kernelContext_4);

#line 45
    uint32_t _S17 = off4_0(10U, i0_2, *(&(kernelContext_4->globalParams_0->s1_0)[_S16]), i2_2, i3_2, kernelContext_4);

#line 45
    uint32_t _S18 = ld16_s0_0(_S17, kernelContext_4);

    return _S18 << 16U;
}


void _main_0(void* _S19, void* entryPointParams_0, void* globalParams_1)
{

#line 51
    ComputeThreadVaryingInput * _S20 = (slang_bit_cast<ComputeThreadVaryingInput *>(_S19));
...
#line 51
    Vector<uint32_t, 3>  _S21 = _S20->groupID;

#line 51
    Vector<uint32_t, 3>  _S22 = _S20->groupThreadID;
    uint32_t _S23 = _S20->groupID.y;

#line 52
    uint32_t _S24 = pw_0(54U, &kernelContext_5);

#line 52
    uint32_t e_2 = (_S23 * _S24 + _S21.x) * 256U + _S22.x;

#line 52
    uint32_t _S25 = pw_0(53U, &kernelContext_5);
    if(e_2 >= _S25)
    {
...
#line 59
    uint32_t _S26 = off4_0(1U, i0_3, i1_3, i2_3, i3_3, &kernelContext_5);

    uint32_t * _S27 = (&((&kernelContext_5)->globalParams_0->dst_0)[_S26]);

#line 61
    uint32_t _S28 = val_0(i0_3, i1_3, i2_3, i3_3, &kernelContext_5);
