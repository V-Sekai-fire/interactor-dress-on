    ...
    : mesh_(mesh), refmesh_(nullptr), kd_tree_(nullptr)
{
    if (!mesh_.is_triangle_mesh()) {
        // -fno-exceptions patch: see thirdparty/pmp/patches/.
        ::std::abort();
    }
