...
# and Gate 0F (gate_runtime.gd) and keeps their output under
# gates/8-loop/regress/. Gates 2 and 0F write their own results files in
# gates/2-avbd/ and gates/0f-runtime/; those are copied here and the
...
git checkout -- gates/2-avbd/results.txt gates/0f-runtime/results.txt gates/0f-runtime/ggml_host.txt 2>/dev/null
