...
#line 1 "slang/lb_multi_dot_serial.slang"
struct LbMultiDotParams_0
{
    uint32_t n_0;
    uint32_t ncols_0;
    uint32_t aOff_0;
...
{
    LbMultiDotParams_0* params_0;
    StructuredBuffer<float> a_0;
    StructuredBuffer<float> vv_0;
...
#line 38
static void two_prod_0(float a_1, float b_0, float * hi_0, float * lo_0)
{

#line 39
    float h_0 = a_1 * b_0;
    *hi_0 = h_0;
    *lo_0 = (F32_fma((a_1), (b_0), (- h_0)));
    return;
}


#line 19
static void two_sum_0(float a_2, float b_1, float * hi_1, float * lo_1)
{
...
static void quick_two_sum_0(float a_3, float b_2, float * hi_2, float * lo_2)
{
...
static void df_acc_0(float * hi_3, float * lo_3, float a_4, float b_3)
{

#line 56
    float p_hi_0;
    float p_lo_0;
    two_prod_0(a_4, b_3, &p_hi_0, &p_lo_0);
    float n_hi_0;
    float n_lo_0;
...
#line 68
    ...
    if(j_0 >= ((slang_bit_cast<GlobalParams_0*>(globalParams_1))->params_0->ncols_0))
    {
...
#line 76
        df_acc_0(&acc_hi_0, &acc_lo_0, (&kernelContext_0)->globalParams_0->a_0.Load((slang_bit_cast<GlobalParams_0*>(globalParams_1))->params_0->aOff_0 + j_0 * (slang_bit_cast<GlobalParams_0*>(globalParams_1))->params_0->aStride_0 + i_0), (&kernelContext_0)->globalParams_0->vv_0.Load((slang_bit_cast<GlobalParams_0*>(globalParams_1))->params_0->vOff_0 + i_0));
...
#line 78
    *(&((&kernelContext_0)->globalParams_0->dst_0)[(slang_bit_cast<GlobalParams_0*>(globalParams_1))->params_0->dstOff_0 + _S3]) = acc_hi_0;
    *(&((&kernelContext_0)->globalParams_0->dst_0)[(slang_bit_cast<GlobalParams_0*>(globalParams_1))->params_0->dstOff_0 + _S3 + 1U]) = acc_lo_0;
    return;
}
