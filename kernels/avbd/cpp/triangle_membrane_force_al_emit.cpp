...
struct GlobalParams_0
{
    ...
    RWStructuredBuffer<Vector<float, 3> > grad_0;
    RWStructuredBuffer<float> hessScalar_0;
...
#line 35
    ...
    float xv_0 = a_0 + d_0;
    float yv_0 = 0.0f - b_0;
    float rn_0 = (F32_sqrt((xv_0 * xv_0 + yv_0 * yv_0)));
    float r00_0 = xv_0 / rn_0;
    float r01_0 = b_0 / rn_0;
    float r10_0 = yv_0 / rn_0;
    float r11_0 = xv_0 / rn_0;

#line 76
    float k_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->stiffness_0.Load(c_0);
    Vector<float, 3>  l0_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->lambda0_0.Load(c_0);
    Vector<float, 3>  l1_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->lambda1_0.Load(c_0);
    float te0x_0 = k_0 * (f0x_0 - (e1x_0 * r00_0 + e2x_0 * r10_0)) + l0_0.x;
    float te0y_0 = k_0 * (f0y_0 - (e1y_0 * r00_0 + e2y_0 * r10_0)) + l0_0.y;
    float te0z_0 = k_0 * (f0z_0 - (e1z_0 * r00_0 + e2z_0 * r10_0)) + l0_0.z;
    float te1x_0 = k_0 * (f1x_0 - (e1x_0 * r01_0 + e2x_0 * r11_0)) + l1_0.x;
    float te1y_0 = k_0 * (f1y_0 - (e1y_0 * r01_0 + e2y_0 * r11_0)) + l1_0.y;
    float te1z_0 = k_0 * (f1z_0 - (e1z_0 * r01_0 + e2z_0 * r11_0)) + l1_0.z;
    float w0a_0 = m00_0 + m10_0;
    float w0b_0 = m01_0 + m11_0;

    *(&((slang_bit_cast<GlobalParams_0*>(globalParams_0))->grad_0)[base_0]) = Vector<float, 3> (0.0f - (te0x_0 * w0a_0 + te1x_0 * w0b_0), 0.0f - (te0y_0 * w0a_0 + te1y_0 * w0b_0), 0.0f - (te0z_0 * w0a_0 + te1z_0 * w0b_0));
    *(&((slang_bit_cast<GlobalParams_0*>(globalParams_0))->grad_0)[_S3]) = Vector<float, 3> (te0x_0 * m00_0 + te1x_0 * m01_0, te0y_0 * m00_0 + te1y_0 * m01_0, te0z_0 * m00_0 + te1z_0 * m01_0);
    *(&((slang_bit_cast<GlobalParams_0*>(globalParams_0))->grad_0)[_S4]) = Vector<float, 3> (te0x_0 * m10_0 + te1x_0 * m11_0, te0y_0 * m10_0 + te1y_0 * m11_0, te0z_0 * m10_0 + te1z_0 * m11_0);
    *(&((slang_bit_cast<GlobalParams_0*>(globalParams_0))->hessScalar_0)[base_0]) = k_0 * (w0a_0 * w0a_0 + w0b_0 * w0b_0);
    *(&((slang_bit_cast<GlobalParams_0*>(globalParams_0))->hessScalar_0)[_S3]) = k_0 * (m00_0 * m00_0 + m01_0 * m01_0);
    *(&((slang_bit_cast<GlobalParams_0*>(globalParams_0))->hessScalar_0)[_S4]) = k_0 * (m10_0 * m10_0 + m11_0 * m11_0);
    return;
}
