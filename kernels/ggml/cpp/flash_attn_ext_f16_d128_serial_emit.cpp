...
#line 1 "slang/flash_attn_ext_f16_d128_serial.slang"
struct Slot_0
{
    uint32_t base_0;
    uint32_t pad0_0;
...
#line 21 "slang/flash_attn_ext_f16_d128_serial.slang"
...
static float pf_0(uint32_t k_1, KernelContext_0 * kernelContext_1)
{

#line 25
    uint32_t _S1 = pw_0(k_1, kernelContext_1);
    return (U32_asfloat((_S1)));
}

static uint32_t off4_0(uint32_t w_0, uint32_t i0_0, uint32_t i1_0, uint32_t i2_0, uint32_t i3_0, KernelContext_0 * kernelContext_2)
{

#line 29
    uint32_t _S2 = pw_0(w_0 + 8U, kernelContext_2);

#line 29
    uint32_t _S3 = pw_0(w_0 + 4U, kernelContext_2);
    uint32_t _S4 = _S2 + i0_0 * _S3;

#line 30
    uint32_t _S5 = pw_0(w_0 + 5U, kernelContext_2);

#line 30
    uint32_t _S6 = _S4 + i1_0 * _S5;

#line 30
    uint32_t _S7 = pw_0(w_0 + 6U, kernelContext_2);

#line 30
    uint32_t _S8 = _S6 + i2_0 * _S7;

#line 30
    uint32_t _S9 = pw_0(w_0 + 7U, kernelContext_2);

#line 30
    return _S8 + i3_0 * _S9;
}

static float ld_f16_s1_0(uint32_t e_0, KernelContext_0 * kernelContext_3)
{

#line 34
    uint32_t w_1 = *(&(kernelContext_3->globalParams_0->s1_0)[e_0 >> 1U]);
...
static float ld_f16_s2_0(uint32_t e_1, KernelContext_0 * kernelContext_4)
{

#line 40
    uint32_t w_2 = *(&(kernelContext_4->globalParams_0->s2_0)[e_1 >> 1U]);
...
#line 47
    uint32_t _S15 = pw_0(54U, &kernelContext_5);

#line 47
    uint32_t e_2 = (_S14 * _S15 + _S12.x) * 64U + _S13.x;

#line 47
    uint32_t _S16 = pw_0(53U, &kernelContext_5);
    if(e_2 >= _S16)
    {
...
#line 49
    ...
    uint32_t iq_0 = e_2 % _S17;
    uint32_t rr_0 = e_2 / _S17;

#line 53
    uint32_t _S18 = pw_0(12U, &kernelContext_5);
    uint32_t h_2 = rr_0 % _S18;

#line 54
    uint32_t _S19 = pw_0(12U, &kernelContext_5);
    uint32_t b_0 = rr_0 / _S19;

#line 55
    uint32_t _S20 = pw_0(20U, &kernelContext_5);

#line 55
    uint32_t _S21 = pw_0(55U, &kernelContext_5);

    uint32_t hk_0 = h_2 / _S21;

#line 57
    uint32_t _S22 = pw_0(56U, &kernelContext_5);
    uint32_t bk_0 = b_0 / _S22;

#line 58
    uint32_t _S23 = pw_0(57U, &kernelContext_5);
    uint32_t hv_0 = h_2 / _S23;

#line 59
    uint32_t _S24 = pw_0(58U, &kernelContext_5);
    uint32_t bv_0 = b_0 / _S24;

#line 60
    float _S25 = pf_0(59U, &kernelContext_5);

#line 60
    float _S26 = pf_0(60U, &kernelContext_5);

#line 60
    uint32_t _S27 = off4_0(10U, 0U, iq_0, h_2, b_0, &kernelContext_5);

#line 60
    uint32_t _S28 = off4_0(19U, 0U, 0U, hk_0, bk_0, &kernelContext_5);

#line 60
    uint32_t _S29 = pw_0(24U, &kernelContext_5);

#line 60
    uint32_t _S30 = off4_0(28U, 0U, 0U, hv_0, bv_0, &kernelContext_5);

#line 60
    uint32_t _S31 = pw_0(33U, &kernelContext_5);

#line 68
    FixedArray<float, 128>  qv_0;
    FixedArray<float, 128>  acc_0;
    FixedArray<float, 32>  sc_0;
...
#line 72
        qv_0[c_0] = (f16tof32(((f32tof16((*(&((&kernelContext_5)->globalParams_0->s0_0)[_S27 + c_0])))))));
        acc_0[c_0] = 0.0f;
...
#line 71
    ...
    float _S32 = (U32_asfloat((4286578688U)));

    uint32_t _S33 = (_S20 + 31U) / 32U;
...
#line 85
                    float _S35 = ld_f16_s1_0(_S28 + key_0 * _S29 + c_0, &kernelContext_5);
                    float _S36 = s_0 + qv_0[c_0] * _S35;
...
#line 97
            float _S37 = (F32_max((s_0), (sc_0[j_1])));
...
#line 105
            float p_0 = (F32_exp((sc_0[j_3] - s_0)));
            float _S38 = s_1 + p_0;
            uint32_t key_1 = _S34 + j_3;
            if(key_1 < _S20)
            {
...
#line 109
                    float _S39 = ld_f16_s2_0(_S30 + key_1 * _S31 + c_2, &kernelContext_5);
                    acc_0[c_2] = acc_0[c_2] + p_0 * _S39;
...
#line 114
        float _S40 = ls_0 * corr_0 + s_1;

#line 78
        uint32_t tt_1 = tt_0 + 1U;
...
#line 118
        uint32_t _S41 = off4_0(1U, c_0, h_2, iq_0, b_0, &kernelContext_5);
        *(&((&kernelContext_5)->globalParams_0->dst_0)[_S41]) = acc_0[c_0] * m_0;
