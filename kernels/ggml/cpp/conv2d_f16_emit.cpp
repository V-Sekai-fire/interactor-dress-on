...
#line 88
    unravel4_0(e_2, 1U, &ox_0, &oy_0, &oc_0, &n_0, &kernelContext_4);

#line 88
    uint32_t _S24 = pw_0(37U, &kernelContext_4);

#line 88
    uint32_t _S25 = pw_0(38U, &kernelContext_4);

#line 88
    uint32_t _S26 = pw_0(39U, &kernelContext_4);

#line 88
    uint32_t _S27 = pw_0(40U, &kernelContext_4);

#line 88
    uint32_t _S28 = pw_0(41U, &kernelContext_4);

#line 88
    uint32_t _S29 = pw_0(42U, &kernelContext_4);

#line 88
    uint32_t _S30 = pw_0(10U, &kernelContext_4);

#line 88
    uint32_t _S31 = pw_0(11U, &kernelContext_4);

#line 88
    uint32_t _S32 = pw_0(12U, &kernelContext_4);

#line 88
    uint32_t _S33 = pw_0(19U, &kernelContext_4);

#line 88
    uint32_t _S34 = pw_0(20U, &kernelContext_4);

#line 88
    uint32_t _S35 = pw_0(14U, &kernelContext_4);

#line 88
    uint32_t _S36 = pw_0(15U, &kernelContext_4);

#line 88
    uint32_t _S37 = pw_0(16U, &kernelContext_4);

#line 88
    uint32_t _S38 = pw_0(17U, &kernelContext_4);

#line 88
    uint32_t _S39 = pw_0(23U, &kernelContext_4);

#line 88
    uint32_t _S40 = pw_0(24U, &kernelContext_4);

#line 88
    uint32_t _S41 = pw_0(25U, &kernelContext_4);

#line 88
    uint32_t _S42 = pw_0(26U, &kernelContext_4);

#line 88
    uint32_t _S43 = pw_0(27U, &kernelContext_4);

#line 109
    uint32_t _S44 = _S43 + n_0 * _S42;

#line 109
    uint32_t _S45 = pw_0(18U, &kernelContext_4);
    uint32_t _S46 = _S45 + oc_0 * _S38;
...
#line 113
        uint32_t _S47 = _S44 + ic_0 * _S41;
        uint32_t _S48 = _S46 + ic_0 * _S37;
...
#line 116
            uint32_t y_0 = oy_0 * _S25 + ky_0 * _S29;
...
#line 118
                uint32_t _S50 = _S47 + (y_0 - _S27) * _S40;
                uint32_t _S51 = _S48 + ky_0 * _S36;
...
#line 121
                    uint32_t x_0 = ox_0 * _S24 + kx_0 * _S28;
...
#line 123
                        float _S53 = (f16tof32((f32_to_f16_0(*(&((&kernelContext_4)->globalParams_0->s1_0)[_S50 + (x_0 - _S26) * _S39])))));

#line 123
                        float _S54 = ld_f16_s0_0(_S51 + kx_0 * _S35, &kernelContext_4);

#line 123
                        acc_2 = acc_2 + _S53 * _S54;
...
#line 112
    uint32_t _S55 = off4_0(1U, ox_0, oy_0, oc_0, n_0, &kernelContext_4);

#line 129
    *(&((&kernelContext_4)->globalParams_0->dst_0)[_S55]) = acc_0;
    return;
}
