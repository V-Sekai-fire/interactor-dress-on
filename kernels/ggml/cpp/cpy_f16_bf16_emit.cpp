...
#line 1 "slang/cpy_f16_bf16.slang"
struct Slot_0
{
    uint32_t base_0;
    uint32_t pad0_0;
...
static uint32_t ld16_s0_0(uint32_t e_1, KernelContext_0 * kernelContext_3)
{

#line 42
    return ((*(&(kernelContext_3->globalParams_0->s0_0)[e_1 >> 1U])) >> ((e_1 & 1U) * 16U)) & 65535U;
}

static uint32_t f16_to_f32_0(uint32_t h_0)
{

#line 46
    uint32_t s_0 = (h_0 & 32768U) << 16U;
    uint32_t x_0 = (h_0 >> 10U) & 31U;
    uint32_t m_0 = h_0 & 1023U;
    if(x_0 == 31U)
    {

#line 50
        return (s_0 | 2139095040U) | (m_0 << 13U);
    }
    if(x_0 != 0U)
    {

#line 53
        return (s_0 | ((x_0 + 112U) << 23U)) | (m_0 << 13U);
    }
    if(m_0 == 0U)
    {
...
#line 59
    ...
    return (s_0 | (x2_0 << 23U)) | ((m_1 & 1023U) << 13U);
}

static uint32_t f32_to_bf16_0(uint32_t b_0)
{

#line 67
    if((b_0 & 2147483647U) > 2139095040U)
    {

#line 68
        return (b_0 >> 16U) | 64U;
    }
    return (b_0 + (32767U + ((b_0 >> 16U) & 1U))) >> 16U;
}

static uint32_t val_0(uint32_t i0_2, uint32_t i1_2, uint32_t i2_2, uint32_t i3_2, KernelContext_0 * kernelContext_4)
{

#line 73
    uint32_t _S17 = pw_0(56U, kernelContext_4);
    uint32_t _S18 = i0_2 * _S17;

#line 74
    uint32_t _S19 = pw_0(57U, kernelContext_4);

#line 74
    uint32_t _S20 = _S18 + i1_2 * _S19;

#line 74
    uint32_t _S21 = pw_0(58U, kernelContext_4);

#line 74
    uint32_t _S22 = _S20 + i2_2 * _S21;

#line 74
    uint32_t _S23 = pw_0(59U, kernelContext_4);
    uint32_t j0_0;
    uint32_t j1_0;
    uint32_t j2_0;
    uint32_t j3_0;
...
#line 78
    unravel4_0(_S22 + i3_2 * _S23, 10U, &j0_0, &j1_0, &j2_0, &j3_0, kernelContext_4);

#line 78
    uint32_t _S24 = off4_0(10U, j0_0, j1_0, j2_0, j3_0, kernelContext_4);

#line 78
    uint32_t _S25 = ld16_s0_0(_S24, kernelContext_4);

    return f32_to_bf16_0(f16_to_f32_0(_S25));
}


void _main_0(void* _S26, void* entryPointParams_0, void* globalParams_1)
{

#line 84
    ComputeThreadVaryingInput * _S27 = (slang_bit_cast<ComputeThreadVaryingInput *>(_S26));
...
#line 84
    Vector<uint32_t, 3>  _S28 = _S27->groupID;

#line 84
    Vector<uint32_t, 3>  _S29 = _S27->groupThreadID;
    uint32_t _S30 = _S27->groupID.y;

#line 85
    uint32_t _S31 = pw_0(54U, &kernelContext_5);

#line 85
    uint32_t e_2 = (_S30 * _S31 + _S28.x) * 256U + _S29.x;

#line 85
    uint32_t _S32 = pw_0(53U, &kernelContext_5);
    if(e_2 >= _S32)
    {
...
#line 92
    unravel4_0(e_2, 1U, &i0_3, &i1_3, &i2_3, &i3_3, &kernelContext_5);

#line 92
    uint32_t _S33 = off4_0(1U, i0_3, i1_3, i2_3, i3_3, &kernelContext_5);

#line 92
    uint32_t _S34 = pw_0(55U, &kernelContext_5);
...
#line 98
        ...
        uint32_t _S35 = _S33 >> 1U;

#line 100
        uint32_t * _S36 = (&((&kernelContext_5)->globalParams_0->dst_0)[_S35]);

#line 100
        uint32_t _S37 = (*(&((&kernelContext_5)->globalParams_0->dst_0)[_S35])) & 65535U;

#line 100
        uint32_t _S38 = val_0(i0_3, i1_3, i2_3, i3_3, &kernelContext_5);
...
#line 101
    uint32_t _S39 = val_0(i0_3, i1_3, i2_3, i3_3, &kernelContext_5);
...
#line 109
        uint32_t _S44 = i0_3 + 1U;

#line 109
        uint32_t _S45 = pw_0(1U, &kernelContext_5);
...
#line 112
            uint32_t _S47 = i1_3 + 1U;

#line 112
            uint32_t _S48 = pw_0(2U, &kernelContext_5);
...
#line 116
                uint32_t _S50 = i2_3 + 1U;

#line 116
                uint32_t _S51 = pw_0(3U, &kernelContext_5);
...
#line 121
                    uint32_t _S53 = i3_3 + 1U;

#line 121
                    uint32_t _S54 = pw_0(4U, &kernelContext_5);
...
#line 133
        uint32_t * _S56 = (&((&kernelContext_5)->globalParams_0->dst_0)[_S33 >> 1U]);

#line 133
        uint32_t _S57 = val_0(k0_0, k1_0, k2_0, k3_0, &kernelContext_5);
...
#line 132
    ...
    {
        uint32_t _S58 = _S33 >> 1U;

#line 135
        *(&((&kernelContext_5)->globalParams_0->dst_0)[_S58]) = ((*(&((&kernelContext_5)->globalParams_0->dst_0)[_S58])) & 4294901760U) | _S39;
