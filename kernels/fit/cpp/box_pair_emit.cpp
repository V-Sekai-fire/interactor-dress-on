...
#line 1 "slang/box_pair.slang"
struct PairParams_0
{
    uint32_t n_queries_0;
    uint32_t n_v_0;
    uint32_t n_e_0;
    uint32_t n_f_0;
    uint32_t self_collision_0;
    uint32_t write_0;
};
...
{
    StructuredBuffer<uint32_t> queries_0;
    StructuredBuffer<float> boxes_0;
    StructuredBuffer<uint32_t> edges_0;
    StructuredBuffer<uint32_t> faces_0;
    StructuredBuffer<uint32_t> garment_0;
    RWStructuredBuffer<uint32_t> counts_0;
    RWStructuredBuffer<uint32_t> pairs_0;
    PairParams_0* params_0;
};
...
#line 27
static bool can_collide_0(uint32_t a_0, uint32_t b_0, KernelContext_0 * kernelContext_0)
{

#line 28
    bool ga_0 = (kernelContext_0->globalParams_0->garment_0).Load(a_0) != 0U;
    bool gb_0 = (kernelContext_0->globalParams_0->garment_0).Load(b_0) != 0U;
    if((kernelContext_0->globalParams_0->params_0->self_collision_0) != 0U)
    {
...
static bool overlaps_0(uint32_t a_1, uint32_t b_1, KernelContext_0 * kernelContext_1)
{
...
#line 40
        if((kernelContext_1->globalParams_0->boxes_0).Load(_S2 + d_0) > (kernelContext_1->globalParams_0->boxes_0).Load(_S3 + 3U + d_0))
        {

#line 41
            return false;
        }
        if((kernelContext_1->globalParams_0->boxes_0).Load(_S3 + d_0) > (kernelContext_1->globalParams_0->boxes_0).Load(_S2 + 3U + d_0))
        {
...
static bool garment_face_0(uint32_t f_0, KernelContext_0 * kernelContext_2)
{
...
#line 51
    bool _S4;
    if((kernelContext_2->globalParams_0->garment_0).Load(kernelContext_2->globalParams_0->faces_0.Load(b_2)) != 0U)
    {
...
#line 52
        _S4 = (kernelContext_2->globalParams_0->garment_0).Load(kernelContext_2->globalParams_0->faces_0.Load(b_2 + 1U)) != 0U;
...
#line 52
        _S4 = (kernelContext_2->globalParams_0->garment_0).Load(kernelContext_2->globalParams_0->faces_0.Load(b_2 + 2U)) != 0U;
...
void _main_0(void* _S5, void* entryPointParams_0, void* globalParams_1)
{

#line 56
    ComputeThreadVaryingInput * _S6 = (slang_bit_cast<ComputeThreadVaryingInput *>(_S5));

#line 56
    KernelContext_0 kernelContext_3;

#line 56
    (&kernelContext_3)->globalParams_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_1));
    uint32_t q_0 = (_S6->groupID * Vector<uint32_t, 3> (64U, 1U, 1U) + _S6->groupThreadID).x;
    if(q_0 >= ((slang_bit_cast<GlobalParams_0*>(globalParams_1))->params_0->n_queries_0))
    {

#line 59
        return;
    }
    uint32_t code_0 = (&kernelContext_3)->globalParams_0->queries_0.Load(q_0);
    uint32_t kind_0 = code_0 >> 30U;
    uint32_t id_0 = code_0 & 1073741823U;

#line 63
    uint32_t _S7;

    if(((slang_bit_cast<GlobalParams_0*>(globalParams_1))->params_0->write_0) != 0U)
    {

#line 65
        _S7 = *(&((&kernelContext_3)->globalParams_0->counts_0)[q_0]);
...
#line 67
        uint32_t _S10 = 2U * id_0;

#line 67
        uint32_t _S11 = (&kernelContext_3)->globalParams_0->edges_0.Load(_S10);
        uint32_t _S12 = (&kernelContext_3)->globalParams_0->edges_0.Load(_S10 + 1U);
...
#line 69
            if(j_0 < ((slang_bit_cast<GlobalParams_0*>(globalParams_1))->params_0->n_e_0))
            {
            }
            else
            {
...
#line 71
                uint32_t _S13 = 2U * j_0;

#line 71
                uint32_t b0_0 = (&kernelContext_3)->globalParams_0->edges_0.Load(_S13);
                uint32_t b1_0 = (&kernelContext_3)->globalParams_0->edges_0.Load(_S13 + 1U);
                if(_S11 == b0_0)
                {
...
#line 73
                ...
                if(((&kernelContext_3)->globalParams_0->garment_0).Load(b0_0) != 0U)
                {

#line 74
                    target_is_query_0 = true;
...
#line 74
                    target_is_query_0 = ((&kernelContext_3)->globalParams_0->garment_0).Load(b1_0) != 0U;

#line 74
                }
                if(!target_is_query_0)
                {
...
#line 76
                    bool _S15 = can_collide_0(_S11, b0_0, &kernelContext_3);
...
#line 76
                        bool _S16 = can_collide_0(_S11, b1_0, &kernelContext_3);
...
#line 76
                        bool _S18 = can_collide_0(_S12, b0_0, &kernelContext_3);
...
#line 76
                            bool _S19 = can_collide_0(_S12, b1_0, &kernelContext_3);
...
#line 76
                    bool _S20 = overlaps_0((slang_bit_cast<GlobalParams_0*>(globalParams_1))->params_0->n_v_0 + id_0, (slang_bit_cast<GlobalParams_0*>(globalParams_1))->params_0->n_v_0 + j_0, &kernelContext_3);
                    if(_S20)
                    {
...
#line 79
                            uint32_t _S21 = 2U * (_S7 + c_0);

#line 79
                            *(&((&kernelContext_3)->globalParams_0->pairs_0)[_S21]) = (U32_min((id_0), (j_0)));
                            *(&((&kernelContext_3)->globalParams_0->pairs_0)[_S21 + 1U]) = (U32_max((id_0), (j_0)));
...
#line 89
                if(j_0 < ((slang_bit_cast<GlobalParams_0*>(globalParams_1))->params_0->n_f_0))
                {
                }
                else
                {
...
#line 90
                uint32_t b_3 = 3U * j_0;
                uint32_t f0_0 = (&kernelContext_3)->globalParams_0->faces_0.Load(b_3);
                uint32_t f1_0 = (&kernelContext_3)->globalParams_0->faces_0.Load(b_3 + 1U);
                uint32_t f2_0 = (&kernelContext_3)->globalParams_0->faces_0.Load(b_3 + 2U);
                if(id_0 == f0_0)
                {
...
#line 95
                    bool _S22 = garment_face_0(j_0, &kernelContext_3);

#line 95
                    target_is_query_0 = !_S22;
...
#line 95
                    bool _S23 = can_collide_0(id_0, f0_0, &kernelContext_3);
...
#line 95
                        bool _S24 = can_collide_0(id_0, f1_0, &kernelContext_3);
...
#line 95
                        bool _S25 = can_collide_0(id_0, f2_0, &kernelContext_3);
...
#line 95
                    bool _S26 = overlaps_0(id_0, (slang_bit_cast<GlobalParams_0*>(globalParams_1))->params_0->n_v_0 + (slang_bit_cast<GlobalParams_0*>(globalParams_1))->params_0->n_e_0 + j_0, &kernelContext_3);
                    if(_S26)
                    {
...
#line 98
                            uint32_t _S27 = 2U * (_S7 + c_0);

#line 98
                            *(&((&kernelContext_3)->globalParams_0->pairs_0)[_S27]) = j_0;
                            *(&((&kernelContext_3)->globalParams_0->pairs_0)[_S27 + 1U]) = id_0;
...
#line 106
            uint32_t b_4 = 3U * id_0;
            uint32_t _S28 = (&kernelContext_3)->globalParams_0->faces_0.Load(b_4);
            uint32_t _S29 = (&kernelContext_3)->globalParams_0->faces_0.Load(b_4 + 1U);
            uint32_t _S30 = (&kernelContext_3)->globalParams_0->faces_0.Load(b_4 + 2U);
...
#line 110
                if(j_0 < ((slang_bit_cast<GlobalParams_0*>(globalParams_1))->params_0->n_v_0))
                {
                }
                else
                {
...
#line 112
                    bool _S31 = can_collide_0(j_0, _S28, &kernelContext_3);
...
#line 112
                        bool _S32 = can_collide_0(j_0, _S29, &kernelContext_3);

#line 112
                        target_is_query_0 = _S32;
...
#line 112
                        bool _S33 = can_collide_0(j_0, _S30, &kernelContext_3);
...
#line 112
                    bool _S34 = overlaps_0(j_0, (slang_bit_cast<GlobalParams_0*>(globalParams_1))->params_0->n_v_0 + (slang_bit_cast<GlobalParams_0*>(globalParams_1))->params_0->n_e_0 + id_0, &kernelContext_3);
                    if(_S34)
                    {
...
#line 115
                            uint32_t _S35 = 2U * (_S7 + c_0);

#line 115
                            *(&((&kernelContext_3)->globalParams_0->pairs_0)[_S35]) = id_0;
                            *(&((&kernelContext_3)->globalParams_0->pairs_0)[_S35 + 1U]) = j_0;
...
#line 125
        *(&((&kernelContext_3)->globalParams_0->counts_0)[q_0]) = c_0;
