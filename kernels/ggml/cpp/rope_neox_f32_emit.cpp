...
#line 1 "slang/rope_neox_f32.slang"
struct Slot_0
{
    uint32_t base_0;
    uint32_t pad0_0;
...
struct GlobalParams_0
{
    ...
    RWStructuredBuffer<int32_t> s1_0;
...
#line 21 "slang/rope_neox_f32.slang"
...
#line 29
static uint32_t off4_0(uint32_t w_0, uint32_t i0_0, uint32_t i1_0, uint32_t i2_0, uint32_t i3_0, KernelContext_0 * kernelContext_1)
{

#line 29
    uint32_t _S1 = pw_0(w_0 + 8U, kernelContext_1);

#line 29
    uint32_t _S2 = pw_0(w_0 + 4U, kernelContext_1);
    uint32_t _S3 = _S1 + i0_0 * _S2;

#line 30
    uint32_t _S4 = pw_0(w_0 + 5U, kernelContext_1);

#line 30
    uint32_t _S5 = _S3 + i1_0 * _S4;

#line 30
    uint32_t _S6 = pw_0(w_0 + 6U, kernelContext_1);

#line 30
    uint32_t _S7 = _S5 + i2_0 * _S6;

#line 30
    uint32_t _S8 = pw_0(w_0 + 7U, kernelContext_1);
...
#line 25
static float pf_0(uint32_t k_1, KernelContext_0 * kernelContext_2)
{

#line 25
    uint32_t _S9 = pw_0(k_1, kernelContext_2);
    return (U32_asfloat((_S9)));
}


#line 34
void _main_0(void* _S10, void* entryPointParams_0, void* globalParams_1)
{

#line 34
    ComputeThreadVaryingInput * _S11 = (slang_bit_cast<ComputeThreadVaryingInput *>(_S10));
...
#line 34
    Vector<uint32_t, 3>  _S12 = _S11->groupID;

#line 34
    Vector<uint32_t, 3>  _S13 = _S11->groupThreadID;
    uint32_t _S14 = _S11->groupID.y;

#line 35
    uint32_t _S15 = pw_0(54U, &kernelContext_3);

#line 35
    uint32_t e_0 = (_S14 * _S15 + _S12.x) * 256U + _S13.x;

#line 35
    uint32_t _S16 = pw_0(53U, &kernelContext_3);
    if(e_0 >= _S16)
    {
...
#line 37
    uint32_t _S17 = pw_0(55U, &kernelContext_3);


    uint32_t j_0 = e_0 % _S17;
    uint32_t r_0 = e_0 / _S17;

#line 41
    uint32_t _S18 = pw_0(2U, &kernelContext_3);
    uint32_t i1_1 = r_0 % _S18;

#line 42
    uint32_t _S19 = pw_0(2U, &kernelContext_3);
    uint32_t r_1 = r_0 / _S19;

#line 43
    uint32_t _S20 = pw_0(3U, &kernelContext_3);
    uint32_t i2_1 = r_1 % _S20;

#line 44
    uint32_t _S21 = pw_0(3U, &kernelContext_3);
    uint32_t i3_1 = r_1 / _S21;

#line 45
    uint32_t _S22 = pw_0(56U, &kernelContext_3);

    if(j_0 >= _S22)
    {

#line 48
        uint32_t c0_0 = 2U * j_0;

#line 48
        uint32_t _S23 = off4_0(10U, c0_0, i1_1, i2_1, i3_1, &kernelContext_3);
        float * _S24 = (&((&kernelContext_3)->globalParams_0->s0_0)[_S23]);
        uint32_t _S25 = c0_0 + 1U;

#line 50
        uint32_t _S26 = off4_0(10U, _S25, i1_1, i2_1, i3_1, &kernelContext_3);

#line 50
        float y1_0 = *(&((&kernelContext_3)->globalParams_0->s0_0)[_S26]);

#line 50
        uint32_t _S27 = off4_0(1U, c0_0, i1_1, i2_1, i3_1, &kernelContext_3);
        *(&((&kernelContext_3)->globalParams_0->dst_0)[_S27]) = *_S24;

#line 51
        uint32_t _S28 = off4_0(1U, _S25, i1_1, i2_1, i3_1, &kernelContext_3);
        *(&((&kernelContext_3)->globalParams_0->dst_0)[_S28]) = y1_0;
        return;
    }

#line 53
    uint32_t _S29 = pw_0(27U, &kernelContext_3);

#line 53
    uint32_t _S30 = pw_0(23U, &kernelContext_3);

    float _S31 = float(*(&((&kernelContext_3)->globalParams_0->s1_0)[_S29 + i2_1 * _S30]));

#line 55
    float _S32 = pf_0(57U, &kernelContext_3);
...
#line 57
    float _S34 = pf_0(44U, &kernelContext_3);

#line 57
    float _S35 = pf_0(43U, &kernelContext_3);



    float ti_0 = _S35 * te_0;
...
#line 63
        float _S36 = pf_0(58U, &kernelContext_3);

        float _S37 = float(j_0) - _S36;

#line 65
        float _S38 = pf_0(59U, &kernelContext_3);
        float rm_0 = (1.0f - (F32_min((1.0f), ((F32_max((0.0f), (_S37 / (F32_max((0.00100000004749745f), (_S38 - _S36)))))))))) * _S34;

#line 66
        th_0 = ti_0 * (1.0f - rm_0) + te_0 * rm_0;
...
#line 63
    float _S39 = pf_0(60U, &kernelContext_3);

#line 70
    float ct_0 = (F32_cos((th_0))) * _S39;
    float st_0 = (F32_sin((th_0))) * _S39;
    uint32_t j1_0 = j_0 + _S22;

#line 72
    uint32_t _S40 = off4_0(10U, j_0, i1_1, i2_1, i3_1, &kernelContext_3);
    float * _S41 = (&((&kernelContext_3)->globalParams_0->s0_0)[_S40]);

#line 73
    float x0_0 = *_S41;

#line 73
    uint32_t _S42 = off4_0(10U, j1_0, i1_1, i2_1, i3_1, &kernelContext_3);
    float * _S43 = (&((&kernelContext_3)->globalParams_0->s0_0)[_S42]);

#line 74
    float x1_0 = *_S43;

#line 74
    uint32_t _S44 = off4_0(1U, j_0, i1_1, i2_1, i3_1, &kernelContext_3);
    *(&((&kernelContext_3)->globalParams_0->dst_0)[_S44]) = *_S41 * ct_0 - *_S43 * st_0;

#line 75
    uint32_t _S45 = off4_0(1U, j1_0, i1_1, i2_1, i3_1, &kernelContext_3);
    *(&((&kernelContext_3)->globalParams_0->dst_0)[_S45]) = x0_0 * st_0 + x1_0 * ct_0;
    return;
}
