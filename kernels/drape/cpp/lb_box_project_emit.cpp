...
#line 1 "slang/lb_box_project.slang"
struct LbBoxProjectParams_0
{
    uint32_t n_0;
};
...
{
    LbBoxProjectParams_0* params_0;
    RWStructuredBuffer<float> x_0;
...
#line 18
    ...
    *(&((&kernelContext_0)->globalParams_0->x_0)[i_0]) = (F32_min(((F32_max((*(&((&kernelContext_0)->globalParams_0->x_0)[i_0])), ((&kernelContext_0)->globalParams_0->lb_0.Load(i_0))))), ((&kernelContext_0)->globalParams_0->ub_0.Load(i_0))));
    return;
}
