...
#line 1 "slang/get_rows_b32.slang"
struct Slot_0
{
    uint32_t base_0;
    uint32_t pad0_0;
...
#line 41
    uint32_t _S16 = off4_0(19U, i1_2, i2_2, i3_2, 0U, kernelContext_3);

#line 41
    uint32_t _S17 = off4_0(10U, i0_2, *(&(kernelContext_3->globalParams_0->s1_0)[_S16]), i2_2, i3_2, kernelContext_3);

    return *(&(kernelContext_3->globalParams_0->s0_0)[_S17]);
}
...
#line 48
    uint32_t _S23 = pw_0(54U, &kernelContext_4);

#line 48
    uint32_t e_1 = (_S22 * _S23 + _S20.x) * 256U + _S21.x;

#line 48
    uint32_t _S24 = pw_0(53U, &kernelContext_4);
    if(e_1 >= _S24)
    {
...
#line 55
    uint32_t _S25 = off4_0(1U, i0_3, i1_3, i2_3, i3_3, &kernelContext_4);

    uint32_t * _S26 = (&((&kernelContext_4)->globalParams_0->dst_0)[_S25]);

#line 57
    uint32_t _S27 = val_0(i0_3, i1_3, i2_3, i3_3, &kernelContext_4);
