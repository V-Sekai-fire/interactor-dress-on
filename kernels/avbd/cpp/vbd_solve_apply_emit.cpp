...
{
    StructuredBuffer<Vector<float, 3> > gScratch_0;
    StructuredBuffer<float> hScratch_0;
    RWStructuredBuffer<Vector<float, 3> > positions_0;
    StructuredBuffer<uint32_t> vertPerm_0;
    VbdSolveApplyParams_0* params_0;
};
...
#line 21
    ...
    Vector<float, 3>  g_0 = (&kernelContext_0)->globalParams_0->gScratch_0.Load(v_0);
    float Hxx_0 = (&kernelContext_0)->globalParams_0->hScratch_0.Load(hb_0);
    float Hxy_0 = (&kernelContext_0)->globalParams_0->hScratch_0.Load(hb_0 + 1U);
    float Hxz_0 = (&kernelContext_0)->globalParams_0->hScratch_0.Load(hb_0 + 2U);
    float Hyy_0 = (&kernelContext_0)->globalParams_0->hScratch_0.Load(hb_0 + 3U);
    float Hyz_0 = (&kernelContext_0)->globalParams_0->hScratch_0.Load(hb_0 + 4U);
    float Hzz_0 = (&kernelContext_0)->globalParams_0->hScratch_0.Load(hb_0 + 5U);
    ...
    float gy_0 = g_0.y;
    float gz_0 = g_0.z;
    float _S3 = 0.0f - 1.0f / (Hxx_0 * a00_0 + Hxy_0 * a01_0 + Hxz_0 * a02_0);


    Vector<float, 3>  * _S4 = (&((&kernelContext_0)->globalParams_0->positions_0)[v_0]);
    *(&((&kernelContext_0)->globalParams_0->positions_0)[v_0]) = Vector<float, 3> ((*_S4).x + _S3 * (a00_0 * gx_0 + a01_0 * gy_0 + a02_0 * gz_0), (*_S4).y + _S3 * (a01_0 * gx_0 + (Hxx_0 * Hzz_0 - Hxz_0 * Hxz_0) * gy_0 + a12_0 * gz_0), (*_S4).z + _S3 * (a02_0 * gx_0 + a12_0 * gy_0 + (Hxx_0 * Hyy_0 - Hxy_0 * Hxy_0) * gz_0));
    return;
}
