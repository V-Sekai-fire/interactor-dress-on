...
#line 1 "C:/interactor-dress-on/kernels/avbd/slang/vbd_gather_attachment.slang"
struct VbdGatherAttachmentParams_0
{
...
{
    StructuredBuffer<Vector<float, 3> > attachGradV_0;
    StructuredBuffer<float> attachHessScalar_0;
    StructuredBuffer<uint32_t> vertAttachOffset_0;
    StructuredBuffer<uint32_t> vertAttachIdx_0;
    RWStructuredBuffer<Vector<float, 3> > gScratch_0;
    RWStructuredBuffer<float> hScratch_0;
    StructuredBuffer<uint32_t> vertPerm_0;
    VbdGatherAttachmentParams_0* params_0;
};
...
#line 27
    ...
    uint32_t sStart_0 = (&kernelContext_0)->globalParams_0->vertAttachOffset_0.Load(v_0);
    uint32_t _S3 = (&kernelContext_0)->globalParams_0->vertAttachOffset_0.Load(v_0 + 1U);
...
#line 41
        uint32_t c_0 = (&kernelContext_0)->globalParams_0->vertAttachIdx_0.Load(k_0);
        Vector<float, 3>  ga_0 = (&kernelContext_0)->globalParams_0->attachGradV_0.Load(c_0);
        float hs_0 = (&kernelContext_0)->globalParams_0->attachHessScalar_0.Load(c_0);
