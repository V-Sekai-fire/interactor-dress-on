...
#line 1 "slang/lb_apply_m.slang"
struct LbApplyMParams_0
{
    uint32_t mcap_0;
    uint32_t inOff_0;
    uint32_t outOff_0;
...
{
    LbApplyMParams_0* params_0;
    StructuredBuffer<uint32_t> st_0;
    StructuredBuffer<float> bf_0;
    StructuredBuffer<float> vin_0;
    RWStructuredBuffer<float> vout_0;
};
...
#line 63
        w_1[j_2] = (&kernelContext_1)->globalParams_0->vin_0.Load((&kernelContext_1)->globalParams_0->params_0->inOff_0 + j_2);
...
#line 62
    lb_mv_0(nc_1, (&kernelContext_1)->globalParams_0->params_0->mcap_0, &w_1, &kernelContext_1);
...
#line 67
        *(&((&kernelContext_1)->globalParams_0->vout_0)[(&kernelContext_1)->globalParams_0->params_0->outOff_0 + j_2]) = w_1[j_2];
