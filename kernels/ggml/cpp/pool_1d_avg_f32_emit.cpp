...
#line 1 "slang/pool_1d_avg_f32.slang"
struct Slot_0
{
    uint32_t base_0;
    uint32_t pad0_0;
...
#line 50
    uint32_t _S24 = off4_0(10U, 0U, i1_2, i2_2, i3_2, &kernelContext_3);

#line 50
    uint32_t _S25 = pw_0(14U, &kernelContext_3);

#line 50
    uint32_t _S26 = pw_0(10U, &kernelContext_3);

#line 50
    uint32_t _S27 = pw_0(38U, &kernelContext_3);

#line 50
    uint32_t _S28 = pw_0(39U, &kernelContext_3);

#line 50
    uint32_t _S29 = pw_0(40U, &kernelContext_3);

#line 59
    uint32_t _S30 = i0_2 * _S28;
...
#line 64
        if(_S31)
        {
            ...
            uint32_t _S32 = count_0 + 1U;

#line 67
            res_0 = res_0 + *(&((&kernelContext_3)->globalParams_0->s0_0)[_S24 + (q_0 - _S29) * _S25]);
...
#line 70
    float * _S33 = (&((&kernelContext_3)->globalParams_0->dst_0)[_S23]);
