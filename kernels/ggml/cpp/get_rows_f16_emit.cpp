...
#line 1 "slang/get_rows_f16.slang"
struct Slot_0
{
    uint32_t base_0;
    uint32_t pad0_0;
...
#line 66
    uint32_t _S17 = off4_0(19U, i1_2, i2_2, i3_2, 0U, kernelContext_4);

#line 66
    uint32_t _S18 = off4_0(10U, i0_2, *(&(kernelContext_4->globalParams_0->s1_0)[_S17]), i2_2, i3_2, kernelContext_4);

#line 66
    uint32_t _S19 = ld16_s0_0(_S18, kernelContext_4);

    return f16_to_f32_0(_S19);
}


void _main_0(void* _S20, void* entryPointParams_0, void* globalParams_1)
{

#line 72
    ComputeThreadVaryingInput * _S21 = (slang_bit_cast<ComputeThreadVaryingInput *>(_S20));
...
#line 72
    Vector<uint32_t, 3>  _S22 = _S21->groupID;

#line 72
    Vector<uint32_t, 3>  _S23 = _S21->groupThreadID;
    uint32_t _S24 = _S21->groupID.y;

#line 73
    uint32_t _S25 = pw_0(54U, &kernelContext_5);

#line 73
    uint32_t e_2 = (_S24 * _S25 + _S22.x) * 256U + _S23.x;

#line 73
    uint32_t _S26 = pw_0(53U, &kernelContext_5);
    if(e_2 >= _S26)
    {
...
#line 80
    uint32_t _S27 = off4_0(1U, i0_3, i1_3, i2_3, i3_3, &kernelContext_5);

    uint32_t * _S28 = (&((&kernelContext_5)->globalParams_0->dst_0)[_S27]);

#line 82
    uint32_t _S29 = val_0(i0_3, i1_3, i2_3, i3_3, &kernelContext_5);
