...
#line 22 "C:/interactor-dress-on/kernels/avbd/slang/vbd_gather_triangle_backward.slang"
struct GlobalParams_0
{
    StructuredBuffer<uint32_t> triIdx_0;
    StructuredBuffer<Vector<float, 3> > v_g_0;
    StructuredBuffer<float> v_H_0;
    RWStructuredBuffer<Vector<float, 3> > v_triGrad_0;
    RWStructuredBuffer<float> v_triHessScalar_0;
};
...
#line 13
    ...
    uint32_t v_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->triIdx_0.Load(slot_0);
    ...
    *(&((slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_triGrad_0)[slot_0]) = Vector<float, 3> (vg_0.x, vg_0.y, vg_0.z);
    *(&((slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_triHessScalar_0)[slot_0]) = vHxx_0 + vHyy_0 + vHzz_0;
    return;
}
