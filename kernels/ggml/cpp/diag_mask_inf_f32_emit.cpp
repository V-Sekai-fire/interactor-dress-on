...
#line 1 "slang/diag_mask_inf_f32.slang"
struct Slot_0
{
    uint32_t base_0;
    uint32_t pad0_0;
...
#line 50
    ...
    float x_0 = *(&((&kernelContext_3)->globalParams_0->s0_0)[_S24]);
    float * _S25 = (&((&kernelContext_3)->globalParams_0->dst_0)[_S23]);
