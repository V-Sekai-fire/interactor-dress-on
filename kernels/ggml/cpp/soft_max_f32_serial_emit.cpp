...
#line 1 "slang/soft_max_f32_serial.slang"
struct Slot_0
{
    uint32_t base_0;
    uint32_t pad0_0;
...
#line 21 "slang/soft_max_f32_serial.slang"
...
#line 34
    ...
    uint32_t _S13 = _S11->groupID.y;

#line 35
    uint32_t _S14 = pw_0(54U, &kernelContext_3);

#line 35
    uint32_t row_0 = _S13 * _S14 + _S12.x;

#line 35
    uint32_t _S15 = pw_0(55U, &kernelContext_3);
    if(row_0 >= _S15)
    {
...
#line 39
    uint32_t _S16 = pw_0(10U, &kernelContext_3);

#line 39
    uint32_t _S17 = pw_0(11U, &kernelContext_3);

    uint32_t r1_0 = row_0 % _S17;

#line 41
    uint32_t _S18 = pw_0(11U, &kernelContext_3);
    uint32_t rr_0 = row_0 / _S18;

#line 42
    uint32_t _S19 = pw_0(12U, &kernelContext_3);
    uint32_t r2_0 = rr_0 % _S19;

#line 43
    uint32_t _S20 = pw_0(12U, &kernelContext_3);
    uint32_t r3_0 = rr_0 / _S20;

#line 44
    uint32_t _S21 = off4_0(10U, 0U, r1_0, r2_0, r3_0, &kernelContext_3);

#line 44
    uint32_t _S22 = pw_0(14U, &kernelContext_3);

#line 44
    uint32_t _S23 = off4_0(1U, 0U, r1_0, r2_0, r3_0, &kernelContext_3);

#line 44
    uint32_t _S24 = pw_0(5U, &kernelContext_3);

#line 44
    float _S25 = pf_0(37U, &kernelContext_3);
...
#line 51
        float _S26 = (U32_asfloat((4286578688U)));
...
#line 53
            ...
            float _S27 = (F32_max((acc_mx_0), (*(&((&kernelContext_3)->globalParams_0->s0_0)[_S21 + i_mx_0 * _S22]) * _S25)));
...
#line 61
        sh_0[t_0] = (F32_max((sh_0[t_0]), (sh_0[t_0 + 128U])));
...
#line 64
        sh_0[t_0] = (F32_max((sh_0[t_0]), (sh_0[t_0 + 64U])));
...
#line 67
        sh_0[t_0] = (F32_max((sh_0[t_0]), (sh_0[t_0 + 32U])));
...
#line 70
        sh_0[t_0] = (F32_max((sh_0[t_0]), (sh_0[t_0 + 16U])));
...
#line 73
        sh_0[t_0] = (F32_max((sh_0[t_0]), (sh_0[t_0 + 8U])));
...
#line 76
        sh_0[t_0] = (F32_max((sh_0[t_0]), (sh_0[t_0 + 4U])));
...
#line 79
        sh_0[t_0] = (F32_max((sh_0[t_0]), (sh_0[t_0 + 2U])));
...
#line 82
        uint32_t _S28 = t_0 + 1U;

#line 82
        sh_0[t_0] = (F32_max((sh_0[t_0]), (sh_0[_S28])));
...
#line 88
            ...
            float _S30 = acc_mx_0 + (F32_exp((*(&((&kernelContext_3)->globalParams_0->s0_0)[_S21 + i_mx_0 * _S22]) * _S25 - _S29)));
...
#line 117
        uint32_t _S31 = t_0 + 1U;

#line 117
        sh_0[t_0] = sh_0[t_0] + sh_0[_S31];
...
#line 121
        ...
        *(&((&kernelContext_3)->globalParams_0->dst_0)[_S23 + i_mx_0 * _S24]) = (F32_exp((*(&((&kernelContext_3)->globalParams_0->s0_0)[_S21 + i_mx_0 * _S22]) * _S25 - _S29))) * _S32;
