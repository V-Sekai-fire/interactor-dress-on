...
#line 50
    unravel4_0(e_1, 1U, &ox_0, &oy_0, &oc_0, &n_0, &kernelContext_3);

#line 50
    uint32_t _S23 = pw_0(37U, &kernelContext_3);

#line 50
    uint32_t _S24 = pw_0(38U, &kernelContext_3);

#line 50
    uint32_t _S25 = pw_0(39U, &kernelContext_3);

#line 50
    uint32_t _S26 = pw_0(40U, &kernelContext_3);

#line 50
    uint32_t _S27 = pw_0(41U, &kernelContext_3);

#line 50
    uint32_t _S28 = pw_0(42U, &kernelContext_3);

#line 50
    uint32_t _S29 = pw_0(10U, &kernelContext_3);

#line 50
    uint32_t _S30 = pw_0(11U, &kernelContext_3);

#line 50
    uint32_t _S31 = pw_0(12U, &kernelContext_3);

#line 50
    uint32_t _S32 = pw_0(19U, &kernelContext_3);

#line 50
    uint32_t _S33 = pw_0(20U, &kernelContext_3);

#line 50
    uint32_t _S34 = pw_0(14U, &kernelContext_3);

#line 50
    uint32_t _S35 = pw_0(15U, &kernelContext_3);

#line 50
    uint32_t _S36 = pw_0(16U, &kernelContext_3);

#line 50
    uint32_t _S37 = pw_0(17U, &kernelContext_3);

#line 50
    uint32_t _S38 = pw_0(23U, &kernelContext_3);

#line 50
    uint32_t _S39 = pw_0(24U, &kernelContext_3);

#line 50
    uint32_t _S40 = pw_0(25U, &kernelContext_3);

#line 50
    uint32_t _S41 = pw_0(26U, &kernelContext_3);

#line 50
    uint32_t _S42 = pw_0(27U, &kernelContext_3);

#line 71
    uint32_t _S43 = _S42 + n_0 * _S41;

#line 71
    uint32_t _S44 = pw_0(18U, &kernelContext_3);
    uint32_t _S45 = _S44 + oc_0 * _S37;
...
#line 75
        uint32_t _S46 = _S43 + ic_0 * _S40;
        uint32_t _S47 = _S45 + ic_0 * _S36;
...
#line 78
            uint32_t y_0 = oy_0 * _S24 + ky_0 * _S28;
...
#line 80
                uint32_t _S49 = _S46 + (y_0 - _S26) * _S39;
                uint32_t _S50 = _S47 + ky_0 * _S35;
...
#line 83
                    uint32_t x_0 = ox_0 * _S23 + kx_0 * _S27;
...
#line 84
                        acc_2 = acc_2 + *(&((&kernelContext_3)->globalParams_0->s1_0)[_S49 + (x_0 - _S25) * _S38]) * *(&((&kernelContext_3)->globalParams_0->s0_0)[_S50 + kx_0 * _S34]);
...
#line 74
    uint32_t _S52 = off4_0(1U, ox_0, oy_0, oc_0, n_0, &kernelContext_3);

#line 91
    *(&((&kernelContext_3)->globalParams_0->dst_0)[_S52]) = acc_0;
    return;
}
