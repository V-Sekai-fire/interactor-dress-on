...
#line 1 "slang/lb_step_max_serial.slang"
struct LbStepMaxParams_0
{
    uint32_t n_0;
    uint32_t dstOff_0;
};
...
{
    LbStepMaxParams_0* params_0;
    StructuredBuffer<float> x_0;
    StructuredBuffer<float> d_0;
...
#line 20
    float acc_0 = (U32_asfloat((2139095039U)));
...
#line 23
        float di_0 = (&kernelContext_0)->globalParams_0->d_0.Load(i_0);
...
#line 24
            _S3 = ((&kernelContext_0)->globalParams_0->ub_0).Load(i_0) < (U32_asfloat((1900671690U)));
...
#line 24
            acc_1 = (F32_min((acc_0), (((&kernelContext_0)->globalParams_0->ub_0.Load(i_0) - (&kernelContext_0)->globalParams_0->x_0.Load(i_0)) / di_0)));
...
#line 27
            _S4 = ((&kernelContext_0)->globalParams_0->lb_0).Load(i_0) > (- (U32_asfloat((1900671690U))));
...
#line 27
            acc_0 = (F32_min((acc_1), (((&kernelContext_0)->globalParams_0->lb_0.Load(i_0) - (&kernelContext_0)->globalParams_0->x_0.Load(i_0)) / di_0)));
...
#line 31
    *(&((&kernelContext_0)->globalParams_0->dst_0)[_S2->params_0->dstOff_0]) = acc_0;
    return;
}
