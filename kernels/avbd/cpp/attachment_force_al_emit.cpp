...
#line 25 "C:/interactor-dress-on/kernels/avbd/slang/attachment_force_al.slang"
struct GlobalParams_0
{
    ...
    RWStructuredBuffer<Vector<float, 3> > gradV_0;
...
#line 17
    ...
    Vector<float, 3>  lam_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->lambda_0.Load(c_0);
    *(&((slang_bit_cast<GlobalParams_0*>(globalParams_0))->gradV_0)[c_0]) = Vector<float, 3> (k_0 * (p_0.x - fp_0.x) + lam_0.x, k_0 * (p_0.y - fp_0.y) + lam_0.y, k_0 * (p_0.z - fp_0.z) + lam_0.z);
    *(&((slang_bit_cast<GlobalParams_0*>(globalParams_0))->hessScalar_0)[c_0]) = k_0;
    return;
}
