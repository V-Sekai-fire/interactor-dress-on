...
#line 1 "slang/csr_gather_df32.slang"
struct df_0
{
    float hi_0;
    float lo_0;
...
{
    StructuredBuffer<uint32_t> ptr_0;
    StructuredBuffer<uint32_t> src_0;
    StructuredBuffer<df_0> blocks_0;
    StructuredBuffer<df_0> weight_0;
    RWStructuredBuffer<df_0> values_0;
    GatherParams_0* params_0;
};
...
#line 49
static df_0 two_prod_0(float a_0, float b_0)
{

#line 50
    precise float p_0 = a_0 * b_0;
    precise float e_0 = (F32_fma((a_0), (b_0), (- p_0)));
    return df_make_0(p_0, e_0);
}
...
#line 44
    precise float s_0 = a_1 + b_1;
    precise float e_1 = b_1 - (s_0 - a_1);
    return df_make_0(s_0, e_1);
}


#line 72
static df_0 df_mul_0(df_0 * x_0, df_0 * y_0)
{

#line 73
    df_0 p_1 = two_prod_0(x_0->hi_0, y_0->hi_0);
    precise float c_0 = x_0->hi_0 * y_0->lo_0;
    precise float d_0 = x_0->lo_0 * y_0->hi_0;
...
#line 34
static df_0 two_sum_0(float a_2, float b_2)
{

#line 35
    precise float s_1 = a_2 + b_2;
    precise float bb_0 = s_1 - a_2;
    precise float ea_0 = a_2 - (s_1 - bb_0);
    precise float eb_0 = b_2 - bb_0;
    precise float e_2 = ea_0 + eb_0;
    return df_make_0(s_1, e_2);
}


#line 55
static df_0 df_add_0(df_0 * x_1, df_0 * y_1)
{

#line 56
    df_0 s_2 = two_sum_0(x_1->hi_0, y_1->hi_0);
    df_0 t_0 = two_sum_0(x_1->lo_0, y_1->lo_0);
...
#line 126
    ...
    if(i_0 >= ((slang_bit_cast<GlobalParams_0*>(globalParams_1))->params_0->nnz_0))
    {
...
#line 129
    ...
    uint32_t _S3 = (&kernelContext_0)->globalParams_0->ptr_0.Load(i_0);

#line 132
    df_0 acc_0 = df_make_0(0.0f, 0.0f);
...
#line 132
        if(j_0 < ((&kernelContext_0)->globalParams_0->ptr_0).Load(i_0 + 1U))
        {
        }
        else
        {
...
#line 133
        uint32_t s_3 = (&kernelContext_0)->globalParams_0->src_0.Load(j_0);

        df_0 _S4 = (&kernelContext_0)->globalParams_0->blocks_0.Load(s_3);

#line 135
        df_0 _S5 = (&kernelContext_0)->globalParams_0->weight_0.Load(s_3 / 144U);

#line 135
        df_0 _S6 = _S4;

#line 135
        df_0 _S7 = df_mul_0(&_S5, &_S6);
...
#line 137
    *(&((&kernelContext_0)->globalParams_0->values_0)[i_0]) = acc_0;
    return;
}
