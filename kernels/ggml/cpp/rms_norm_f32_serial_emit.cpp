...
#line 1 "slang/rms_norm_f32_serial.slang"
struct Slot_0
{
    uint32_t base_0;
    uint32_t pad0_0;
...
#line 21 "slang/rms_norm_f32_serial.slang"
...
#line 54
            float * _S26 = (&((&kernelContext_3)->globalParams_0->s0_0)[_S21 + i_sumsq_0 * _S22]);
            float _S27 = acc_sumsq_0 + *_S26 * *_S26;

#line 55
            i_sumsq_0 = i_sumsq_0 + 256U;
...
#line 86
    float _S29 = 1.0f / (F32_sqrt((sh_0[0U] / float(_S16) + _S25)));
...
#line 87
        ...
        *(&((&kernelContext_3)->globalParams_0->dst_0)[_S23 + i_sumsq_0 * _S24]) = *(&((&kernelContext_3)->globalParams_0->s0_0)[_S21 + i_sumsq_0 * _S22]) * _S29;

#line 87
        i_sumsq_0 = i_sumsq_0 + 1U;
