...
void _main_0(void* _S2, void* entryPointParams_0, void* globalParams_1)
{

#line 30
    ComputeThreadVaryingInput * _S3 = (slang_bit_cast<ComputeThreadVaryingInput *>(_S2));
...
#line 30
    Vector<uint32_t, 3>  _S4 = _S3->groupID;

#line 30
    Vector<uint32_t, 3>  _S5 = _S3->groupThreadID;
    uint32_t _S6 = _S3->groupID.y;

#line 31
    uint32_t _S7 = pw_0(54U, &kernelContext_2);

#line 31
    uint32_t e_0 = (_S6 * _S7 + _S4.x) * 256U + _S5.x;

#line 31
    uint32_t _S8 = pw_0(53U, &kernelContext_2);
    if(e_0 >= _S8)
    {
...
#line 33
    uint32_t _S9 = pw_0(9U, &kernelContext_2);

#line 33
    uint32_t _S10 = pw_0(5U, &kernelContext_2);

    float * _S11 = (&((&kernelContext_2)->globalParams_0->dst_0)[_S9 + e_0 * _S10]);

#line 35
    float _S12 = pf_0(37U, &kernelContext_2);

#line 35
    float _S13 = pf_0(39U, &kernelContext_2);

#line 35
    *_S11 = _S12 + _S13 * float(e_0);
    return;
}
