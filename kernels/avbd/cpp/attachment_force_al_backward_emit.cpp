...
#line 35 "C:/interactor-dress-on/kernels/avbd/slang/attachment_force_al_backward.slang"
struct GlobalParams_0
{
    ...
    StructuredBuffer<Vector<float, 3> > v_gradV_0;
    StructuredBuffer<float> v_hessScalar_0;
    RWStructuredBuffer<Vector<float, 3> > v_positions_0;
    RWStructuredBuffer<Vector<float, 3> > v_fixedPos_0;
...
#line 23
    ...
    uint32_t v_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->vertIdx_0.Load(c_0);
    Vector<float, 3>  p_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->positions_0.Load(v_0);
    ...
    Vector<float, 3>  vG_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_gradV_0.Load(c_0);
    float vH_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_hessScalar_0.Load(c_0);
    float _S3 = vG_0.x;
...
#line 31
    *(&((slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_positions_0)[v_0]) = Vector<float, 3> (k_0 * _S3, k_0 * _S4, k_0 * _S5);
    float _S6 = 0.0f - k_0;

#line 32
    *(&((slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_fixedPos_0)[c_0]) = Vector<float, 3> (_S6 * _S3, _S6 * _S4, _S6 * _S5);
    *(&((slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_lambda_0)[c_0]) = Vector<float, 3> (_S3, _S4, _S5);

    *(&((slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_stiffness_0)[c_0]) = (p_0.x - fp_0.x) * _S3 + (p_0.y - fp_0.y) * _S4 + (p_0.z - fp_0.z) * _S5 + vH_0;
    return;
}
