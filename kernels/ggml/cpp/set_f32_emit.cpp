...
#line 50
    uint32_t _S23 = off4_0(1U, i0_2, i1_2, i2_2, i3_2, &kernelContext_3);

#line 50
    uint32_t _S24 = pw_0(1U, &kernelContext_3);


    uint32_t _S25 = i0_2 + i1_2 * _S24;

#line 53
    uint32_t _S26 = pw_0(1U, &kernelContext_3);

#line 53
    uint32_t _S27 = pw_0(2U, &kernelContext_3);

#line 53
    uint32_t _S28 = _S25 + i2_2 * (_S26 * _S27);

#line 53
    uint32_t _S29 = pw_0(1U, &kernelContext_3);

#line 53
    uint32_t _S30 = pw_0(2U, &kernelContext_3);

#line 53
    uint32_t _S31 = _S29 * _S30;

#line 53
    uint32_t _S32 = pw_0(3U, &kernelContext_3);

#line 53
    uint32_t l_0 = _S28 + i3_2 * (_S31 * _S32);

#line 53
    uint32_t _S33 = off4_0(10U, i0_2, i1_2, i2_2, i3_2, &kernelContext_3);
    float _S34 = *(&((&kernelContext_3)->globalParams_0->s0_0)[_S33]);

#line 54
    uint32_t _S35 = pw_0(58U, &kernelContext_3);
...
#line 57
        uint32_t r_2 = l_0 - _S35;

#line 57
        uint32_t _S36 = pw_0(57U, &kernelContext_3);
        uint32_t j3_0 = r_2 / _S36;

#line 58
        uint32_t _S37 = pw_0(57U, &kernelContext_3);
        uint32_t r_3 = r_2 % _S37;

#line 59
        uint32_t _S38 = pw_0(56U, &kernelContext_3);
        uint32_t j2_0 = r_3 / _S38;

#line 60
        uint32_t _S39 = pw_0(56U, &kernelContext_3);
        uint32_t r_4 = r_3 % _S39;

#line 61
        uint32_t _S40 = pw_0(55U, &kernelContext_3);
        uint32_t j1_0 = r_4 / _S40;

#line 62
        uint32_t _S41 = pw_0(55U, &kernelContext_3);
        uint32_t j0_0 = r_4 % _S41;

#line 63
        uint32_t _S42 = pw_0(19U, &kernelContext_3);
...
#line 64
            uint32_t _S44 = pw_0(20U, &kernelContext_3);
...
#line 64
            uint32_t _S45 = pw_0(21U, &kernelContext_3);
...
#line 64
                uint32_t _S46 = pw_0(22U, &kernelContext_3);
...
#line 64
            uint32_t _S47 = off4_0(19U, j0_0, j1_0, j2_0, j3_0, &kernelContext_3);

#line 64
            x_0 = *(&((&kernelContext_3)->globalParams_0->s1_0)[_S47]);
...
#line 68
    *(&((&kernelContext_3)->globalParams_0->dst_0)[_S23]) = x_0;
    return;
}
