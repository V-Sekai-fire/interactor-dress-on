...
#line 45
static uint32_t pad_wrap_0(uint32_t i_0, uint32_t lp_0, uint32_t n_0)
{

#line 46
    uint32_t _S16 = (i_0 + n_0 - lp_0) % n_0;
...
#line 41
static bool pad_in_0(uint32_t i_1, uint32_t lp_1, uint32_t n_1)
{
...
#line 50
void _main_0(void* _S18, void* entryPointParams_0, void* globalParams_1)
{

#line 50
    ComputeThreadVaryingInput * _S19 = (slang_bit_cast<ComputeThreadVaryingInput *>(_S18));
...
#line 50
    Vector<uint32_t, 3>  _S20 = _S19->groupID;

#line 50
    Vector<uint32_t, 3>  _S21 = _S19->groupThreadID;
    uint32_t _S22 = _S19->groupID.y;

#line 51
    uint32_t _S23 = pw_0(54U, &kernelContext_3);

#line 51
    uint32_t e_1 = (_S22 * _S23 + _S20.x) * 256U + _S21.x;

#line 51
    uint32_t _S24 = pw_0(53U, &kernelContext_3);
    if(e_1 >= _S24)
    {
...
#line 58
    uint32_t _S25 = off4_0(1U, i0_2, i1_2, i2_2, i3_2, &kernelContext_3);

#line 58
    uint32_t _S26 = pw_0(45U, &kernelContext_3);
...
#line 62
        float * _S27 = (&((&kernelContext_3)->globalParams_0->dst_0)[_S25]);

#line 62
        uint32_t _S28 = pw_0(37U, &kernelContext_3);

#line 62
        uint32_t _S29 = pw_0(10U, &kernelContext_3);

#line 62
        uint32_t _S30 = pad_wrap_0(i0_2, _S28, _S29);

#line 62
        uint32_t _S31 = pw_0(39U, &kernelContext_3);

#line 62
        uint32_t _S32 = pw_0(11U, &kernelContext_3);

#line 62
        uint32_t _S33 = pad_wrap_0(i1_2, _S31, _S32);

#line 62
        uint32_t _S34 = pw_0(41U, &kernelContext_3);

#line 62
        uint32_t _S35 = pw_0(12U, &kernelContext_3);

#line 62
        uint32_t _S36 = pad_wrap_0(i2_2, _S34, _S35);

#line 62
        uint32_t _S37 = pw_0(43U, &kernelContext_3);

#line 62
        uint32_t _S38 = pw_0(13U, &kernelContext_3);

#line 62
        uint32_t _S39 = pad_wrap_0(i3_2, _S37, _S38);

#line 62
        uint32_t _S40 = off4_0(10U, _S30, _S33, _S36, _S39, &kernelContext_3);

#line 62
        *_S27 = *(&((&kernelContext_3)->globalParams_0->s0_0)[_S40]);
...
#line 61
        uint32_t _S41 = pw_0(37U, &kernelContext_3);

#line 61
        uint32_t _S42 = pw_0(10U, &kernelContext_3);

#line 61
        bool _S43;


        if(pad_in_0(i0_2, _S41, _S42))
        {

#line 64
            uint32_t _S44 = pw_0(39U, &kernelContext_3);

#line 64
            uint32_t _S45 = pw_0(11U, &kernelContext_3);

#line 64
            _S43 = pad_in_0(i1_2, _S44, _S45);
...
#line 64
            uint32_t _S46 = pw_0(41U, &kernelContext_3);

#line 64
            uint32_t _S47 = pw_0(12U, &kernelContext_3);

#line 64
            _S43 = pad_in_0(i2_2, _S46, _S47);
...
#line 64
            uint32_t _S48 = pw_0(43U, &kernelContext_3);

#line 64
            uint32_t _S49 = pw_0(13U, &kernelContext_3);

#line 64
            _S43 = pad_in_0(i3_2, _S48, _S49);
...
#line 65
            float * _S50 = (&((&kernelContext_3)->globalParams_0->dst_0)[_S25]);

#line 65
            uint32_t _S51 = pw_0(37U, &kernelContext_3);

#line 65
            uint32_t _S52 = i0_2 - _S51;

#line 65
            uint32_t _S53 = pw_0(39U, &kernelContext_3);

#line 65
            uint32_t _S54 = i1_2 - _S53;

#line 65
            uint32_t _S55 = pw_0(41U, &kernelContext_3);

#line 65
            uint32_t _S56 = i2_2 - _S55;

#line 65
            uint32_t _S57 = pw_0(43U, &kernelContext_3);

#line 65
            uint32_t _S58 = off4_0(10U, _S52, _S54, _S56, i3_2 - _S57, &kernelContext_3);

#line 65
            *_S50 = *(&((&kernelContext_3)->globalParams_0->s0_0)[_S58]);

#line 64
        }
        else
        {
            *(&((&kernelContext_3)->globalParams_0->dst_0)[_S25]) = 0.0f;
