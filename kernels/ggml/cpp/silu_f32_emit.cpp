...
static float silu_0(float x_0)
{

#line 42
    return x_0 / (1.0f + (F32_exp((- x_0))));
}
...
#line 59
    *(&((&kernelContext_3)->globalParams_0->dst_0)[_S23]) = silu_0(*(&((&kernelContext_3)->globalParams_0->s0_0)[_S24]));
    return;
}
