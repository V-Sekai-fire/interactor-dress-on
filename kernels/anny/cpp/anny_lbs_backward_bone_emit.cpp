...
#line 1 "slang/anny_lbs_backward_bone.slang"
...
struct GlobalParams_0
{
    ...
    RWStructuredBuffer<float> dbone_0;
};
...
#line 66
    ...
    uint32_t t_1 = (_S2->groupID * Vector<uint32_t, 3> (64U, 1U, 1U) + _S2->groupThreadID).x;
    if(t_1 >= ((slang_bit_cast<GlobalParams_0*>(globalParams_1))->params_0->J_0 * 3U))
    {
...
#line 84
            float g_0 = w_0 * (&kernelContext_0)->globalParams_0->dverts_0.Load(_S3 + r_0);
            df_acc_0(&h0_0, &l0_0, g_0, (&kernelContext_0)->globalParams_0->bind_0.Load(_S3));
            df_acc_0(&h1_0, &l1_0, g_0, (&kernelContext_0)->globalParams_0->bind_0.Load(_S3 + 1U));
            df_acc_0(&h2_0, &l2_0, g_0, (&kernelContext_0)->globalParams_0->bind_0.Load(_S3 + 2U));
            df_acc_0(&h3_0, &l3_0, g_0, 1.0f);
...
#line 91
    uint32_t _S4 = j_0 * 12U + r_0 * 4U;

#line 91
    *(&((&kernelContext_0)->globalParams_0->dbone_0)[_S4]) = h0_0 + l0_0;
    *(&((&kernelContext_0)->globalParams_0->dbone_0)[_S4 + 1U]) = h1_0 + l1_0;
    *(&((&kernelContext_0)->globalParams_0->dbone_0)[_S4 + 2U]) = h2_0 + l2_0;
    *(&((&kernelContext_0)->globalParams_0->dbone_0)[_S4 + 3U]) = h3_0 + l3_0;
    return;
}
