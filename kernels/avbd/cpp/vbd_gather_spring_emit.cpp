...
#line 1 "C:/interactor-dress-on/kernels/avbd/slang/vbd_gather_spring.slang"
struct VbdGatherSpringParams_0
{
...
{
    StructuredBuffer<Vector<float, 3> > springGradA_0;
    StructuredBuffer<float> springHess_0;
    StructuredBuffer<uint32_t> vertSpringOffset_0;
    StructuredBuffer<uint32_t> vertSpringIdx_0;
    StructuredBuffer<uint32_t> vertSpringRole_0;
    RWStructuredBuffer<Vector<float, 3> > gScratch_0;
    RWStructuredBuffer<float> hScratch_0;
    StructuredBuffer<uint32_t> vertPerm_0;
    VbdGatherSpringParams_0* params_0;
};
...
#line 26
    ...
    uint32_t lane_0 = (_S2->groupID * Vector<uint32_t, 3> (64U, 1U, 1U) + _S2->groupThreadID).x;
...
#line 29
    ...
    uint32_t v_0 = (&kernelContext_0)->globalParams_0->vertPerm_0.Load(lane_0 + (slang_bit_cast<GlobalParams_0*>(globalParams_1))->params_0->colorOffset_0);
    uint32_t sStart_0 = (&kernelContext_0)->globalParams_0->vertSpringOffset_0.Load(v_0);
    uint32_t _S3 = (&kernelContext_0)->globalParams_0->vertSpringOffset_0.Load(v_0 + 1U);
    uint32_t hb_0 = 6U * v_0;
    Vector<float, 3>  * _S4 = (&((&kernelContext_0)->globalParams_0->gScratch_0)[v_0]);

    float _S5 = (*_S4).y;
    float _S6 = (*_S4).z;
    float * _S7 = (&((&kernelContext_0)->globalParams_0->hScratch_0)[hb_0]);
    uint32_t _S8 = hb_0 + 1U;

#line 40
    float * _S9 = (&((&kernelContext_0)->globalParams_0->hScratch_0)[_S8]);
    uint32_t _S10 = hb_0 + 2U;

#line 41
    float * _S11 = (&((&kernelContext_0)->globalParams_0->hScratch_0)[_S10]);
    uint32_t _S12 = hb_0 + 3U;

#line 42
    float * _S13 = (&((&kernelContext_0)->globalParams_0->hScratch_0)[_S12]);
    uint32_t _S14 = hb_0 + 4U;

#line 43
    float * _S15 = (&((&kernelContext_0)->globalParams_0->hScratch_0)[_S14]);
    uint32_t _S16 = hb_0 + 5U;

#line 44
    float * _S17 = (&((&kernelContext_0)->globalParams_0->hScratch_0)[_S16]);
...
#line 46
        uint32_t c_0 = (&kernelContext_0)->globalParams_0->vertSpringIdx_0.Load(k_0);

        float sign_0 = 1.0f - 2.0f * float((&kernelContext_0)->globalParams_0->vertSpringRole_0.Load(k_0));
        Vector<float, 3>  ga_0 = (&kernelContext_0)->globalParams_0->springGradA_0.Load(c_0);
        float _S18 = gx_0 + sign_0 * ga_0.x;
        float _S19 = gy_0 + sign_0 * ga_0.y;
        float _S20 = gz_0 + sign_0 * ga_0.z;
        uint32_t shb_0 = 6U * c_0;
        float _S21 = Hxx_0 + (&kernelContext_0)->globalParams_0->springHess_0.Load(shb_0);
        float _S22 = Hxy_0 + (&kernelContext_0)->globalParams_0->springHess_0.Load(shb_0 + 1U);
        float _S23 = Hxz_0 + (&kernelContext_0)->globalParams_0->springHess_0.Load(shb_0 + 2U);
        float _S24 = Hyy_0 + (&kernelContext_0)->globalParams_0->springHess_0.Load(shb_0 + 3U);
        float _S25 = Hyz_0 + (&kernelContext_0)->globalParams_0->springHess_0.Load(shb_0 + 4U);
        float _S26 = Hzz_0 + (&kernelContext_0)->globalParams_0->springHess_0.Load(shb_0 + 5U);
...
#line 61
    *(&((&kernelContext_0)->globalParams_0->gScratch_0)[v_0]) = Vector<float, 3> (gx_0, gy_0, gz_0);
    *(&((&kernelContext_0)->globalParams_0->hScratch_0)[hb_0]) = Hxx_0;
    *(&((&kernelContext_0)->globalParams_0->hScratch_0)[_S8]) = Hxy_0;
    *(&((&kernelContext_0)->globalParams_0->hScratch_0)[_S10]) = Hxz_0;
    *(&((&kernelContext_0)->globalParams_0->hScratch_0)[_S12]) = Hyy_0;
    *(&((&kernelContext_0)->globalParams_0->hScratch_0)[_S14]) = Hyz_0;
    *(&((&kernelContext_0)->globalParams_0->hScratch_0)[_S16]) = Hzz_0;
    return;
}
