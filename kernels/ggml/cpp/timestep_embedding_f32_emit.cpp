...
#line 1 "slang/timestep_embedding_f32.slang"
struct Slot_0
{
    uint32_t base_0;
    uint32_t pad0_0;
...
#line 21 "slang/timestep_embedding_f32.slang"
...
static float freq_0(uint32_t j_0, uint32_t half_0, KernelContext_0 * kernelContext_3)
{

#line 41
    uint32_t _S16 = pw_0(38U, kernelContext_3);
    return (F32_exp((- (F32_log((float(_S16)))) * float(j_0) / float(half_0))));
}
...
#line 54
    unravel4_0(e_1, 1U, &i0_2, &i1_2, &i2_2, &i3_2, &kernelContext_4);

#line 54
    uint32_t _S24 = off4_0(1U, i0_2, i1_2, i2_2, i3_2, &kernelContext_4);

#line 54
    uint32_t _S25 = pw_0(37U, &kernelContext_4);


    uint32_t half_1 = _S25 / 2U;

#line 57
    uint32_t _S26 = off4_0(10U, i1_2, 0U, 0U, 0U, &kernelContext_4);
    float t_0 = *(&((&kernelContext_4)->globalParams_0->s0_0)[_S26]);
    if(i0_2 < half_1)
    {

#line 60
        float * _S27 = (&((&kernelContext_4)->globalParams_0->dst_0)[_S24]);

#line 60
        float _S28 = freq_0(i0_2, half_1, &kernelContext_4);

#line 60
        *_S27 = (F32_cos((t_0 * _S28)));
...
#line 63
            float * _S29 = (&((&kernelContext_4)->globalParams_0->dst_0)[_S24]);

#line 63
            float _S30 = freq_0(i0_2 - half_1, half_1, &kernelContext_4);

#line 63
            *_S29 = (F32_sin((t_0 * _S30)));

#line 62
        }
        else
        {
            *(&((&kernelContext_4)->globalParams_0->dst_0)[_S24]) = 0.0f;
