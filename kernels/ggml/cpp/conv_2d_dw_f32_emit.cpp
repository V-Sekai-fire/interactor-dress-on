...
#line 1 "slang/conv_2d_dw_f32.slang"
struct Slot_0
{
    uint32_t base_0;
    uint32_t pad0_0;
...
#line 50
    uint32_t _S26 = pw_0(19U, &kernelContext_3);

#line 50
    uint32_t _S27 = pw_0(20U, &kernelContext_3);

#line 50
    uint32_t _S28 = pw_0(37U, &kernelContext_3);

#line 50
    uint32_t _S29 = pw_0(38U, &kernelContext_3);

#line 50
    uint32_t _S30 = pw_0(39U, &kernelContext_3);

#line 50
    uint32_t _S31 = pw_0(40U, &kernelContext_3);

#line 50
    uint32_t _S32 = pw_0(41U, &kernelContext_3);

#line 50
    uint32_t _S33 = pw_0(42U, &kernelContext_3);
...
#line 65
        uint32_t qy_0 = i1_2 * _S29 + ky_0 * _S33;
...
#line 68
                uint32_t qx_0 = i0_2 * _S28 + kx_0 * _S32;
...
#line 69
                    uint32_t _S36 = off4_0(10U, kx_0, ky_0, 0U, i2_2, &kernelContext_3);
                    float * _S37 = (&((&kernelContext_3)->globalParams_0->s0_0)[_S36]);

#line 70
                    uint32_t _S38 = off4_0(19U, qx_0 - _S30, qy_0 - _S31, i2_2, i3_2, &kernelContext_3);

#line 70
                    sum_1 = sum_1 + *_S37 * *(&((&kernelContext_3)->globalParams_0->s1_0)[_S38]);
...
#line 75
    *(&((&kernelContext_3)->globalParams_0->dst_0)[_S23]) = sum_0;
    return;
}
