...
#line 55
    *(&((&kernelContext_3)->globalParams_0->dst_0)[_S23]) = (F32_log((*(&((&kernelContext_3)->globalParams_0->s0_0)[_S24]))));
    return;
}
