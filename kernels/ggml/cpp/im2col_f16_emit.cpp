...
struct GlobalParams_0
{
    ...
    RWStructuredBuffer<uint32_t> dst_0;
    Slot_0* slot_0;
};
...
static float im2col_at_0(uint32_t i0_2, uint32_t i1_2, uint32_t i2_2, uint32_t i3_2, KernelContext_0 * kernelContext_3)
{

#line 41
    uint32_t _S16 = pw_0(43U, kernelContext_3);
    bool is2d_0 = _S16 == 1U;

#line 42
    uint32_t _S17 = pw_0(10U, kernelContext_3);
...
#line 44
        uint32_t _S18 = pw_0(11U, kernelContext_3);
...
#line 44
    uint32_t _S19 = pw_0(19U, kernelContext_3);
...
#line 46
        uint32_t _S20 = pw_0(20U, kernelContext_3);
...
#line 46
    ...
    uint32_t kk_0 = kh_0 * _S17;
    uint32_t iic_0 = i0_2 / kk_0;
    uint32_t r_2 = i0_2 % kk_0;
    uint32_t ikh_0 = r_2 / _S17;
    uint32_t ikw_0 = r_2 % _S17;
...
#line 53
    uint32_t _S21 = pw_0(37U, kernelContext_3);
    uint32_t _S22 = i1_2 * _S21;

#line 54
    uint32_t _S23 = pw_0(41U, kernelContext_3);

#line 54
    uint32_t x_0 = _S22 + ikw_0 * _S23;

#line 54
    uint32_t _S24 = pw_0(38U, kernelContext_3);
    uint32_t _S25 = ioh_0 * _S24;

#line 55
    uint32_t _S26 = pw_0(42U, kernelContext_3);

#line 55
    uint32_t y_0 = _S25 + ikh_0 * _S26;

#line 55
    uint32_t _S27 = pw_0(39U, kernelContext_3);
...
#line 56
        uint32_t _S29 = pw_0(39U, kernelContext_3);
...
#line 56
        uint32_t _S30 = pw_0(40U, kernelContext_3);
...
#line 56
            uint32_t _S31 = pw_0(40U, kernelContext_3);
...
#line 57
    uint32_t _S32 = pw_0(39U, kernelContext_3);

    uint32_t xx_0 = x_0 - _S32;

#line 59
    uint32_t _S33 = pw_0(40U, kernelContext_3);
    uint32_t yy_0 = y_0 - _S33;
    if(is2d_0)
    {
...
#line 61
    uint32_t _S34 = off4_0(19U, xx_0, kh_0, ih_0, ioh_0, kernelContext_3);

#line 61
    return *(&(kernelContext_3->globalParams_0->s1_0)[_S34]);
}
...
static uint32_t im2col_h_0(uint32_t h_3, uint32_t off_0, uint32_t n_0, uint32_t old_0, KernelContext_0 * kernelContext_4)
{
...
#line 103
    unravel4_0(h_3 - off_0, 1U, &i0_3, &i1_3, &i2_3, &i3_3, kernelContext_4);

#line 103
    float _S37 = im2col_at_0(i0_3, i1_3, i2_3, i3_3, kernelContext_4);

    return f32_to_f16_0(_S37);
}


void _main_0(void* _S38, void* entryPointParams_0, void* globalParams_1)
{

#line 109
    ComputeThreadVaryingInput * _S39 = (slang_bit_cast<ComputeThreadVaryingInput *>(_S38));

#line 109
    KernelContext_0 kernelContext_5;

#line 109
    (&kernelContext_5)->globalParams_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_1));

#line 109
    Vector<uint32_t, 3>  _S40 = _S39->groupID;

#line 109
    Vector<uint32_t, 3>  _S41 = _S39->groupThreadID;
    uint32_t _S42 = _S39->groupID.y;

#line 110
    uint32_t _S43 = pw_0(54U, &kernelContext_5);

#line 110
    uint32_t e_1 = (_S42 * _S43 + _S40.x) * 256U + _S41.x;

#line 110
    uint32_t _S44 = pw_0(53U, &kernelContext_5);
    if(e_1 >= _S44)
    {
...
#line 112
    uint32_t _S45 = pw_0(9U, &kernelContext_5);

#line 112
    uint32_t _S46 = pw_0(1U, &kernelContext_5);

#line 112
    uint32_t _S47 = pw_0(2U, &kernelContext_5);


    uint32_t _S48 = _S46 * _S47;

#line 115
    uint32_t _S49 = pw_0(3U, &kernelContext_5);

#line 115
    uint32_t _S50 = pw_0(4U, &kernelContext_5);

#line 115
    uint32_t n_1 = _S48 * (_S49 * _S50);
    uint32_t wd_0 = (_S45 >> 1U) + e_1;
    uint32_t h0_0 = wd_0 * 2U;
...
#line 119
        old_1 = *(&((&kernelContext_5)->globalParams_0->dst_0)[wd_0]);
...
#line 119
    uint32_t _S53 = im2col_h_0(h0_0, _S45, n_1, old_1 & 65535U, &kernelContext_5);

#line 119
    uint32_t _S54 = im2col_h_0(h0_0 + 1U, _S45, n_1, old_1 >> 16U, &kernelContext_5);

#line 124
    *(&((&kernelContext_5)->globalParams_0->dst_0)[wd_0]) = _S53 | (_S54 << 16U);
    return;
}
