...
#line 1 "slang/leaky_relu_f32.slang"
struct Slot_0
{
    uint32_t base_0;
    uint32_t pad0_0;
...
static float leaky_relu_0(float x_0, float ns_0)
{
...
#line 51
    uint32_t _S24 = pw_0(54U, &kernelContext_4);

#line 51
    uint32_t e_1 = (_S23 * _S24 + _S21.x) * 256U + _S22.x;

#line 51
    uint32_t _S25 = pw_0(53U, &kernelContext_4);
    if(e_1 >= _S25)
    {
...
#line 58
    uint32_t _S26 = off4_0(1U, i0_2, i1_2, i2_2, i3_2, &kernelContext_4);

#line 58
    uint32_t _S27 = off4_0(10U, i0_2, i1_2, i2_2, i3_2, &kernelContext_4);



    float * _S28 = (&((&kernelContext_4)->globalParams_0->s0_0)[_S27]);
    float * _S29 = (&((&kernelContext_4)->globalParams_0->dst_0)[_S26]);

#line 63
    float _S30 = pf_0(37U, &kernelContext_4);

#line 63
    *_S29 = leaky_relu_0(*_S28, _S30);
    return;
}
