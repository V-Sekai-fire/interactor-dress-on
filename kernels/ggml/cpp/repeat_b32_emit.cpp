...
#line 42
    uint32_t _S22 = pw_0(13U, kernelContext_3);

#line 42
    uint32_t _S23 = i3_2 % _S22;

#line 42
    uint32_t _S24 = off4_0(10U, _S17, _S19, _S21, _S23, kernelContext_3);

#line 42
    return *(&(kernelContext_3->globalParams_0->s0_0)[_S24]);
}
...
#line 47
    uint32_t _S30 = pw_0(54U, &kernelContext_4);

#line 47
    uint32_t e_1 = (_S29 * _S30 + _S27.x) * 256U + _S28.x;

#line 47
    uint32_t _S31 = pw_0(53U, &kernelContext_4);
    if(e_1 >= _S31)
    {
...
#line 54
    uint32_t _S32 = off4_0(1U, i0_3, i1_3, i2_3, i3_3, &kernelContext_4);

    uint32_t * _S33 = (&((&kernelContext_4)->globalParams_0->dst_0)[_S32]);

#line 56
    uint32_t _S34 = val_0(i0_3, i1_3, i2_3, i3_3, &kernelContext_4);
