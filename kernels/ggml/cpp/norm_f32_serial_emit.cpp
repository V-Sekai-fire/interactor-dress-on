...
#line 1 "slang/norm_f32_serial.slang"
struct Slot_0
{
    uint32_t base_0;
    uint32_t pad0_0;
...
#line 21 "slang/norm_f32_serial.slang"
...
#line 53
            ...
            float _S26 = acc_sumx_0 + *(&((&kernelContext_3)->globalParams_0->s0_0)[_S21 + i_sumx_0 * _S22]);
...
#line 82
        uint32_t _S27 = t_0 + 1U;

#line 82
        sh_0[t_0] = sh_0[t_0] + sh_0[_S27];
...
#line 81
    ...
    float _S28 = float(_S16);

#line 85
    float _S29 = sh_0[0U] / _S28;
...
#line 89
            ...
            float _S30 = *(&((&kernelContext_3)->globalParams_0->s0_0)[_S21 + i_sumx_0 * _S22]) - _S29;

#line 91
            float _S31 = acc_sumx_0 + _S30 * _S30;
...
#line 118
        uint32_t _S32 = t_0 + 1U;

#line 118
        sh_0[t_0] = sh_0[t_0] + sh_0[_S32];
...
#line 122
    float _S33 = 1.0f / (F32_sqrt((sh_0[0U] / _S28 + _S25)));
...
#line 123
        ...
        *(&((&kernelContext_3)->globalParams_0->dst_0)[_S23 + i_sumx_0 * _S24]) = (*(&((&kernelContext_3)->globalParams_0->s0_0)[_S21 + i_sumx_0 * _S22]) - _S29) * _S33;
