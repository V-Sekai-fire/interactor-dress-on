...
#line 1 "slang/anny_lbs.slang"
struct AnnyLbsParams_0
{
    uint32_t V_0;
    uint32_t J_0;
};
...
{
    AnnyLbsParams_0* params_0;
    StructuredBuffer<float> bind_0;
    StructuredBuffer<float> weights_0;
    StructuredBuffer<float> bone_0;
    RWStructuredBuffer<float> verts_0;
};
...
#line 18
    ...
    if(i_0 >= ((slang_bit_cast<GlobalParams_0*>(globalParams_1))->params_0->V_0))
    {
...
#line 23
    float _S4 = (&kernelContext_0)->globalParams_0->bind_0.Load(_S3);
    uint32_t _S5 = _S3 + 1U;

#line 24
    float _S6 = (&kernelContext_0)->globalParams_0->bind_0.Load(_S5);
    uint32_t _S7 = _S3 + 2U;

#line 25
    float _S8 = (&kernelContext_0)->globalParams_0->bind_0.Load(_S7);
...
#line 29
        if(j_0 < ((slang_bit_cast<GlobalParams_0*>(globalParams_1))->params_0->J_0))
        {
        }
        else
        {
...
#line 30
        float w_0 = (&kernelContext_0)->globalParams_0->weights_0.Load(i_0 * (slang_bit_cast<GlobalParams_0*>(globalParams_1))->params_0->J_0 + j_0);
        if(w_0 != 0.0f)
        {

#line 32
            uint32_t b_0 = j_0 * 12U;

            float _S9 = y_0 + w_0 * ((&kernelContext_0)->globalParams_0->bone_0.Load(b_0 + 4U) * _S4 + (&kernelContext_0)->globalParams_0->bone_0.Load(b_0 + 5U) * _S6 + (&kernelContext_0)->globalParams_0->bone_0.Load(b_0 + 6U) * _S8 + (&kernelContext_0)->globalParams_0->bone_0.Load(b_0 + 7U));
            float _S10 = z_0 + w_0 * ((&kernelContext_0)->globalParams_0->bone_0.Load(b_0 + 8U) * _S4 + (&kernelContext_0)->globalParams_0->bone_0.Load(b_0 + 9U) * _S6 + (&kernelContext_0)->globalParams_0->bone_0.Load(b_0 + 10U) * _S8 + (&kernelContext_0)->globalParams_0->bone_0.Load(b_0 + 11U));

#line 35
            x_0 = x_0 + w_0 * ((&kernelContext_0)->globalParams_0->bone_0.Load(b_0) * _S4 + (&kernelContext_0)->globalParams_0->bone_0.Load(b_0 + 1U) * _S6 + (&kernelContext_0)->globalParams_0->bone_0.Load(b_0 + 2U) * _S8 + (&kernelContext_0)->globalParams_0->bone_0.Load(b_0 + 3U));
...
#line 38
    *(&((&kernelContext_0)->globalParams_0->verts_0)[_S3]) = x_0;
    *(&((&kernelContext_0)->globalParams_0->verts_0)[_S5]) = y_0;
    *(&((&kernelContext_0)->globalParams_0->verts_0)[_S7]) = z_0;
    return;
}
