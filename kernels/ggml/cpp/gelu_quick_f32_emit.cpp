...
#line 1 "slang/gelu_quick_f32.slang"
struct Slot_0
{
    uint32_t base_0;
    uint32_t pad0_0;
...
#line 21 "slang/gelu_quick_f32.slang"
...
static float gelu_quick_0(float x_0)
{

#line 42
    return x_0 * (1.0f / (1.0f + (F32_exp((-1.70200002193450928f * x_0)))));
}
...
#line 59
    *(&((&kernelContext_3)->globalParams_0->dst_0)[_S23]) = gelu_quick_0(*(&((&kernelContext_3)->globalParams_0->s0_0)[_S24]));
    return;
}
