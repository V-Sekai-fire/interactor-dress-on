...
#line 1 "slang/cpy_f32_f16.slang"
struct Slot_0
{
    uint32_t base_0;
    uint32_t pad0_0;
...
static uint32_t val_0(uint32_t i0_2, uint32_t i1_2, uint32_t i2_2, uint32_t i3_2, KernelContext_0 * kernelContext_3)
{

#line 63
    uint32_t _S16 = pw_0(56U, kernelContext_3);
    uint32_t _S17 = i0_2 * _S16;

#line 64
    uint32_t _S18 = pw_0(57U, kernelContext_3);

#line 64
    uint32_t _S19 = _S17 + i1_2 * _S18;

#line 64
    uint32_t _S20 = pw_0(58U, kernelContext_3);

#line 64
    uint32_t _S21 = _S19 + i2_2 * _S20;

#line 64
    uint32_t _S22 = pw_0(59U, kernelContext_3);
    uint32_t j0_0;
    uint32_t j1_0;
    uint32_t j2_0;
    uint32_t j3_0;
...
#line 68
    unravel4_0(_S21 + i3_2 * _S22, 10U, &j0_0, &j1_0, &j2_0, &j3_0, kernelContext_3);

#line 68
    uint32_t _S23 = off4_0(10U, j0_0, j1_0, j2_0, j3_0, kernelContext_3);

    return f32_to_f16_0(*(&(kernelContext_3->globalParams_0->s0_0)[_S23]));
}


void _main_0(void* _S24, void* entryPointParams_0, void* globalParams_1)
{

#line 74
    ComputeThreadVaryingInput * _S25 = (slang_bit_cast<ComputeThreadVaryingInput *>(_S24));
...
#line 74
    Vector<uint32_t, 3>  _S26 = _S25->groupID;

#line 74
    Vector<uint32_t, 3>  _S27 = _S25->groupThreadID;
    uint32_t _S28 = _S25->groupID.y;

#line 75
    uint32_t _S29 = pw_0(54U, &kernelContext_4);

#line 75
    uint32_t e_1 = (_S28 * _S29 + _S26.x) * 256U + _S27.x;

#line 75
    uint32_t _S30 = pw_0(53U, &kernelContext_4);
    if(e_1 >= _S30)
    {
...
#line 82
    unravel4_0(e_1, 1U, &i0_3, &i1_3, &i2_3, &i3_3, &kernelContext_4);

#line 82
    uint32_t _S31 = off4_0(1U, i0_3, i1_3, i2_3, i3_3, &kernelContext_4);

#line 82
    uint32_t _S32 = pw_0(55U, &kernelContext_4);
...
#line 88
        ...
        uint32_t _S33 = _S31 >> 1U;

#line 90
        uint32_t * _S34 = (&((&kernelContext_4)->globalParams_0->dst_0)[_S33]);

#line 90
        uint32_t _S35 = (*(&((&kernelContext_4)->globalParams_0->dst_0)[_S33])) & 65535U;

#line 90
        uint32_t _S36 = val_0(i0_3, i1_3, i2_3, i3_3, &kernelContext_4);
...
#line 91
    uint32_t _S37 = val_0(i0_3, i1_3, i2_3, i3_3, &kernelContext_4);
...
#line 99
        uint32_t _S42 = i0_3 + 1U;

#line 99
        uint32_t _S43 = pw_0(1U, &kernelContext_4);
...
#line 102
            uint32_t _S45 = i1_3 + 1U;

#line 102
            uint32_t _S46 = pw_0(2U, &kernelContext_4);
...
#line 106
                uint32_t _S48 = i2_3 + 1U;

#line 106
                uint32_t _S49 = pw_0(3U, &kernelContext_4);
...
#line 111
                    uint32_t _S51 = i3_3 + 1U;

#line 111
                    uint32_t _S52 = pw_0(4U, &kernelContext_4);
...
#line 123
        uint32_t * _S54 = (&((&kernelContext_4)->globalParams_0->dst_0)[_S31 >> 1U]);

#line 123
        uint32_t _S55 = val_0(k0_0, k1_0, k2_0, k3_0, &kernelContext_4);
...
#line 122
    ...
    {
        uint32_t _S56 = _S31 >> 1U;

#line 125
        *(&((&kernelContext_4)->globalParams_0->dst_0)[_S56]) = ((*(&((&kernelContext_4)->globalParams_0->dst_0)[_S56])) & 4294901760U) | _S37;
