...
struct GlobalParams_0
{
    ...
    StructuredBuffer<uint32_t> springP2Idx_0;
    StructuredBuffer<Vector<float, 3> > v_g_0;
    StructuredBuffer<float> v_H_0;
    RWStructuredBuffer<Vector<float, 3> > v_springGradA_0;
    RWStructuredBuffer<float> v_springHess_0;
};
...
#line 15
    ...
    uint32_t p1_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->springP1Idx_0.Load(c_0);
    uint32_t p2_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->springP2Idx_0.Load(c_0);
    uint32_t hb1_0 = 6U * p1_0;
    uint32_t hb2_0 = 6U * p2_0;
    uint32_t hbc_0 = 6U * c_0;
    Vector<float, 3>  vg1_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_g_0.Load(p1_0);
    Vector<float, 3>  vg2_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_g_0.Load(p2_0);
    *(&((slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_springGradA_0)[c_0]) = Vector<float, 3> (vg1_0.x - vg2_0.x, vg1_0.y - vg2_0.y, vg1_0.z - vg2_0.z);
    *(&((slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_springHess_0)[hbc_0]) = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_H_0.Load(hb1_0) + (slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_H_0.Load(hb2_0);
    *(&((slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_springHess_0)[hbc_0 + 1U]) = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_H_0.Load(hb1_0 + 1U) + (slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_H_0.Load(hb2_0 + 1U);
    *(&((slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_springHess_0)[hbc_0 + 2U]) = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_H_0.Load(hb1_0 + 2U) + (slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_H_0.Load(hb2_0 + 2U);
    *(&((slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_springHess_0)[hbc_0 + 3U]) = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_H_0.Load(hb1_0 + 3U) + (slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_H_0.Load(hb2_0 + 3U);
    *(&((slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_springHess_0)[hbc_0 + 4U]) = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_H_0.Load(hb1_0 + 4U) + (slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_H_0.Load(hb2_0 + 4U);
    *(&((slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_springHess_0)[hbc_0 + 5U]) = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_H_0.Load(hb1_0 + 5U) + (slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_H_0.Load(hb2_0 + 5U);
    return;
}
