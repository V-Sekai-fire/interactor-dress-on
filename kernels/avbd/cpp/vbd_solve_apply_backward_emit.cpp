...
struct GlobalParams_0
{
    ...
    StructuredBuffer<float> hScratch_0;
    StructuredBuffer<Vector<float, 3> > deltaX_0;
    RWStructuredBuffer<Vector<float, 3> > v_g_0;
    RWStructuredBuffer<float> v_H_0;
};
...
#line 13
    ...
    Vector<float, 3>  vo_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_out_0.Load(v_0);
    float Hxx_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->hScratch_0.Load(hb_0);
    uint32_t _S3 = hb_0 + 1U;

#line 18
    float Hxy_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->hScratch_0.Load(_S3);
    uint32_t _S4 = hb_0 + 2U;

#line 19
    float Hxz_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->hScratch_0.Load(_S4);
    uint32_t _S5 = hb_0 + 3U;

#line 20
    float Hyy_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->hScratch_0.Load(_S5);
    uint32_t _S6 = hb_0 + 4U;

#line 21
    float Hyz_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->hScratch_0.Load(_S6);
    uint32_t _S7 = hb_0 + 5U;

#line 22
    float Hzz_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->hScratch_0.Load(_S7);
    float a00_0 = Hyy_0 * Hzz_0 - Hyz_0 * Hyz_0;


    float a01_0 = Hxz_0 * Hyz_0 - Hxy_0 * Hzz_0;
    float a02_0 = Hxy_0 * Hyz_0 - Hxz_0 * Hyy_0;
    float a12_0 = Hxy_0 * Hxz_0 - Hxx_0 * Hyz_0;

    float invDet_0 = 1.0f / (Hxx_0 * a00_0 + Hxy_0 * a01_0 + Hxz_0 * a02_0);
    float ux_0 = vo_0.x;
    float uy_0 = vo_0.y;
    float uz_0 = vo_0.z;
    float yx_0 = invDet_0 * (a00_0 * ux_0 + a01_0 * uy_0 + a02_0 * uz_0);
    float yy_0 = invDet_0 * (a01_0 * ux_0 + (Hxx_0 * Hzz_0 - Hxz_0 * Hxz_0) * uy_0 + a12_0 * uz_0);
    float yz_0 = invDet_0 * (a02_0 * ux_0 + a12_0 * uy_0 + (Hxx_0 * Hyy_0 - Hxy_0 * Hxy_0) * uz_0);
    *(&((slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_g_0)[v_0]) = Vector<float, 3> (0.0f - yx_0, 0.0f - yy_0, 0.0f - yz_0);
    Vector<float, 3>  dx_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->deltaX_0.Load(v_0);
    float dxx_0 = dx_0.x;
    float dxy_0 = dx_0.y;
    float dxz_0 = dx_0.z;
    *(&((slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_H_0)[hb_0]) = 0.0f - yx_0 * dxx_0;
    *(&((slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_H_0)[_S3]) = 0.0f - (yx_0 * dxy_0 + yy_0 * dxx_0);
    *(&((slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_H_0)[_S4]) = 0.0f - (yx_0 * dxz_0 + yz_0 * dxx_0);
    *(&((slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_H_0)[_S5]) = 0.0f - yy_0 * dxy_0;
    *(&((slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_H_0)[_S6]) = 0.0f - (yy_0 * dxz_0 + yz_0 * dxy_0);
    *(&((slang_bit_cast<GlobalParams_0*>(globalParams_0))->v_H_0)[_S7]) = 0.0f - yz_0 * dxz_0;
    return;
}
